...
class Masjid_Feed_Content_Only_Renderer {
    ...
    public function filter_classic_template($template) {
        ...
        $content_only_template = MASJIDFEED_PLUGIN_DIR . 'templates/content-only.php';
    ...
    private function is_content_only_request() {
        return !is_admin()
            && is_singular()
            && (bool) Masjid_Feed_Settings::get_option('content_only_rendering_enabled', 0)
