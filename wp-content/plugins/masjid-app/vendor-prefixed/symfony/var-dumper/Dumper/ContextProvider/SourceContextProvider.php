 ...
 */
namespace Masjid_App\Dependencies\Symfony\Component\VarDumper\Dumper\ContextProvider;
...
use Masjid_App\Dependencies\Symfony\Component\VarDumper\VarDumper;
use Masjid_App\Dependencies\Twig\Template;
/**
...
final class SourceContextProvider implements ContextProviderInterface
{
    ...
    {
        $html = '';
        $dumper = new HtmlDumper(static function ($line) use (&$html) {
            $html .= $line;
        }, $this->charset);
