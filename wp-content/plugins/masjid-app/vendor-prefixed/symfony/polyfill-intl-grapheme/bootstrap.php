 ...
 */
use Masjid_App\Dependencies\Symfony\Polyfill\Intl\Grapheme as p;
...
if (!\function_exists('grapheme_extract') && !\function_exists('Masjid_App\Dependencies\grapheme_extract')) {
...
if (!\function_exists('grapheme_stripos') && !\function_exists('Masjid_App\Dependencies\grapheme_stripos')) {
    function grapheme_stripos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_stripos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_stristr') && !\function_exists('Masjid_App\Dependencies\grapheme_stristr')) {
...
if (!\function_exists('grapheme_strlen') && !\function_exists('Masjid_App\Dependencies\grapheme_strlen')) {
    function grapheme_strlen($input)
    {
        return p\Grapheme::grapheme_strlen($input);
    }
}
if (!\function_exists('grapheme_strpos') && !\function_exists('Masjid_App\Dependencies\grapheme_strpos')) {
    function grapheme_strpos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strpos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strripos') && !\function_exists('Masjid_App\Dependencies\grapheme_strripos')) {
    function grapheme_strripos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strripos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strrpos') && !\function_exists('Masjid_App\Dependencies\grapheme_strrpos')) {
    function grapheme_strrpos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strrpos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strstr') && !\function_exists('Masjid_App\Dependencies\grapheme_strstr')) {
...
if (!\function_exists('grapheme_substr') && !\function_exists('Masjid_App\Dependencies\grapheme_substr')) {
    function grapheme_substr($string, $offset, $length = null)
    {
        return p\Grapheme::grapheme_substr($string, $offset, $length);
    }
}
if (!\function_exists('grapheme_str_split') && !\function_exists('Masjid_App\Dependencies\grapheme_str_split')) {
    function grapheme_str_split(string $string, int $length = 1)
    {
        return p\Grapheme::grapheme_str_split($string, $length);
    }
}
if (!\function_exists('grapheme_levenshtein') && !\function_exists('Masjid_App\Dependencies\grapheme_levenshtein')) {
...
if (!\function_exists('grapheme_strrev') && !\function_exists('Masjid_App\Dependencies\grapheme_strrev')) {
