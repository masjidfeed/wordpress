...
namespace Masjid_App\Dependencies\Ramsey\Uuid\Nonstandard;
...
use Masjid_App\Dependencies\Ramsey\Uuid\Exception\InvalidArgumentException;
use Masjid_App\Dependencies\Ramsey\Uuid\Lazy\LazyUuidFromString;
use Masjid_App\Dependencies\Ramsey\Uuid\Rfc4122\FieldsInterface as Rfc4122FieldsInterface;
use Masjid_App\Dependencies\Ramsey\Uuid\Rfc4122\TimeTrait;
use Masjid_App\Dependencies\Ramsey\Uuid\Rfc4122\UuidInterface;
use Masjid_App\Dependencies\Ramsey\Uuid\Rfc4122\UuidV1;
use Masjid_App\Dependencies\Ramsey\Uuid\Uuid as BaseUuid;
/**
...
class UuidV6 extends BaseUuid implements UuidInterface
{
     ...
     */
    public static function fromUuidV1(UuidV1 $uuidV1): \Masjid_App\Dependencies\Ramsey\Uuid\Rfc4122\UuidV6
    {
