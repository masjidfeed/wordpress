...
use Masjid_App\Dependencies\JetBrains\PHPStormStub\PhpStormStubsMap;
...
final readonly class Reflector
{
    private const MISSING_CLASSES = [
        ...
        // PHP 8.4
        // TODO: to report
        'Masjid_App\Dependencies\Pdo\DbLib',
        'Masjid_App\Dependencies\Pdo\Firebird',
        'Masjid_App\Dependencies\Pdo\Odbc',
        'Masjid_App\Dependencies\Pdo\Pgsql',
    ];
