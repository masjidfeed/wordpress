...
final readonly class SymbolRegistry
{
    ...
    {
        return new self(array_values(self::normalizeNames($names)), array_values(array_unique($regexes)), \false);
    }
    /**
    ...
    {
        return new self(array_values(self::normalizeConstantNames($names)), array_values(array_unique($regexes)), \true);
    }
    /**
