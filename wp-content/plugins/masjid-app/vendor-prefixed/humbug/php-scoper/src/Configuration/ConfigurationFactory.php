 ...
 */
namespace Masjid_App\Dependencies\Humbug\PhpScoper\Configuration;

use Exception;
use Masjid_App\Dependencies\Humbug\PhpScoper\Configuration\Throwable\InvalidConfiguration;
use Masjid_App\Dependencies\Humbug\PhpScoper\Configuration\Throwable\InvalidConfigurationFile;
use Masjid_App\Dependencies\Humbug\PhpScoper\Configuration\Throwable\InvalidConfigurationValue;
use Masjid_App\Dependencies\Humbug\PhpScoper\Patcher\ComposerPatcher;
use Masjid_App\Dependencies\Humbug\PhpScoper\Patcher\Patcher;
use Masjid_App\Dependencies\Humbug\PhpScoper\Patcher\PatcherChain;
use Masjid_App\Dependencies\Humbug\PhpScoper\Patcher\SymfonyParentTraitPatcher;
use Masjid_App\Dependencies\Humbug\PhpScoper\Patcher\SymfonyPatcher;
use Masjid_App\Dependencies\PhpParser\PhpVersion;
use SplFileInfo;
use Masjid_App\Dependencies\Symfony\Component\Filesystem\Filesystem;
use Masjid_App\Dependencies\Symfony\Component\Finder\Finder;
...
use function Masjid_App\Dependencies\Humbug\PhpScoper\chain;
...
use function Masjid_App\Dependencies\Safe\file_get_contents;
use function trim;
