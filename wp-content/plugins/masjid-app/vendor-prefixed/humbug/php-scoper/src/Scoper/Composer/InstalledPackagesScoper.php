 ...
 */
namespace Masjid_App\Dependencies\Humbug\PhpScoper\Scoper\Composer;
...
use function Masjid_App\Dependencies\Safe\json_decode;
use function Masjid_App\Dependencies\Safe\json_encode;
...
final readonly class InstalledPackagesScoper implements Scoper
{
    ...
    {
        return array_map($this->autoloadPrefixer->prefixPackageAutoloadStatements(...), $packages);
    }
}
