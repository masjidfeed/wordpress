 ...
 */
namespace Masjid_App\Dependencies\Humbug\PhpScoper\Scoper\Symfony;
...
final readonly class XmlScoper implements Scoper
{
    ...
    private static function scopeNamespaces(string $contents, string $prefix, EnrichedReflector $enrichedReflector, SymbolsRegistry $symbolsRegistry): string
    {
        ...
        return self::replaceClasses($matches['namespace'], $matches['separator'], $prefix, $contents, $enrichedReflector, $symbolsRegistry);
    }
    /**
