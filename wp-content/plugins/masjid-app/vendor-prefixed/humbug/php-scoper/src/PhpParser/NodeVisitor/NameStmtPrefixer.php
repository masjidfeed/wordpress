...
use Masjid_App\Dependencies\Humbug\PhpScoper\PhpParser\Node\FullyQualifiedFactory;
...
use Masjid_App\Dependencies\Humbug\PhpScoper\PhpParser\NodeVisitor\Resolver\OriginalNameResolver;
use Masjid_App\Dependencies\Humbug\PhpScoper\PhpParser\NodeVisitor\UseStmt\UseStmtCollection;
use Masjid_App\Dependencies\Humbug\PhpScoper\PhpParser\UseStmtName;
use Masjid_App\Dependencies\Humbug\PhpScoper\Symbol\EnrichedReflector;
use Masjid_App\Dependencies\PhpParser\Node;
use Masjid_App\Dependencies\PhpParser\Node\Attribute;
use Masjid_App\Dependencies\PhpParser\Node\Expr\ArrowFunction;
use Masjid_App\Dependencies\PhpParser\Node\Expr\ClassConstFetch;
use Masjid_App\Dependencies\PhpParser\Node\Expr\Closure;
use Masjid_App\Dependencies\PhpParser\Node\Expr\ConstFetch;
use Masjid_App\Dependencies\PhpParser\Node\Expr\FuncCall;
use Masjid_App\Dependencies\PhpParser\Node\Expr\Instanceof_;
use Masjid_App\Dependencies\PhpParser\Node\Expr\New_;
use Masjid_App\Dependencies\PhpParser\Node\Expr\StaticCall;
use Masjid_App\Dependencies\PhpParser\Node\Expr\StaticPropertyFetch;
use Masjid_App\Dependencies\PhpParser\Node\IntersectionType;
use Masjid_App\Dependencies\PhpParser\Node\Name;
use Masjid_App\Dependencies\PhpParser\Node\Name\FullyQualified;
use Masjid_App\Dependencies\PhpParser\Node\NullableType;
use Masjid_App\Dependencies\PhpParser\Node\Param;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\Catch_;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\Class_;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\ClassMethod;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\Function_;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\Interface_;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\Property;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\TraitUse;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\TraitUseAdaptation\Alias;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\TraitUseAdaptation\Precedence;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\Use_;
use Masjid_App\Dependencies\PhpParser\Node\UnionType;
