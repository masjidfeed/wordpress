...
use Masjid_App\Dependencies\Humbug\PhpScoper\PhpParser\UnexpectedParsingScenario;
...
use Masjid_App\Dependencies\PhpParser\Node\ArrayItem;
use Masjid_App\Dependencies\PhpParser\Node\Const_;
use Masjid_App\Dependencies\PhpParser\Node\Expr\Array_;
use Masjid_App\Dependencies\PhpParser\Node\Expr\Assign;
...
use Masjid_App\Dependencies\PhpParser\Node\Stmt\PropertyProperty;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\Return_;
...
REGEX;
    ...
    {
        if (!ParentNodeAppender::hasParent($string) || 1 !== native_preg_match(self::CLASS_LIKE_PATTERN, $string->value) && 1 !== native_preg_match(self::CONSTANT_FETCH_PATTERN, $string->value)) {
            return $string;
        }
