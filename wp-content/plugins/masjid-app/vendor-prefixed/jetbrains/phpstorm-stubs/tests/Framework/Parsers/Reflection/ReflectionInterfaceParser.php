...
class ReflectionInterfaceParser implements Parser
{
    ...
    public function __construct(?ReflectionMethodParser $methodParser = null, ?ReflectionClassConstantParser $constantParser = null, ?ReflectionImplementedInterfaceParser $interfaceParser = null)
    {
    ...
    {
        return $object instanceof AdaptedReflectionClass && $object->isInternal() && $object->isInterface();
    }
    /**
