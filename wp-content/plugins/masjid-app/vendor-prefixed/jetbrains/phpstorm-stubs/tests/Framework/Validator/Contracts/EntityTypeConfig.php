...
final class EntityTypeConfig
{
     ...
     */
    public function __construct(public readonly LookupKind $lookupKind, public readonly EntityType $entityType, public readonly string $label, public readonly ?EntityType $constantEntityType = null)
    {
    }
    public static function forClass(): self
    {
        return new self(lookupKind: LookupKind::CLASS_TYPE, entityType: EntityType::CLASS_TYPE, label: 'Class', constantEntityType: EntityType::CLASS_CONSTANT);
    }
    public static function forEnum(): self
    {
        return new self(lookupKind: LookupKind::ENUM_TYPE, entityType: EntityType::ENUM_TYPE, label: 'Enum', constantEntityType: EntityType::ENUM_CONSTANT);
    }
    public static function forInterface(): self
    {
        return new self(lookupKind: LookupKind::INTERFACE_TYPE, entityType: EntityType::INTERFACE_TYPE, label: 'Interface', constantEntityType: EntityType::INTERFACE_CONSTANT);
    }
    public static function forFunction(): self
    {
        return new self(lookupKind: LookupKind::FUNCTION, entityType: EntityType::FUNCTION, label: 'Function');
    }
}
