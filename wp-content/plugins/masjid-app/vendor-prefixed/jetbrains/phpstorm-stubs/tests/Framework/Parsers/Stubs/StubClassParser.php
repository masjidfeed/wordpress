...
class StubClassParser implements MultiEntityStubParserInterface
{
    ...
    public function __construct(?ClassNodeExtractorInterface $nodeExtractor = null, ?PhpDocParserInterface $phpDocParser = null, ?TypeParserInterface $typeParser = null, ?AvailableVersionParserInterface $versionParser = null)
    {
    ...
    public function parseNode(ClassNode $node, array $imports = []): PHPClass
    {
        ...
        foreach ($attributeNodes as $attributeNode) {
            $attributes[] = ['name' => $attributeNode->getName(), 'arguments' => $attributeNode->getArguments()];
        }
