...
class ReflectionEntitySerializer implements EntitySerializerInterface
{
    ...
    public function __construct()
    {
        ...
        $this->deserializerMap = ['PHPClass' => $this->classSerializer, 'PHPFunction' => $this->functionSerializer, 'PHPInterface' => $this->interfaceSerializer, 'PHPEnum' => $this->enumSerializer, 'PHPConstant' => $this->constantSerializer];
    }
