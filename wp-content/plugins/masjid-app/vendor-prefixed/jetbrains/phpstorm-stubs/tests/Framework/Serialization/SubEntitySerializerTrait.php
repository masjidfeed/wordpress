...
namespace Masjid_App\Dependencies\StubTests\Framework\Serialization;
...
trait SubEntitySerializerTrait
{
    ...
    {
        $data = ['name' => $method->getName(), 'isStatic' => $method->isStatic(), 'isFinal' => $method->isFinal(), 'isAbstract' => $method->isAbstract(), 'isDeprecated' => $method->isDeprecated()];
    ...
    {
        $data = ['name' => $parameter->getName(), 'position' => $parameter->getPosition(), 'isOptional' => $parameter->isOptional(), 'isVariadic' => $parameter->isVariadic(), 'isPassedByReference' => $parameter->isPassedByReference(), 'isDeprecated' => $parameter->isDeprecated(), 'hasDefaultValue' => $parameter->hasDefaultValue()];
    ...
    {
        $data = ['name' => $property->getName(), 'isStatic' => $property->isStatic(), 'isReadonly' => $property->isReadonly()];
    ...
    {
        $data = ['name' => $constant->getName(), 'value' => $this->toJsonSafe($constant->getValue()), 'visibility' => $constant->getAccess()->value, 'isFinal' => $constant->isFinal()];
