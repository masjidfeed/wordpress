...
use Masjid_App\Dependencies\StubTests\Framework\Validator\Services\ParameterCountComparator;
/**
...
class ClassMethodsParametersCountCheck extends AbstractMemberFlagCheck implements DescribesMethodMismatch
{
    ...
    {
        $mismatch = ParameterCountComparator::compare($reflMethod->getParameters(), $stubMethod->getParameters(), $phpVersion);
        if ($mismatch === null) {
            return null;
        }
