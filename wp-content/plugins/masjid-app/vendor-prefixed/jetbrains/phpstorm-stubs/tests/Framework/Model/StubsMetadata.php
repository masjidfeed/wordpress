...
final class StubsMetadata
{
    ...
    {
        if (!in_array($sourcePath, $this->duplicates, \true)) {
    ...
    {
        return ($this->sinceVersion === null || version_compare($phpVersion, $this->sinceVersion, '>=')) && ($this->removedVersion === null || version_compare($phpVersion, $this->removedVersion, '<'));
    }
}
