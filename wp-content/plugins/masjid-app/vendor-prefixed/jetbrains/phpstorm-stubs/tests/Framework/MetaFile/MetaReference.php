...
final class MetaReference
{
    ...
    public function __construct(public readonly MetaReferenceType $type, public readonly string $fqn, public readonly string $sourceFile, public readonly int $line, public readonly MetaReferenceRole $role = MetaReferenceRole::VALUE)
    {
    }
