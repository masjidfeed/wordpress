...
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Stubs\Nodes\InterfaceNode;
/**
...
class StubInterfaceParser implements MultiEntityStubParserInterface
{
    ...
    public function __construct(?InterfaceNodeExtractorInterface $nodeExtractor = null, ?PhpDocParserInterface $phpDocParser = null, ?TypeParserInterface $typeParser = null, ?AvailableVersionParserInterface $versionParser = null)
    {
    ...
    public function parseNode(InterfaceNode $node, array $imports = []): PHPInterface
    {
        ...
        foreach ($node->getParentInterfaceNames() as $parentInterfaceName) {
            ...
            $parentInterface->setId($this->nameResolver->resolve($parentInterfaceName, $imports, $node->getNamespace()));
