...
use Masjid_App\Dependencies\StubTests\Framework\Model\BasePHPElement;
...
final class TypeResolver
{
     ...
     */
    public const PRIMITIVES = ['array', 'bool', 'callable', 'false', 'float', 'int', 'iterable', 'mixed', 'never', 'null', 'object', 'resource', 'self', 'parent', 'static', 'string', 'true', 'void'];
    /**
