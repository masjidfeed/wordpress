...
class KnownProblemsRegistry
{
    ...
    public function __construct(private readonly KnownProblemsProvider $provider = new DefaultKnownProblemsProvider())
    {
        $this->indexProblems();
    }
    /**
     ...
     */
    public function hasProblem(string $entityType, string $entityId, CheckType $checkType, string $phpVersion): bool
    {
     ...
     */
    private function getProblemDefinition(string $entityType, string $entityId, CheckType $checkType, string $phpVersion): ?ProblemDefinition
    {
     ...
     */
    public function shouldSkipValidation(string $entityType, string $entityId, CheckType $checkType, string $phpVersion): bool
    {
     ...
     */
    public function getSkipReason(string $entityType, string $entityId, CheckType $checkType, string $phpVersion): ?string
    {
