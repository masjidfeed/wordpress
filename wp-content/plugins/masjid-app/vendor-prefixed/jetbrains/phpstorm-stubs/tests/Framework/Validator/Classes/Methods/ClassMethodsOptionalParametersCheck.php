...
use Masjid_App\Dependencies\StubTests\Framework\Validator\Services\OptionalParametersComparator;
/**
...
class ClassMethodsOptionalParametersCheck extends AbstractMemberFlagCheck implements DescribesMethodMismatch
{
    ...
    {
        $mismatches = OptionalParametersComparator::findMismatches($reflMethod->getParameters(), $stubMethod->getParameters(), $phpVersion);
        if (empty($mismatches)) {
            return null;
        }
