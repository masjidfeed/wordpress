...
class DeprecationParser
{
     ...
     */
    private const SINCE_POSITION = [self::FLAVOUR_JETBRAINS => 2, self::FLAVOUR_BUILTIN => 1];
    /**
    ...
    public function parseDeprecation(array $attributes, array $imports = [], ?ParsedPhpDoc $phpDoc = null): ParsedDeprecation
    {
        ...
        foreach ($attributes as $attribute) {
            ...
            break;
            // Only the first deprecation attribute is meaningful
        }
    ...
    {
        if ($fullName === 'JetBrains\PhpStorm\Deprecated' || str_ends_with($fullName, 'Masjid_App\Dependencies\PhpStorm\Deprecated')) {
