...
namespace Masjid_App\Dependencies\StubTests\Framework\Parsers\Reflection\Wrappers;
...
class ReflectionTypeRegistry
{
     ...
     * @var array
     */
    private static $typeMapping = ['ReflectionClass' => AdaptedReflectionClass::class, 'ReflectionMethod' => AdaptedReflectionMethod::class, 'ReflectionFunction' => AdaptedReflectionFunction::class, 'ReflectionParameter' => AdaptedReflectionParameter::class, 'ReflectionProperty' => AdaptedReflectionProperty::class, 'ReflectionClassConstant' => AdaptedReflectionClassConstant::class, 'ReflectionType' => AdaptedReflectionType::class];
    /**
