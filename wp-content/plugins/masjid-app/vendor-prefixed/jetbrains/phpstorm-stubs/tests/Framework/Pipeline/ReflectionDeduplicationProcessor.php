...
namespace Masjid_App\Dependencies\StubTests\Framework\Pipeline;
...
use Masjid_App\Dependencies\StubTests\Framework\Model\PHPNamespacedElement;
/**
...
class ReflectionDeduplicationProcessor implements EntityProcessor
{
    ...
    private function getEntityId($entity): string
    {
        ...
        $name = '';
        $namespace = '';
        if ($entity instanceof PHPClass || $entity instanceof PHPInterface || $entity instanceof PHPEnum || $entity instanceof PHPFunction || $entity instanceof PHPConstant) {
