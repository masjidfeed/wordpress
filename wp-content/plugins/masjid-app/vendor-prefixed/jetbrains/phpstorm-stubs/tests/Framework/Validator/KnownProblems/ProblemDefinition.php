...
namespace Masjid_App\Dependencies\StubTests\Framework\Validator\KnownProblems;
...
readonly class ProblemDefinition
{
     ...
     */
    public function __construct(public EntityType $entityType, public string $entityId, public ProblemType $type, public array $affectedChecks, public PhpVersionRange $versionRange, public string $reason, public array $entityIds = [])
    {
    ...
    {
        return in_array($check, $this->affectedChecks, \true) && $this->versionRange->includes($phpVersion);
    }
    /**
