...
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Stubs\PhpDoc\ParsedPhpDoc;
...
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Stubs\Nodes\ParameterNode;
/**
...
class StubParameterParser
{
    ...
    public function __construct(?TypeParserInterface $typeParser = null, ?AvailableVersionParserInterface $versionParser = null)
    {
    ...
    public function parseNode(ParameterNode $node, array $paramTypesFromPhpDoc = [], array $imports = [], string $namespace = '\\', array $optionalParamsFromPhpDoc = [], int $position = 0): PHPParameter
    {
        ...
        $isOptional = $hasDefault || $node->isVariadic() || in_array($paramName, $optionalParamsFromPhpDoc, \true);
