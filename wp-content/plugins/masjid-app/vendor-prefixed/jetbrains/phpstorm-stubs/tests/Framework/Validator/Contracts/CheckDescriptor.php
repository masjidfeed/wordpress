...
use Masjid_App\Dependencies\StubTests\ValidatorTestBase;
/**
...
final readonly class CheckDescriptor
{
     ...
     */
    public function __construct(public string $checkClass, public PhpVersions $fromVersion, public PhpVersions $toVersion, public string $messageTemplate, public ?EntityTypeConfig $entityTypeConfig = null)
    {
    }
}
