...
class AllStubsParser
{
     ...
     */
    public function __construct(private StubsDataProvider $dataProvider, private ParsedDataWriter $storageManager, private array $parsers)
    {
    }
    public function parseAll(): void
    {
        ...
        foreach ($files as $filePath) {
            ...
            foreach ($this->parsers as $parser) {
                ...
                } catch (\Masjid_App\Dependencies\PhpParser\Error $e) {
