...
abstract class AbstractConstantFlagCheck extends AbstractClassCheck
{
     ...
     */
    abstract protected function describeMismatch(string $constantEntityId, PHPClassConstant $reflConstant, PHPClassConstant $stubConstant, string $phpVersion): ?string;
