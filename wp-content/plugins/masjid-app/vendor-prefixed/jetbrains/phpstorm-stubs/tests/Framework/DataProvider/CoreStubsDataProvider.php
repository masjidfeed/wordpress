...
class CoreStubsDataProvider implements StubsDataProvider
{
     ...
     */
    public function __construct(StubCategory|array $categories, ?StubsDataProvider $innerProvider = null)
    {
    ...
    public function getAllStubFiles(): array
    {
        ...
        $this->cachedStubFiles = array_values(array_filter($this->innerProvider->getAllStubFiles(), fn(string $path) => $this->isPathAllowed($path, $allowedDirectories)));
        return $this->cachedStubFiles;
    }
