...
class EntityExistsCheck extends AbstractReflectionCheck
{
    ...
    public function __construct(?EntityTypeConfig $entityTypeConfig = null, ?KnownProblemsRegistry $knownProblemsRegistry = null, ?EntityLookupService $entityLookup = null)
    {
