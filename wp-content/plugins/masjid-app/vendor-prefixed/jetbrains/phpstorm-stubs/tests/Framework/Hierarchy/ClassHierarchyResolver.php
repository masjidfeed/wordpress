...
namespace Masjid_App\Dependencies\StubTests\Framework\Hierarchy;
...
class ClassHierarchyResolver
{
    ...
    private function resolveClass(PHPClass $class, array $classMap, array $interfaceMap): void
    {
        ...
        if ($class->getParentClass() !== null) {
            $class->setParentClass($this->lookupEntity($class->getParentClass(), $class->getNamespace(), $classMap) ?? $class->getParentClass());
        }
