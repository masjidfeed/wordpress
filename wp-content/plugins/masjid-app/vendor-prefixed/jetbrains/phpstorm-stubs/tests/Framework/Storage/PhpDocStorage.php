...
class PhpDocStorage implements PhpDocRepository
{
    ...
    public function __construct(string $pathToJsonFile, bool $loadExisting = \true)
    {
    ...
    public function save(): void
    {
        ...
        $json = json_encode($this->phpDocs, \JSON_PRETTY_PRINT | \JSON_UNESCAPED_SLASHES | \JSON_UNESCAPED_UNICODE);
        if ($json === \false) {
