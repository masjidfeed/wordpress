...
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Stubs\Adapters\Nikic\NikicNodeExtractor;
...
class StubFunctionParser implements MultiEntityStubParserInterface
{
    ...
    public function __construct(?FunctionNodeExtractorInterface $nodeExtractor = null, ?PhpDocParserInterface $phpDocParser = null, ?TypeParserInterface $typeParser = null, ?AvailableVersionParserInterface $versionParser = null)
    {
    ...
    public function parseNode(FunctionNode $node): PHPFunction
    {
        ...
        $parsedReturnType = $this->typeParser->parseType($node->getReturnType(), $parsedPhpDoc->returnType, $node->getAttributes(), $imports, $phpFunction->getNamespace());
