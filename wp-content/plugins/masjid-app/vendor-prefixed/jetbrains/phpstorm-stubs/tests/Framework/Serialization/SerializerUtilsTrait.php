...
trait SerializerUtilsTrait
{
    ...
    protected function toJsonSafe($value)
    {
        ...
        if ($value instanceof \Masjid_App\Dependencies\StubTests\Framework\Parsers\Stubs\StubEnumCaseReference) {
        ...
        if ($value instanceof \Masjid_App\Dependencies\StubTests\Framework\Parsers\Reflection\Wrappers\AdaptedEnumCaseReference) {
            return '[object:' . $value->getEnumFqn() . ']';
        }
