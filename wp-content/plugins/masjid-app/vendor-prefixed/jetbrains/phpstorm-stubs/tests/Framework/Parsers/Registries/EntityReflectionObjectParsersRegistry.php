...
namespace Masjid_App\Dependencies\StubTests\Framework\Parsers\Registries;
...
class EntityReflectionObjectParsersRegistry
{
    ...
    public function __construct(?ReflectionClassParser $classParser = null, ?ReflectionModernConstantParser $constantParser = null, ?ReflectionFunctionParser $functionParser = null, ?ReflectionInterfaceParser $interfaceParser = null, ?ReflectionEnumParser $enumParser = null)
    {
