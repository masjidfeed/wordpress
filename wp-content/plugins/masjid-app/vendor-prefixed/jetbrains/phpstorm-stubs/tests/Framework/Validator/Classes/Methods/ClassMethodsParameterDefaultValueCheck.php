...
use Masjid_App\Dependencies\StubTests\Framework\Validator\Services\ParameterDefaultValueComparator;
/**
...
class ClassMethodsParameterDefaultValueCheck extends AbstractMemberFlagCheck implements DescribesMethodMismatch
{
    ...
    public function describeMethodMismatch(string $methodEntityId, PHPMethod $reflMethod, PHPMethod $stubMethod, string $phpVersion): ?string
    {
        ...
        return "Method {$methodEntityId}: parameter default value mismatch(es): " . implode('; ', $mismatches);
    }
}
