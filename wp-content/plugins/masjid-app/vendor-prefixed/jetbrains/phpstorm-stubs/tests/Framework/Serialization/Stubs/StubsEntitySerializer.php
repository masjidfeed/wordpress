...
use Masjid_App\Dependencies\StubTests\Framework\Serialization\SerializerRegistry;
...
class StubsEntitySerializer implements EntitySerializerInterface
{
    ...
    public function __construct(?PhpDocRepository $phpDocStorage = null)
    {
        ...
        $this->deserializerMap = ['PHPClass' => $classSerializer, 'PHPFunction' => $functionSerializer, 'PHPInterface' => $interfaceSerializer, 'PHPEnum' => $enumSerializer, 'PHPConstant' => $constantSerializer];
    }
