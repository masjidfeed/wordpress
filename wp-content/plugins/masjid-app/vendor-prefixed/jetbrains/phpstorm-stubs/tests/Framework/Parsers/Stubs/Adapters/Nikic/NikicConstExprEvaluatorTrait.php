...
use Masjid_App\Dependencies\PhpParser\ConstExprEvaluationException;
use Masjid_App\Dependencies\PhpParser\ConstExprEvaluator;
...
trait NikicConstExprEvaluatorTrait
{
    ...
    private static function evaluateConstExpr(Expr $expr): mixed
    {
        ...
        set_error_handler(fn() => \true, \E_DEPRECATED | \E_WARNING);
        try {
    ...
    private static function sharedEvaluator(): ConstExprEvaluator
    {
        ...
        if ($evaluator === null) {
            $evaluator = new ConstExprEvaluator(function (Expr $node): mixed {
