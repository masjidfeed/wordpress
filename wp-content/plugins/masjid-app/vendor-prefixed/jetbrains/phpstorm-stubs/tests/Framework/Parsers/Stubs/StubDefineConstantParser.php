...
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Stubs\Nodes\ConstantDefinitionNode;
...
class StubDefineConstantParser implements MultiEntityStubParserInterface
{
    ...
    public function __construct(?ConstantNodeExtractorInterface $nodeExtractor = null, ?PhpDocParserInterface $phpDocParser = null, ?AvailableVersionParserInterface $versionParser = null)
    {
