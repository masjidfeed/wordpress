...
class ReflectionClassParser implements Parser
{
    ...
    public function __construct(?ReflectionMethodParser $methodParser = null, ?ReflectionPropertyParser $propertyParser = null, ?ReflectionClassConstantParser $constantParser = null, ?ReflectionParentClassParser $parentClassParser = null, ?ReflectionImplementedInterfaceParser $interfaceParser = null)
    {
    ...
    {
        return $object instanceof AdaptedReflectionClass && $object->isInternal() && !$object->isInterface() && !$object->isEnum();
    }
    /**
