...
enum StubCategory : string
{
    ...
    {
        return match ($this) {
            self::CORE => ['apache', 'Core', 'date', 'filter', 'fpm', 'hash', 'io', 'litespeed', 'meta', 'pcre', 'Phar', 'phpdbg', 'random', 'Reflection', 'session', 'SPL', 'standard', 'superglobals', 'tokenizer', 'uri'],
            self::BUNDLED => ['ctype', 'curl', 'dom', 'fileinfo', 'iconv', 'json', 'libxml', 'mbstring', 'openssl', 'PDO', 'posix', 'readline', 'SimpleXML', 'sodium', 'sqlite3', 'xml', 'xmlreader', 'xmlwriter', 'zlib'],
            self::EXTERNAL => ['bcmath', 'bz2', 'calendar', 'com_dotnet', 'dba', 'enchant', 'exif', 'FFI', 'ftp', 'gd', 'gettext', 'gmp', 'imap', 'interbase', 'intl', 'ldap', 'mcrypt', 'mssql', 'mysql', 'mysqli', 'oci8', 'odbc', 'pcntl', 'pgsql', 'pspell', 'recode', 'regex', 'shmop', 'snmp', 'soap', 'sockets', 'sybase', 'sysvmsg', 'sysvsem', 'sysvshm', 'tidy', 'wddx', 'xmlrpc', 'xsl', 'Zend OPcache', 'zip'],
            self::PECL => ['aerospike', 'amqp', 'apcu', 'ast', 'brotli', 'cassandra', 'couchbase', 'couchbase_v2', 'crypto', 'cubrid', 'decimal', 'dio', 'ds', 'ds_v2', 'eio', 'Ev', 'event', 'excimer', 'expect', 'fann', 'ffmpeg', 'gearman', 'geoip', 'geos', 'gmagick', 'gnupg', 'grpc', 'http', 'ibm_db2', 'igbinary', 'imagick', 'inotify', 'jsonpath', 'judy', 'leveldb', 'libevent', 'libsodium', 'libvirt-php', 'lua', 'LuaSandbox', 'lzf', 'mailparse', 'mapscript', 'maxminddb', 'memcache', 'memcached', 'meminfo', 'ming', 'mongo', 'mongodb', 'mosquitto-php', 'mqseries', 'msgpack', 'mysql_xdevapi', 'ncurses', 'oauth', 'opentelemetry', 'pam', 'parallel', 'Parle', 'pcov', 'pq', 'pthreads', 'radius', 'rar', 'rdkafka', 'redis', 'rpminfo', 'rrd', 'simdjson', 'simple_kafka_client', 'snappy', 'solr', 'SplType', 'SQLite', 'sqlsrv', 'ssh2', 'stats', 'stomp', 'svm', 'svn', 'swoole', 'sync', 'uopz', 'uploadprogress', 'uuid', 'uv', 'v8js', 'win32service', 'xdebug', 'xdiff', 'xhprof', 'xlswriter', 'xxtea', 'yaf', 'yaml', 'yar', 'zmq', 'zookeeper', 'zstd'],
            self::OTHERS => ['blackfire', 'ddtrace', 'elastic_apm', 'frankenphp', 'newrelic', 'pdflib', 'relay', 'SaxonC', 'suhosin', 'winbinder', 'wincache', 'xcache', 'zend', 'ZendCache', 'ZendDebugger', 'ZendUtils'],
        };
    }
    /**
    ...
    public function containsDirectory(string $directoryName): bool
    {
        ...
        if (!isset($index[$this->value])) {
            $index[$this->value] = array_fill_keys($this->getDirectories(), \true);
        }
