...
use Masjid_App\Dependencies\StubTests\Framework\MetaFile\MetaFileReferenceExtractor;
...
use Masjid_App\Dependencies\StubTests\Framework\Validator\Meta\ConstantsReferenceExistsCheck;
use Masjid_App\Dependencies\StubTests\Framework\Validator\Meta\ExpectedArgumentsAreUniqueCheck;
use Masjid_App\Dependencies\StubTests\Framework\Validator\Meta\ExpectedReturnValuesAreUniqueCheck;
use Masjid_App\Dependencies\StubTests\Framework\Validator\Meta\FunctionReferencesExistsCheck;
use Masjid_App\Dependencies\StubTests\Framework\Validator\Meta\ReferencesAreFullyQualifiedCheck;
use Masjid_App\Dependencies\StubTests\Framework\Validator\Meta\RegisteredArgumentsSetAreUniqueCheck;
use Masjid_App\Dependencies\StubTests\Framework\Validator\Meta\RegisteredArgumentsSetExistsCheck;
use Masjid_App\Dependencies\StubTests\Framework\Validator\Meta\MetaInternalTagCheck;
...
class MetaFileValidatorTest extends TestCase
{
    ...
    public function testFunctionReferenceExistsInStubs(string $entityId): void
    {
        ...
        $this->assertEmpty($failures, "Meta function/method reference not found in stubs:\n" . implode("\n", $failures));
    }
    ...
    public function testConstantReferenceExistsInStubs(string $entityId): void
    {
        ...
        $results = $check->run($stubs, $entityId, PhpVersions::LATEST->value);
        $failures = $results->getFailures();
        $this->assertEmpty($failures, "Meta constant reference not found in stubs:\n" . implode("\n", $failures));
    }
    ...
    public function testRegisteredArgumentsSetExists(string $setName): void
    {
        ...
        $failures = $results->getFailures();
        $this->assertEmpty($failures, "argumentsSet reference not found:\n" . implode("\n", $failures));
    }
