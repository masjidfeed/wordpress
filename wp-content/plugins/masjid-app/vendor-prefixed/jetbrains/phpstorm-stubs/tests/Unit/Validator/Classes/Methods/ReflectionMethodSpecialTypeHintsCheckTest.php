...
class ReflectionMethodSpecialTypeHintsCheckTest extends CheckTestCase
{
    ...
    {
        $method = $this->makeMethodWithLanguageLevelTypes('getReturnType', ['7.1' => 'ReflectionNamedType|null', '8.0' => 'ReflectionNamedType|ReflectionUnionType|null', '8.1' => 'ReflectionNamedType|ReflectionUnionType|ReflectionIntersectionType|null']);
        $stubClass = $this->createMockClassWithProperties('\ReflectionFunctionAbstract', null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
    ...
    {
        $method = $this->makeMethodWithLanguageLevelTypes('getReturnType', [
            '7.1' => 'ReflectionType|null',
            // wrong — should be ReflectionNamedType|null
    ...
    {
        $method = $this->makeMethodWithLanguageLevelTypes('getType', ['7.1' => 'ReflectionNamedType|null', '8.0' => 'ReflectionNamedType|ReflectionUnionType|null', '8.1' => 'ReflectionNamedType|ReflectionUnionType|ReflectionIntersectionType|null']);
        $stubClass = $this->createMockClassWithProperties('\ReflectionParameter', null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    {
        $method = $this->makeMethodWithLanguageLevelTypes('getType', ['8.0' => 'ReflectionNamedType|ReflectionUnionType|null', '8.1' => 'ReflectionNamedType|ReflectionUnionType|ReflectionIntersectionType|null']);
        $stubClass = $this->createMockClassWithProperties('\ReflectionProperty', null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    {
        $method = $this->makeMethodWithLanguageLevelTypes('getBackingType', ['8.2' => 'ReflectionNamedType|null']);
        $stubClass = $this->createMockClassWithProperties('\ReflectionEnum', null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    {
        $method = $this->makeMethodWithLanguageLevelTypes('getBackingType', ['8.2' => 'ReflectionType|null']);
        $stubClass = $this->createMockClassWithProperties('\ReflectionEnum', null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, '\ReflectionEnum', '8.2');
    ...
    public function testMethodAbsentFromClassIsSkipped(): void
    {
        ...
        $stubClass = $this->createMockClassWithProperties('\ReflectionFunctionAbstract', null, null, null, []);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, '\ReflectionFunctionAbstract', '8.1');
        $this->assertFalse($result->hasFailures());
    ...
    public function testClassLevelKnownProblemSuppresses(): void
    {
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::CLASS_TYPE, entityId: $entityId, type: ProblemType::RUNTIME_VALUE, affectedChecks: [CheckType::REFLECTION_SPECIAL_TYPE_HINTS], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Test suppression')]);
        KnownProblemsRegistry::reset();
    ...
    public function testMethodLevelKnownProblemSuppressesMethod(): void
    {
        ...
        $knownProblemsProvider = $this->createStub(KnownProblemsProvider::class);
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::METHOD, entityId: $methodId, type: ProblemType::RUNTIME_VALUE, affectedChecks: [CheckType::REFLECTION_SPECIAL_TYPE_HINTS], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Method-level suppression')]);
        KnownProblemsRegistry::reset();
        $registry = KnownProblemsRegistry::getInstance($knownProblemsProvider);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
