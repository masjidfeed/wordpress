...
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Reflection\ReflectionClassParser;
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Reflection\Wrappers\AdaptedReflectionClass;
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Reflection\Wrappers\AdaptedReflectionClassConstant;
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Reflection\Wrappers\AdaptedReflectionMethod;
...
class ReflectionClassParserTest extends BaseTestCase
{
    ...
    {
        $stubReflectionClass = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $stubReflectionClass->method('isInternal')->willReturn(\true);
    ...
    public function testItCanNotParseInternalInterface()
    {
        $stubReflectionClass = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $stubReflectionClass->method('isInternal')->willReturn(\true);
        $stubReflectionClass->method('isInterface')->willReturn(\true);
        self::assertFalse((new ReflectionClassParser())->canParse($stubReflectionClass));
    }
    ...
    public function testItCanNotParseInternalEnums()
    {
        $stubReflectionClass = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $stubReflectionClass->method('isInternal')->willReturn(\true);
        $stubReflectionClass->method('isEnum')->willReturn(\true);
        self::assertFalse((new ReflectionClassParser())->canParse($stubReflectionClass));
    }
    ...
    {
        $reflectionMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionMock->method('getNamespaceName')->willReturn('Masjid_App\Dependencies\MyNameSpace\SubNameSpace');
        $basePHPElement = (new ReflectionClassParser())->parse($reflectionMock);
    ...
    public function testItCanParseId()
    {
        ...
        $reflectionMock->method('getName')->willReturn('Masjid_App\Dependencies\SomeNamespace\SubNamespace\SomeFooClass');
        $reflectionMock->method('getNamespaceName')->willReturn('Masjid_App\Dependencies\SomeNamespace\SubNamespace');
        $basePHPElement = (new ReflectionClassParser())->parse($reflectionMock);
        self::assertEquals('Masjid_App\Dependencies\SomeNamespace\SubNamespace\SomeFooClass', $basePHPElement->getId());
    }
    ...
    {
        $reflectionMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->onlyMethods([])->getMock();
        $basePHPElement = (new ReflectionClassParser())->parse($reflectionMock);
    ...
    {
        $reflectionMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionMock->method('isFinal')->willReturn(\true);
        $basePHPElement = (new ReflectionClassParser())->parse($reflectionMock);
    ...
    {
        $reflectionMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionMock->method('isReadOnly')->willReturn(\true);
        $basePHPElement = (new ReflectionClassParser())->parse($reflectionMock);
    ...
    public function testItCanParseClassWithMethods()
    {
        ...
        $reflectionMethodMock = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['getName'])->getMock();
    ...
    {
        $reflectionClassMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionMethodMock1 = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['getName'])->getMock();
        $reflectionMethodMock2 = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['getName'])->getMock();
        $reflectionMethodMock3 = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['getName'])->getMock();
    ...
    {
        $reflectionClassMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionPropertyMock = $this->getMockBuilder(AdaptedReflectionProperty::class)->disableOriginalConstructor()->onlyMethods(['getName'])->getMock();
    ...
    {
        $reflectionClassMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionPropertyMock1 = $this->getMockBuilder(AdaptedReflectionProperty::class)->disableOriginalConstructor()->onlyMethods(['getName'])->getMock();
        $reflectionPropertyMock2 = $this->getMockBuilder(AdaptedReflectionProperty::class)->disableOriginalConstructor()->onlyMethods(['getName'])->getMock();
        $reflectionPropertyMock3 = $this->getMockBuilder(AdaptedReflectionProperty::class)->disableOriginalConstructor()->onlyMethods(['getName'])->getMock();
    ...
    {
        $reflectionClassMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionClassMock->method('hasReflectionConstants')->willReturn(\true);
    ...
    {
        $reflectionClassMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionClassConstantMock = $this->getMockBuilder(AdaptedReflectionClassConstant::class)->disableOriginalConstructor()->onlyMethods(['getName', 'getValue'])->getMock();
    ...
    {
        $reflectionClassMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionClassConstantMock1 = $this->getMockBuilder(AdaptedReflectionClassConstant::class)->disableOriginalConstructor()->onlyMethods(['getName', 'getValue'])->getMock();
        $reflectionClassConstantMock2 = $this->getMockBuilder(AdaptedReflectionClassConstant::class)->disableOriginalConstructor()->onlyMethods(['getName', 'getValue'])->getMock();
        $reflectionClassConstantMock3 = $this->getMockBuilder(AdaptedReflectionClassConstant::class)->disableOriginalConstructor()->onlyMethods(['getName', 'getValue'])->getMock();
    ...
    public function testItReturnsImplementedInterfacesWithCorrectNamespace()
    {
        ...
        $reflectionInterfaceMock->method('getName')->willReturn('Masjid_App\Dependencies\My\Namespace\Interface');
        $reflectionInterfaceMock->method('getNamespaceName')->willReturn('Masjid_App\Dependencies\My\Namespace');
        $reflectionClassMock->method('getInterfaces')->willReturn([$reflectionInterfaceMock]);
        $basePHPElement = (new ReflectionClassParser())->parse($reflectionClassMock);
        self::assertEquals("Masjid_App\\Dependencies\\My\\Namespace\\Interface", $basePHPElement->getImplementedInterfaces()[0]->getId());
        self::assertEquals("Masjid_App\\Dependencies\\My\\Namespace", $basePHPElement->getImplementedInterfaces()[0]->getNamespace());
    }
