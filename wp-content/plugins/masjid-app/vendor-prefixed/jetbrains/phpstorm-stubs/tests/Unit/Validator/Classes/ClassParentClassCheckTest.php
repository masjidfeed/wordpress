...
class ClassParentClassCheckTest extends CheckTestCase
{
    ...
    public function testKnownProblemSkipsValidation(): void
    {
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::CLASS_TYPE, entityId: $className, type: ProblemType::OVERLOADED_SIGNATURE, affectedChecks: [CheckType::CLASS_PARENT], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Test known problem')]);
        KnownProblemsRegistry::reset();
    ...
    {
        // Arrange
        $className = 'Masjid_App\Dependencies\Dom\Element';
        $parentClassName = 'Masjid_App\Dependencies\Dom\Node';
        $reflectionParent = $this->createMockClassWithProperties($parentClassName);
    ...
    public function testNamespacedParentMatchedViaId(): void
    {
        ...
        $classId = 'Masjid_App\Dependencies\Random\BrokenRandomEngineError';
        ...
        $stubRandomError->setId('Masjid_App\Dependencies\Random\RandomError');
        ...
        $reflectionParent = $this->createMockClassWithProperties('Masjid_App\Dependencies\Random\RandomError');
    ...
    public function testLinkedReflectionParentUsesIdNotShortName(): void
    {
        ...
        $reflectionRandomError->setName('RandomError');
        // short name (as getName() returns after linking)
        $reflectionRandomError->setId('Masjid_App\Dependencies\Random\RandomError');
        // full id
