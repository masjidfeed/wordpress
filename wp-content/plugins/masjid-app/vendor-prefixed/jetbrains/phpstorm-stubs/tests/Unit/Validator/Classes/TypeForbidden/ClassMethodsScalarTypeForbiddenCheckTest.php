...
namespace Masjid_App\Dependencies\StubTests\Unit\Validator\Classes\TypeForbidden;
...
class ClassMethodsScalarTypeForbiddenCheckTest extends CheckTestCase
{
    ...
    {
        $className = '\MyClass';
        $method = $this->makeMethod('doSomething', parameters: [$this->makeParam('val', new StandaloneType($scalarType))]);
    ...
    {
        return ['int' => ['int'], 'float' => ['float'], 'string' => ['string'], 'bool' => ['bool']];
    }
    ...
    {
        $className = '\MyClass';
        $method = $this->makeMethod('doSomething', parameters: [$this->makeParam('val', new StandaloneType($typeName))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::EARLIEST->value);
    ...
    {
        return ['array' => ['array'], 'callable' => ['callable'], 'class name' => ['DateTime'], 'self' => ['self'], 'parent' => ['parent']];
    }
    ...
    public function testNullableScalarParamTypeIsFailure(): void
    {
        ...
        $method = $this->makeMethod('doSomething', parameters: [$this->makeParam('val', $nullableInt)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::EARLIEST->value);
    ...
    public function testNullableNonScalarParamTypeSucceeds(): void
    {
        ...
        $className = '\MyClass';
        $method = $this->makeMethod('doSomething', parameters: [$this->makeParam('val', $this->createNullableType('array'))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::EARLIEST->value);
    ...
    public function testMethodAvailableOnlyFromPhp70IsNotCollectedForPhp56(): void
    {
        ...
        $className = '\MyClass';
        $method = $this->makeMethod('doSomething', sinceVersion: '7.0', parameters: [$this->makeParam('val', new StandaloneType('int'))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::EARLIEST->value);
    ...
    {
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('privateWork', access: 'private', parameters: [$this->makeParam('val', new StandaloneType('int'))])]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::EARLIEST->value);
    ...
    {
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('protectedWork', access: 'protected', parameters: [$this->makeParam('val', new StandaloneType('int'))])]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::EARLIEST->value);
    ...
    {
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('finalWork', isFinal: \true, parameters: [$this->makeParam('val', new StandaloneType('int'))])]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::EARLIEST->value);
    ...
    public function testFinalClassMethodsAreNotFlagged(): void
    {
        ...
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('doWork', parameters: [$this->makeParam('val', new StandaloneType('int'))])]);
        $stubClass->setIsFinal(\true);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::EARLIEST->value);
    ...
    {
        $className = '\MyClass';
        $method = $this->makeMethod('tentativeWork', isTentative: \true, parameters: [$this->makeParam('val', new StandaloneType('int'))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::EARLIEST->value);
    ...
    {
        $className = '\MyClass';
        $method = $this->makeMethod('doSomething', parameters: [$this->makeParam('a', new StandaloneType('int')), $this->makeParam('b', new StandaloneType('string')), $this->makeParam('c', new StandaloneType('array'))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::EARLIEST->value);
    ...
    public function testKnownProblemAtClassLevelSkipsAllMethods(): void
    {
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::CLASS_TYPE, entityId: $className, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::SCALAR_TYPE_FORBIDDEN], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Test class skip')]);
        KnownProblemsRegistry::reset();
    ...
    public function testKnownProblemAtMethodLevelSkipsSpecificMethod(): void
    {
        ...
        $knownProblemsProvider = $this->createStub(\Masjid_App\Dependencies\StubTests\Framework\Validator\KnownProblems\KnownProblemsProvider::class);
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::METHOD, entityId: $methodEntityId, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::SCALAR_TYPE_FORBIDDEN], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Test method skip')]);
        KnownProblemsRegistry::reset();
        $registry = KnownProblemsRegistry::getInstance($knownProblemsProvider);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('doWork', parameters: [$this->makeParam('val', new StandaloneType('int'))])]);
        $stubs = $this->createMockStorageManager();
