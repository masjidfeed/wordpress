...
class FunctionPhpDocConformsSignatureCheckTest extends CheckTestCase
{
    ...
    public function testIncompatibleParamTypeFails(): void
    {
        ...
        $param->initStubsMetadata()->setTypeFromPhpDoc('int');
        // incompatible
    ...
    public function testKnownProblemSkipsFunction(): void
    {
        ...
        $func = $this->makeFunctionWithPhpDoc($functionId, 'string', 'int');
        // mismatch
        $stubs = $this->createMockStorageManager();
        $stubs->method('getFunctions')->willReturn([$func]);
     ...
     */
    private function makeFunctionWithPhpDoc(string $name, ?string $sigReturnType, ?string $docReturnType, array $params = []): PHPFunction
    {
