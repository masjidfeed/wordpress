...
class ClassMethodsParameterDeprecationCheckTest extends CheckTestCase
{
    ...
    {
        $className = '\MyClass';
        $reflMethod = $this->createMockMethod('doWork', [$this->makeParam('oldParam', deprecated: \true)]);
        $stubMethod = $this->createMockMethod('doWork', [$this->makeParam('oldParam', deprecated: \true)]);
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$reflMethod]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$stubMethod]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    {
        $className = '\MyClass';
        $reflMethod = $this->createMockMethod('define', [$this->makeParam('case_insensitive', deprecated: \true)]);
    ...
    public function testStubParameterDeprecationStartingLaterDoesNotSatisfyReflection(): void
    {
        ...
        $className = '\MyClass';
        $reflMethod = $this->createMockMethod('define', [$this->makeParam('case_insensitive', deprecated: \true)]);
        $stubMethod = $this->createMockMethod('define', [$this->makeParam('case_insensitive', deprecated: \true, deprecatedSinceVersion: '8.4')]);
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$reflMethod]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$stubMethod]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    {
        $className = '\MyClass';
        $reflMethod = $this->createMockMethod('doWork', [$this->makeParam('a', deprecated: \true), $this->makeParam('b'), $this->makeParam('c', deprecated: \true)]);
        $stubMethod = $this->createMockMethod('doWork', [$this->makeParam('a'), $this->makeParam('b'), $this->makeParam('c')]);
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$reflMethod]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$stubMethod]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    {
        $className = '\MyClass';
        $reflMethod = $this->createMockMethod('onlyInRefl', [$this->makeParam('p', deprecated: \true)]);
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$reflMethod]);
        $stubClass = $this->createMockClassWithProperties($className);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    {
        $className = '\MyClass';
        $reflMethod = $this->createMockMethod('doWork', [$this->makeParam('kept'), $this->makeParam('removed', deprecated: \true)]);
        // Stub only has 'kept' — 'removed' is absent
        $stubMethod = $this->createMockMethod('doWork', [$this->makeParam('kept')]);
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$reflMethod]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$stubMethod]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    public function testClassLevelKnownProblemSkipsAllMethods(): void
    {
        ...
        $reflMethod = $this->createMockMethod('doWork', [$this->makeParam('p', deprecated: \true)]);
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::CLASS_TYPE, entityId: $className, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::PARAMETER_DEPRECATION], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Class-level skip reason')]);
        KnownProblemsRegistry::reset();
    ...
    public function testMethodLevelKnownProblemSkipsSpecificMismatch(): void
    {
        ...
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$stubMethod]);
        $knownProblemsProvider = $this->createStub(\Masjid_App\Dependencies\StubTests\Framework\Validator\KnownProblems\KnownProblemsProvider::class);
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::METHOD, entityId: $mismatchedId, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::PARAMETER_DEPRECATION], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Method-level skip reason')]);
        KnownProblemsRegistry::reset();
        $registry = KnownProblemsRegistry::getInstance($knownProblemsProvider);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
