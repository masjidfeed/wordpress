...
class ClassMethodsUnionTypeForbiddenCheckTest extends CheckTestCase
{
    ...
    {
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('doSomething')]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_4->value);
        $this->assertFalse($result->hasFailures());
    ...
    {
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getString', new StandaloneType('string'))]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_4->value);
        $this->assertFalse($result->hasFailures());
    ...
    public function testNullableReturnTypeIsNotFlaggedAsUnionType(): void
    {
        ...
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getStr', $this->createNullableType('string'))]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_4->value);
    ...
    public function testNullableParamTypeIsNotFlaggedAsUnionType(): void
    {
        ...
        $className = '\MyClass';
        $method = $this->makeMethod('doSomething', parameters: [$this->makeParam('val', $this->createNullableType('string'))]);
    ...
    public function testUnionReturnTypeViaSignatureIsFailure(): void
    {
        ...
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getValue', $this->createUnionType('string', 'int'))]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_4->value);
    ...
    public function testUnionReturnTypeViaSignatureIsFailureAlsoForPhp56(): void
    {
        ...
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('get', $this->createUnionType('string', 'int'))]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    {
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('privateGet', $this->createUnionType('string', 'int'), access: 'private')]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_4->value);
    ...
    {
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('protectedGet', $this->createUnionType('string', 'int'), access: 'protected')]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_4->value);
    ...
    {
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('finalGet', $this->createUnionType('string', 'int'), isFinal: \true)]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_4->value);
    ...
    {
        $className = '\MyClass';
        $method = $this->makeMethod('tentativeGet', $this->createUnionType('string', 'int'), isTentative: \true);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_4->value);
    ...
    {
        $className = '\MyClass';
        $method = $this->makeMethod('doSomething', parameters: [$this->makeParam('val', $this->createUnionType('string', 'int'))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_4->value);
    ...
    {
        $className = '\MyClass';
        $method = $this->makeMethod('doSomething', parameters: [$this->makeParam('val', new StandaloneType('string'))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_4->value);
    ...
    public function testMethodWithUnionReturnAndUnionParamReportsBoth(): void
    {
        ...
        $method = $this->makeMethod(
            'doSomething',
            $this->createUnionType('string', 'int'),
            // union return
            parameters: [$this->makeParam('val', $this->createUnionType('bool', 'float'))]
        );
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testKnownProblemAtClassLevelSkipsAllMethods(): void
    {
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::CLASS_TYPE, entityId: $className, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::UNION_TYPE_FORBIDDEN], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Test class skip')]);
        KnownProblemsRegistry::reset();
    ...
    public function testKnownProblemAtMethodLevelSkipsSpecificMethod(): void
    {
        ...
        $knownProblemsProvider = $this->createStub(\Masjid_App\Dependencies\StubTests\Framework\Validator\KnownProblems\KnownProblemsProvider::class);
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::METHOD, entityId: $methodEntityId, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::UNION_TYPE_FORBIDDEN], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Test method skip')]);
        KnownProblemsRegistry::reset();
        $registry = KnownProblemsRegistry::getInstance($knownProblemsProvider);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getValue', $this->createUnionType('string', 'int'))]);
        $stubs = $this->createMockStorageManager();
