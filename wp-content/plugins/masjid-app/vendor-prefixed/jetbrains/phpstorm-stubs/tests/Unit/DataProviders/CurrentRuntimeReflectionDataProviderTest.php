...
PHP;
        eval($fake);
        self::assertTrue(function_exists('Masjid_App\Dependencies\my_custom_function'));
...
PHP;
        eval($fake);
        self::assertTrue(class_exists('Masjid_App\Dependencies\MyFakeClass'));
...
PHP;
        eval($fake);
        self::assertTrue(interface_exists('Masjid_App\Dependencies\MyFakeInterface'));
