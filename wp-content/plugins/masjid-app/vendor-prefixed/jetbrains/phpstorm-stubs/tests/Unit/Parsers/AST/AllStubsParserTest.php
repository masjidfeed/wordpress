...
use Masjid_App\Dependencies\StubTests\Framework\Pipeline\EntityProcessingPipeline;
...
use Masjid_App\Dependencies\StubTests\Framework\Pipeline\StubsDeduplicationProcessor;
...
class AllStubsParserTest extends BaseTestCase
{
    ...
    public function testItParsesMultipleFunctionsFromSingleFile()
    {
        ...
        $parsers = [new StubFunctionParser()];
