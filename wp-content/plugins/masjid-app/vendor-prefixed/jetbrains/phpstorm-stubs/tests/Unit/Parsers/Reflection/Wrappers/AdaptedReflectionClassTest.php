...
class AdaptedReflectionClassTest extends TestCase
{
    ...
    {
        $reflectionMock = $this->getMockBuilder(ReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionMock->method('getNamespaceName')->willReturn('Masjid_App\Dependencies\Foo\Bar');
        $adapted = new AdaptedReflectionClass($reflectionMock);
        self::assertEquals('Masjid_App\Dependencies\Foo\Bar', $adapted->getNamespaceName());
    }
    public function testItExtractsIsAbstract()
    {
        $reflectionMock = $this->getMockBuilder(ReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionMock->method('isAbstract')->willReturn(\true);
        $adapted = new AdaptedReflectionClass($reflectionMock);
    ...
    {
        $reflectionMock = $this->getMockBuilder(ReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionMock->method('isInterface')->willReturn(\true);
        $adapted = new AdaptedReflectionClass($reflectionMock);
    ...
    {
        $reflectionMock = $this->getMockBuilder(ReflectionClass::class)->disableOriginalConstructor()->getMock();
        $reflectionMock->method('isInternal')->willReturn(\true);
        $adapted = new AdaptedReflectionClass($reflectionMock);
    ...
    {
        $propertyMock = $this->getMockBuilder(ReflectionProperty::class)->disableOriginalConstructor()->getMock();
    ...
    {
        $parentMock = $this->getMockBuilder(ReflectionClass::class)->disableOriginalConstructor()->getMock();
    ...
    {
        $interfaceMock = $this->getMockBuilder(ReflectionClass::class)->disableOriginalConstructor()->getMock();
    ...
    {
        $traitMock = $this->getMockBuilder(ReflectionClass::class)->disableOriginalConstructor()->getMock();
    ...
    {
        $constructorMock = $this->getMockBuilder(ReflectionMethod::class)->disableOriginalConstructor()->getMock();
