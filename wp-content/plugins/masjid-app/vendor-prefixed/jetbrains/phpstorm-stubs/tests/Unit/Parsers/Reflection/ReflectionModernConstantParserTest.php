...
class ReflectionModernConstantParserTest extends TestCase
{
    ...
    {
        $parsedObject = (new ReflectionModernConstantParser())->parse(new ReflectionConstant('Masjid_App\Dependencies\TestNamespace\DUMMY_CONSTANT'));
        self::assertEquals("Masjid_App\\Dependencies\\TestNamespace\\DUMMY_CONSTANT", $parsedObject->getId());
    }
}
