...
class EntityLookupServiceTest extends CheckTestCase
{
    ...
    // ── Helper ───────────────────────────────────────────────────────────────
    private function createMockStorage(array $classes = [], array $enums = [], array $interfaces = [], array $functions = [], array $constants = []): StubDataQueryInterface
    {
    ...
    public function testFindAnyEntityByIdPrefersClassOverOtherTypes(): void
    {
        ...
        $storage = $this->createMockStorage(classes: [$class], interfaces: [$iface], enums: [$enum], functions: [$fn]);
