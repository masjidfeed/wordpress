...
namespace Masjid_App\Dependencies\Demo;
...
use Masjid_App\Dependencies\Other\Marker;
...
SRC;
        ...
        self::assertSame('Masjid_App\Dependencies\Other\Marker', ltrim($withImports[0]['imports']['Marker'], '\\'));
    }
}
