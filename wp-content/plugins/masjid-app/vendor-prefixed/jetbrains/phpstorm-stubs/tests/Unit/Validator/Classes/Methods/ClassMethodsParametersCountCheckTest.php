...
namespace Masjid_App\Dependencies\StubTests\Unit\Validator\Classes\Methods;
...
use Masjid_App\Dependencies\StubTests\Framework\Validator\Classes\Methods\ClassMethodsParametersCountCheck;
...
class ClassMethodsParametersCountCheckTest extends CheckTestCase
{
    ...
    public function testMatchingParameterCountIsSuccess(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('doWork', parameters: $params)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('doWork', parameters: $params)]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = (new ClassMethodsParametersCountCheck($provider))->run($stubs, $className, '8.0');
    ...
    {
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('doWork', parameters: [$this->makeParam('a'), $this->makeParam('b')])]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('doWork', parameters: [$this->makeParam('a')])]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = (new ClassMethodsParametersCountCheck($provider))->run($stubs, $className, '8.0');
    ...
    {
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('foo', parameters: [$this->makeParam('x'), $this->makeParam('y')]), $this->makeMethod('bar', parameters: [$this->makeParam('z')])]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [
            $this->makeMethod('foo', parameters: [$this->makeParam('x')]),
            // mismatch: stub has 1, refl has 2
    ...
    {
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('onlyInReflection', parameters: [$this->makeParam('x')])]);
        $stubClass = $this->createMockClassWithProperties($className);
        // no methods
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    public function testParamNotYetAddedIsExcludedFromCount(): void
    {
        ...
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('init', parameters: [$this->makeParam('a')])]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('init', parameters: [$this->makeParam('a'), $this->makeParam('b', sinceVersion: '8.1')])]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = (new ClassMethodsParametersCountCheck($provider))->run($stubs, $className, '8.0');
    ...
    public function testParamAddedAtExactSinceVersionIsIncluded(): void
    {
        ...
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('init', parameters: [$this->makeParam('a'), $this->makeParam('b')])]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('init', parameters: [$this->makeParam('a'), $this->makeParam('b', sinceVersion: '8.0')])]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = (new ClassMethodsParametersCountCheck($provider))->run($stubs, $className, '8.0');
    ...
    public function testParamAtExactRemovedVersionIsStillIncluded(): void
    {
        ...
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('legacy', parameters: [$this->makeParam('a'), $this->makeParam('b')])]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('legacy', parameters: [$this->makeParam('a'), $this->makeParam('b', removedVersion: '7.2')])]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testParamAfterRemovedVersionIsExcluded(): void
    {
        ...
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('legacy', parameters: [$this->makeParam('a')])]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('legacy', parameters: [$this->makeParam('a'), $this->makeParam('b', removedVersion: '7.1')])]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testVersionWindowParamCountedOnlyWithinRange(): void
    {
        ...
        $className = '\MyClass';
        $stubMethod = $this->makeMethod('go', parameters: [$this->makeParam('x'), $this->makeParam('y', sinceVersion: '7.0', removedVersion: '7.2')]);
        foreach (['7.0', '7.1', '7.2'] as $version) {
            $expected = $version === '7.2' ? 1 : 2;
            $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('go', parameters: array_fill(0, $expected, $this->makeParam('_')))]);
    ...
    public function testPlaceholderAndVariadicWithSameNameCountAsOne(): void
    {
        ...
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('process', parameters: [$this->makeParam('x'), $this->makeParam('vals')])]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('process', parameters: [
            $this->makeParam('x'),
            $this->makeParam('vals', removedVersion: '7.5'),
            // placeholder: excluded from 7.5+, available in 7.4
            $this->makeParam('vals'),
        ])]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    public function testVariadicAloneCountsNormallyWhenPlaceholderExcluded(): void
    {
        ...
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('process', parameters: [
            $this->makeParam('x'),
            $this->makeParam('vals', removedVersion: '7.5'),
            // excluded from 7.5+ (including PHP 8.0)
            $this->makeParam('vals'),
        ])]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    public function testMethodInheritedFromParentIsChecked(): void
    {
        ...
        $parentStub->setMethods([$this->makeMethod('doWork', parameters: [$this->makeParam('a')])]);
        // wrong count
    ...
    public function testChildMethodOverridesParentForParameterCountCheck(): void
    {
        ...
        $parentStub->setMethods([$this->makeMethod('doWork', parameters: [$this->makeParam('a')])]);
        // wrong in parent
        $childStub = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('doWork', parameters: [$this->makeParam('a'), $this->makeParam('b')])]);
        $childStub->setParentClass($parentStub);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$childStub]);
    ...
    public function testClassLevelKnownProblemSkipsAllMethods(): void
    {
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::CLASS_TYPE, entityId: $className, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::PARAMETERS_COUNT], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Class-level skip')]);
        KnownProblemsRegistry::reset();
    ...
    public function testMethodLevelKnownProblemSkipsSpecificMismatch(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('doWork', parameters: [$this->makeParam('a'), $this->makeParam('b')]), $this->makeMethod('other', parameters: [$this->makeParam('x')])]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [
            $this->makeMethod('doWork', parameters: [$this->makeParam('a')]),
            // mismatch — known problem
            $this->makeMethod('other', parameters: [$this->makeParam('x')]),
        ]);
        $knownProblemsProvider = $this->createStub(\Masjid_App\Dependencies\StubTests\Framework\Validator\KnownProblems\KnownProblemsProvider::class);
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::METHOD, entityId: $mismatchedId, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::PARAMETERS_COUNT], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Method-level skip')]);
        KnownProblemsRegistry::reset();
        $registry = KnownProblemsRegistry::getInstance($knownProblemsProvider);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    {
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('doWork', parameters: [$this->makeParam('a'), $this->makeParam('b')]), $this->makeMethod('other', parameters: [$this->makeParam('x'), $this->makeParam('y')])]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [
            $this->makeMethod('doWork', parameters: [$this->makeParam('a')]),
            // mismatch — known problem
            $this->makeMethod('other', parameters: [$this->makeParam('x')]),
        ...
        $knownProblemsProvider = $this->createStub(\Masjid_App\Dependencies\StubTests\Framework\Validator\KnownProblems\KnownProblemsProvider::class);
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::METHOD, entityId: $className . '::doWork', type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::PARAMETERS_COUNT], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Only doWork is known')]);
        KnownProblemsRegistry::reset();
        $registry = KnownProblemsRegistry::getInstance($knownProblemsProvider);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
