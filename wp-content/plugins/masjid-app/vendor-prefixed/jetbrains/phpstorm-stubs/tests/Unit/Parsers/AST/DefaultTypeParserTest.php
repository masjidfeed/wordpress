...
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Stubs\Types\ParsedType;
...
class TestClass {
    ...
    public function testParseAllThreeSourcesSimultaneously()
    {
        ...
        self::assertEquals('', $property->getType()->toString());
        // No signature in this example (NoType)
...
function fixture_resolvable($n) {}';
    ...
    public function testParseHandlesNullValuesGracefully()
    {
        ...
        self::assertInstanceOf(\Masjid_App\Dependencies\StubTests\Framework\Model\Types\NoType::class, $result->typeFromSignature);
