...
class InterfaceMethodsParametersCountCheckTest extends CheckTestCase
{
    ...
    public function testMatchingParameterCountIsSuccess(): void
    {
        ...
        $reflIface = $this->makeInterface($interfaceId, [$this->makeMethod('offsetGet', parameters: [$this->makeParam('offset')])]);
        $stubIface = $this->makeInterface($interfaceId, [$this->makeMethod('offsetGet', parameters: [$this->makeParam('offset')])]);
        $provider = $this->createMockReflectionProviderWithInterfaces([$reflIface]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getInterfaces')->willReturn([$stubIface]);
        $result = (new ClassMethodsParametersCountCheck(reflectionProvider: $provider, entityTypeConfig: EntityTypeConfig::forInterface()))->run($stubs, $interfaceId, '8.0');
    ...
    public function testMismatchedParameterCountIsFailure(): void
    {
        ...
        $reflIface = $this->makeInterface($interfaceId, [$this->makeMethod('offsetGet', parameters: [$this->makeParam('offset')])]);
        $stubIface = $this->makeInterface($interfaceId, [$this->makeMethod('offsetGet', parameters: [])]);
        $provider = $this->createMockReflectionProviderWithInterfaces([$reflIface]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getInterfaces')->willReturn([$stubIface]);
        $result = (new ClassMethodsParametersCountCheck(reflectionProvider: $provider, entityTypeConfig: EntityTypeConfig::forInterface()))->run($stubs, $interfaceId, '8.0');
    ...
    public function testParameterRemovedBeforeVersionIsExcluded(): void
    {
        ...
        $reflIface = $this->makeInterface($interfaceId, [$this->makeMethod('doSomething', parameters: [$this->makeParam('current')])]);
        $stubIface = $this->makeInterface($interfaceId, [$this->makeMethod('doSomething', parameters: [$this->makeParam('current'), $this->makeParam('legacy', removedVersion: '7.4')])]);
        $provider = $this->createMockReflectionProviderWithInterfaces([$reflIface]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getInterfaces')->willReturn([$stubIface]);
        $result = (new ClassMethodsParametersCountCheck(reflectionProvider: $provider, entityTypeConfig: EntityTypeConfig::forInterface()))->run($stubs, $interfaceId, '8.0');
    ...
    public function testMethodParameterCountFromParentInterfaceIsCounted(): void
    {
        ...
        $reflIface = $this->makeInterface($childId, [$this->makeMethod('offsetGet', parameters: [$this->makeParam('offset')])]);
        $parentStub = $this->makeInterface('\ParentInterface', [$this->makeMethod('offsetGet', parameters: [$this->makeParam('offset')])]);
    ...
    public function testInterfaceLevelKnownProblemSkipsAllMethods(): void
    {
        ...
        $reflIface = $this->makeInterface($interfaceId, [$this->makeMethod('method', parameters: [$this->makeParam('a'), $this->makeParam('b')])]);
        $stubIface = $this->makeInterface($interfaceId, [$this->makeMethod('method', parameters: [])]);
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::INTERFACE_TYPE, entityId: $interfaceId, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::PARAMETERS_COUNT], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Interface-level skip')]);
        KnownProblemsRegistry::reset();
