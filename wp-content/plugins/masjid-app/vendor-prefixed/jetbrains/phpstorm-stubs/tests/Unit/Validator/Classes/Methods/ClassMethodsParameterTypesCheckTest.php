...
class ClassMethodsParameterTypesCheckTest extends CheckTestCase
{
    ...
    {
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('doWork')]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('doWork')]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = (new ClassMethodsParameterTypesCheck($provider))->run($stubs, $className, '8.0');
    ...
    public function testMatchingTypesSucceed(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('compute', $reflParams)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('compute', $stubParams)]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = (new ClassMethodsParameterTypesCheck($provider))->run($stubs, $className, '8.0');
    ...
    public function testTypeMismatchIsFailure(): void
    {
        ...
        $stubParams = [$this->makeParam('x', $this->createType('int'))];
        // wrong type
    ...
    public function testMultipleMismatchesReportedTogether(): void
    {
        ...
        $reflParams = [$this->makeParam('a', $this->createType('string')), $this->makeParam('b', $this->createType('int'))];
        $stubParams = [
            $this->makeParam('a', $this->createType('int')),
            // wrong
            $this->makeParam('b', $this->createType('bool')),
        ];
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('compute', $reflParams)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('compute', $stubParams)]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
    ...
    public function testReflectionHasNoTypeButStubHasTypeIsSuccess(): void
    {
        ...
        // no type
        $stubParams = [$this->makeParam('x', $this->createType('string'))];
        // typed
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('doIt', $reflParams)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('doIt', $stubParams)]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
    ...
    public function testUnionTypeOrderIsIgnored(): void
    {
        ...
        $stubParams = [$this->makeParam('x', $this->createUnionType('int', 'string'))];
        // different order
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('doIt', $reflParams)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('doIt', $stubParams)]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
    ...
    public function testParamMissingFromStubMethodIsNotReportedAsTypeMismatch(): void
    {
        ...
        $className = '\MyClass';
        $reflParams = [$this->makeParam('a', $this->createType('string')), $this->makeParam('b', $this->createType('int'))];
        $stubParams = [$this->makeParam('a', $this->createType('string'))];
        // 'b' absent
    ...
    public function testMethodMissingFromStubsIsSkipped(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('onlyInRefl', $reflParams)]);
        $stubClass = $this->createMockClassWithProperties($className);
        // no methods
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    public function testVersionExcludedStubParamIsIgnored(): void
    {
        ...
        $className = '\MyClass';
        $reflParams = [$this->makeParam('a', $this->createType('string')), $this->makeParam('b', $this->createType('int'))];
        $stubParams = [$this->makeParam('a', $this->createType('string')), $this->makeParam('b', $this->createType('bool'), sinceVersion: '8.1')];
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('doWork', $reflParams)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('doWork', $stubParams)]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    public function testVersionRemovedStubParamIsIgnored(): void
    {
        $className = '\MyClass';
        $reflParams = [$this->makeParam('a', $this->createType('string')), $this->makeParam('b', $this->createType('int'))];
        $stubParams = [$this->makeParam('a', $this->createType('string')), $this->makeParam('b', $this->createType('int'), removedVersion: '7.4')];
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('doWork', $reflParams)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('doWork', $stubParams)]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    public function testLanguageLevelTypeAwareResolvesForVersion(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('exec', $reflParams)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('exec', $stubParams)]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = (new ClassMethodsParameterTypesCheck($provider))->run($stubs, $className, '8.0');
    ...
    public function testLanguageLevelTypeAwareBeforeVersionHasNoType(): void
    {
        ...
        $reflParams = [$this->makeParam('handle')];
        // no type in reflection for PHP 7.4
    ...
    public function testSameNamedVariadicParamDeduplicationSucceeds(): void
    {
        ...
        $stubParams = [$this->makeParam('values', $this->createType('int'), removedVersion: '7.4'), $this->makeParam('values', $this->createType('string'), variadic: \true)];
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('collect', $reflParams)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('collect', $stubParams)]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testTypeMismatchInheritedFromParentIsChecked(): void
    {
        ...
        $reflParams = [$this->makeParam('x', $this->createType('string'))];
        $stubParams = [$this->makeParam('x', $this->createType('int'))];
        // wrong type in parent stub
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->createMockMethod('inherited', $reflParams)]);
    ...
    public function testClassLevelKnownProblemSkipsAllMethods(): void
    {
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::CLASS_TYPE, entityId: $className, type: ProblemType::OVERLOADED_SIGNATURE, affectedChecks: [CheckType::PARAMETER_TYPES], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Class-level param types skip')]);
        KnownProblemsRegistry::reset();
    ...
    public function testMethodLevelKnownProblemSkipsSpecificMismatch(): void
    {
        ...
        $knownProblemsProvider = $this->createStub(\Masjid_App\Dependencies\StubTests\Framework\Validator\KnownProblems\KnownProblemsProvider::class);
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::METHOD, entityId: $mismatchedId, type: ProblemType::OVERLOADED_SIGNATURE, affectedChecks: [CheckType::PARAMETER_TYPES], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Method-level param types skip')]);
        KnownProblemsRegistry::reset();
        $registry = KnownProblemsRegistry::getInstance($knownProblemsProvider);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
