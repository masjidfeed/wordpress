...
class StubPropertyParserTest extends BaseTestCase
{
    ...
    {
        $properties = $this->getPropertiesFromClass('complete_property.txt');
        $staticReadonlyProperty = $properties[3];
    ...
    {
        return ['untyped without initializer has implicit null default' => ['untypedNoDefault', \true], 'untyped with initializer' => ['untypedWithDefault', \true], 'typed without initializer is uninitialized' => ['typedNoDefault', \false], 'typed with initializer' => ['typedWithDefault', \true], 'nullable typed without initializer is uninitialized' => ['nullableNoDefault', \false], 'static untyped without initializer' => ['staticUntypedNoDefault', \true], 'static typed without initializer' => ['staticTypedNoDefault', \false], 'explicit null initializer' => ['explicitNullDefault', \true]];
    }
    ...
    {
        return ['int literal' => ['untypedWithDefault', 5], 'typed int literal' => ['typedWithDefault', 7], 'empty string' => ['emptyStringDefault', ''], 'explicit null' => ['explicitNullDefault', null], 'boolean false' => ['falseDefault', \false], 'named constant is resolved' => ['constantDefault', \PHP_INT_MAX], 'untyped uninitialized yields implicit null' => ['untypedNoDefault', null]];
    }
