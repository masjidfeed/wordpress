...
class FunctionExistsCheckTest extends CheckTestCase
{
    ...
    public function testFunctionExistsAmongMultipleFunctions(): void
    {
        ...
        $mockFunctions = [$this->createMockFunction('array_map'), $this->createMockFunction('array_filter'), $this->createMockFunction('array_reduce')];
        $stubsManager = $this->createMockStorageManager();
    ...
    public function testFunctionFoundByGetIdMethod(): void
    {
        ...
        $mockFunction = $this->createStub(\Masjid_App\Dependencies\StubTests\Framework\Model\PHPFunction::class);
    ...
    public function testKnownProblemSkipsFunctionExistenceCheck(): void
    {
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::FUNCTION, entityId: $functionName, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::ENTITY_EXISTS], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Function is provided at C level without a stub')]);
        KnownProblemsRegistry::reset();
