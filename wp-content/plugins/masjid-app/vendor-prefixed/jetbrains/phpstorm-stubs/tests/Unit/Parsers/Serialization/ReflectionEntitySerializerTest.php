...
namespace Masjid_App\Dependencies\StubTests\Unit\Parsers\Serialization;

use Masjid_App\Dependencies\StubTests\Framework\Model\Access\AccessModifier;
use Masjid_App\Dependencies\StubTests\Framework\Serialization\Reflection\ReflectionEntitySerializer;
...
use Masjid_App\Dependencies\StubTests\Framework\Model\PHPMethod;
use Masjid_App\Dependencies\StubTests\Framework\Model\PHPParameter;
...
class ReflectionEntitySerializerTest extends TestCase
{
    ...
    public function testSerializeSimpleClass(): void
    {
        ...
        $class->setNamespace('Masjid_App\Dependencies\Test\Namespace');
        $class->setId('Masjid_App\Dependencies\Test\Namespace\TestClass');
        $class->setIsFinal(\true);
        ...
        self::assertEquals('Masjid_App\Dependencies\Test\Namespace', $result['namespace']);
        self::assertEquals('Masjid_App\Dependencies\Test\Namespace\TestClass', $result['id']);
    ...
    public function testSerializeFunction(): void
    {
        ...
        $function->setNamespace('Masjid_App\Dependencies\Test\Namespace');
        $function->setId('Masjid_App\Dependencies\Test\Namespace\testFunction');
        $function->setDeprecated(\false);
        $function->setHasTentativeReturnType(\true);
        ...
        self::assertEquals('Masjid_App\Dependencies\Test\Namespace', $result['namespace']);
        self::assertEquals('Masjid_App\Dependencies\Test\Namespace\testFunction', $result['id']);
    ...
    public function testSerializeInterface(): void
    {
        ...
        $interface->setNamespace('Masjid_App\Dependencies\Test\Namespace');
        $interface->setId('Masjid_App\Dependencies\Test\Namespace\TestInterface');
        $method = new PHPMethod();
        ...
        self::assertEquals('Masjid_App\Dependencies\Test\Namespace', $result['namespace']);
        self::assertEquals('Masjid_App\Dependencies\Test\Namespace\TestInterface', $result['id']);
        self::assertCount(1, $result['methods']);
        self::assertCount(1, $result['constants']);
    ...
    public function testSerializeInterfaceWithParentInterfaces(): void
    {
        ...
        $interface->setNamespace('Masjid_App\Dependencies\MongoDB\BSON');
        $interface->setId('Masjid_App\Dependencies\MongoDB\BSON\Persistable');
        foreach (['Masjid_App\Dependencies\MongoDB\BSON\Serializable', 'Masjid_App\Dependencies\MongoDB\BSON\Unserializable'] as $parentName) {
        ...
        $result = $this->serializer->serialize($interface);
        self::assertSame(['Masjid_App\Dependencies\MongoDB\BSON\Serializable', 'Masjid_App\Dependencies\MongoDB\BSON\Unserializable'], $result['parentInterfaces'], 'Parents must be persisted as fully qualified ids, not bare names');
        $restored = $this->serializer->deserialize($result);
        self::assertSame(['Masjid_App\Dependencies\MongoDB\BSON\Serializable', 'Masjid_App\Dependencies\MongoDB\BSON\Unserializable'], array_map(fn(PHPInterface $parent) => $parent->getId(), $restored->getParentInterfaces()));
        self::assertSame(['Masjid_App\Dependencies\MongoDB\BSON\Serializable', 'Masjid_App\Dependencies\MongoDB\BSON\Unserializable'], array_map(fn(PHPInterface $parent) => $parent->getName(), $restored->getParentInterfaces()), 'The name must round-trip as ReflectionImplementedInterfaceParser writes it: FQN, no leading slash');
    }
    ...
    public function testSerializeEnum(): void
    {
        ...
        $enum->setNamespace('Masjid_App\Dependencies\Test\Namespace');
        $enum->setId('Masjid_App\Dependencies\Test\Namespace\TestEnum');
        $enum->setIsFinal(\true);
    ...
    {
        $restored = $this->serializer->deserialize(['_type' => 'PHPEnum', 'name' => 'Legacy', 'id' => '\Legacy', 'namespace' => '\\']);
    ...
    public function testSerializeConstant(): void
    {
        ...
        $constant->setName('TEST_CONSTANT');
        $constant->setNamespace('Masjid_App\Dependencies\Test\Namespace');
        $constant->setId('Masjid_App\Dependencies\Test\Namespace\TEST_CONSTANT');
    ...
    {
        $data = ['_type' => 'PHPClass', 'name' => 'TestClass', 'namespace' => 'Masjid_App\Dependencies\Test\Namespace', 'id' => 'Masjid_App\Dependencies\Test\Namespace\TestClass', 'isFinal' => \true, 'isReadonly' => \false, 'sourcePath' => '/path/to/file.php', 'duplicates' => [], 'methods' => [], 'properties' => [], 'constants' => []];
        ...
        self::assertEquals('Masjid_App\Dependencies\Test\Namespace', $result->getNamespace());
        self::assertEquals('Masjid_App\Dependencies\Test\Namespace\TestClass', $result->getId());
        self::assertTrue($result->isFinal());
        self::assertFalse($result->isReadonly());
    }
    public function testDeserializeClassWithMethod(): void
    {
        $data = ['_type' => 'PHPClass', 'name' => 'TestClass', 'id' => 'TestClass', 'methods' => [[
            'name' => 'testMethod',
            'isStatic' => \true,
            'isFinal' => \false,
            'isAbstract' => \false,
            ...
            'parameters' => [],
            'returnType' => null,
            // null instead of string to avoid type conversion issues
    ...
    {
        $data = ['_type' => 'PHPClass', 'name' => 'TestClass', 'id' => 'TestClass', 'methods' => [['name' => 'testMethod', 'isStatic' => \false, 'isFinal' => \false, 'isAbstract' => \false, 'isDeprecated' => \false, 'accessModifier' => 'public', 'parameters' => [['name' => 'param1', 'position' => 0, 'isOptional' => \true, 'isVariadic' => \false, 'isPassedByReference' => \false, 'hasDefaultValue' => \true, 'defaultValue' => 'test']], 'returnType' => null, 'hasTentativeReturnType' => \false]], 'properties' => [], 'constants' => []];
        $result = $this->serializer->deserialize($data);
        self::assertCount(1, $result->getMethods());
    ...
    {
        $data = ['_type' => 'PHPClass', 'name' => 'TestClass', 'id' => 'TestClass', 'methods' => [], 'properties' => [['name' => 'testProperty', 'isStatic' => \true, 'isReadonly' => \false, 'accessModifier' => 'private', 'type' => null]], 'constants' => []];
        $result = $this->serializer->deserialize($data);
    ...
    public function testDeserializeFunction(): void
    {
        $data = [
            '_type' => 'PHPFunction',
            'name' => 'testFunction',
            'namespace' => 'Masjid_App\Dependencies\Test\Namespace',
            'id' => 'Masjid_App\Dependencies\Test\Namespace\testFunction',
            'isDeprecated' => \true,
            'returnType' => null,
            // null to avoid type conversion issues
    ...
    {
        $data = ['_type' => 'PHPInterface', 'name' => 'TestInterface', 'namespace' => 'Masjid_App\Dependencies\Test\Namespace', 'id' => 'Masjid_App\Dependencies\Test\Namespace\TestInterface', 'sourcePath' => '/path/to/file.php', 'duplicates' => [], 'methods' => [], 'constants' => []];
        $result = $this->serializer->deserialize($data);
    ...
    {
        $data = ['_type' => 'PHPEnum', 'name' => 'TestEnum', 'namespace' => 'Masjid_App\Dependencies\Test\Namespace', 'id' => 'Masjid_App\Dependencies\Test\Namespace\TestEnum', 'isFinal' => \true, 'isReadonly' => \false, 'sourcePath' => '/path/to/file.php', 'duplicates' => [], 'methods' => []];
        $result = $this->serializer->deserialize($data);
    ...
    {
        $data = ['_type' => 'PHPConstant', 'name' => 'TEST_CONSTANT', 'namespace' => 'Masjid_App\Dependencies\Test\Namespace', 'id' => 'Masjid_App\Dependencies\Test\Namespace\TEST_CONSTANT', 'value' => 'test_value', 'sourcePath' => '/path/to/file.php', 'duplicates' => []];
        $result = $this->serializer->deserialize($data);
    ...
    public function testRoundTripSerializationClass(): void
    {
        ...
        $class->setId('Masjid_App\Dependencies\Test\RoundTripClass');
        $class->setIsFinal(\true);
        $class->setIsReadonly(\false);
        $method = new PHPMethod();
        $method->setName('testMethod');
    ...
    public function testRoundTripSerializationFunction(): void
    {
        ...
        $function->setId('Masjid_App\Dependencies\Test\roundTripFunction');
        $function->setDeprecated(\false);
        $function->setHasTentativeReturnType(\true);
