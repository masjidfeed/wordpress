...
final class PhpVersionManifestTest extends TestCase
{
    public function testItRecordsTheFetchedPatchOnTheFirstRun(): void
    {
        ...
        self::assertFalse(PhpVersionManifest::isRegression(null, '8.4.23'), 'A baseline run has nothing to regress against');
    }
    ...
    public function testItKeepsTheRecordedPatchWhenTheFetchedOneIsOlder(): void
    {
        ...
        self::assertTrue(PhpVersionManifest::isRegression('8.4.23', '8.4.22'), 'An older fetch must be reported as a regression, not as "up to date"');
    }
    public function testItIsAStableNoOpWhenNothingChanged(): void
    {
        ...
        self::assertFalse(PhpVersionManifest::isRegression('8.4.23', '8.4.23'), 'An unchanged patch is up to date, not a regression');
    }
    /**
