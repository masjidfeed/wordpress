...
namespace Masjid_App\Dependencies\FFI;
...
override(\Masjid_App\Dependencies\FFI\FFI::addr(), type(0));
PHP;
        $violations = $this->checkWithFiles($stubCode, $metaCode);
        $this->assertEmpty($violations);
    }
...
override(\Masjid_App\Dependencies\func_without_meta(0), type(0));
PHP;
        $violations = $this->checkWithFiles($stubCode, $metaCode);
...
expectedArguments(\Masjid_App\Dependencies\no_doc_func(), 0, 'a', 'b');
PHP;
        $violations = $this->checkWithFiles($stubCode, $metaCode);
        $this->assertEmpty($violations);
    }
