...
use Masjid_App\Dependencies\StubTests\Framework\Serialization\Stubs\StubsEntitySerializer;
...
class StubsEntitySerializerTest extends TestCase
{
    ...
    {
        return ['INF' => [\INF, '[float:INF]'], '-INF' => [-\INF, '[float:-INF]'], 'NAN' => [\NAN, '[float:NAN]']];
    }
    ...
    {
        $data = ['_type' => 'PHPClass', 'name' => 'TestClass', 'namespace' => 'Masjid_App\Dependencies\Test\Namespace', 'id' => 'Masjid_App\Dependencies\Test\Namespace\TestClass', 'isFinal' => \true, 'isReadonly' => \false, 'sourcePath' => '/path/to/file.php', 'duplicates' => [], 'phpDoc' => '/** @deprecated */', 'sinceVersion' => '8.0', 'removedVersion' => null, 'methods' => [], 'properties' => [], 'constants' => []];
    ...
    {
        $data = ['_type' => 'PHPClass', 'name' => 'TestClass', 'id' => 'TestClass', 'methods' => [['name' => 'testMethod', 'isStatic' => \false, 'isFinal' => \false, 'isAbstract' => \false, 'isDeprecated' => \true, 'accessModifier' => 'public', 'parameters' => [], 'returnType' => 'string', 'hasTentativeReturnType' => \false, 'phpDoc' => '/** @return string */', 'sinceVersion' => '7.4', 'removedVersion' => null, 'returnTypeFromPhpDoc' => 'string|false', 'languageLevelTypes' => ['8.0' => 'string'], 'defaultType' => 'string']], 'properties' => [], 'constants' => []];
        $result = $this->serializer->deserialize($data);
        self::assertInstanceOf(PHPClass::class, $result);
    ...
    {
        $data = ['_type' => 'PHPClass', 'name' => 'TestClass', 'id' => 'TestClass', 'methods' => [], 'properties' => [['name' => 'testProperty', 'isStatic' => \false, 'isReadonly' => \true, 'accessModifier' => 'protected', 'type' => 'int', 'phpDoc' => '/** @var int */', 'sinceVersion' => '8.1', 'removedVersion' => null, 'typeFromPhpDoc' => 'int|null', 'languageLevelTypes' => ['8.1' => 'int'], 'defaultType' => 'int']], 'constants' => []];
        $result = $this->serializer->deserialize($data);
    ...
    {
        $data = ['_type' => 'PHPFunction', 'name' => 'testFunction', 'namespace' => 'Masjid_App\Dependencies\Test\Namespace', 'id' => 'Masjid_App\Dependencies\Test\Namespace\testFunction', 'isDeprecated' => \false, 'returnType' => 'bool', 'sourcePath' => '/path/to/file.php', 'duplicates' => [], 'hasTentativeReturnType' => \false, 'parameters' => [], 'phpDoc' => '/** @return bool */', 'sinceVersion' => '7.0', 'removedVersion' => null, 'returnTypeFromPhpDoc' => 'bool', 'languageLevelTypes' => ['8.0' => 'bool'], 'defaultType' => 'bool'];
        $result = $this->serializer->deserialize($data);
    ...
    {
        $data = ['_type' => 'PHPConstant', 'name' => 'TEST_CONSTANT', 'namespace' => 'Masjid_App\Dependencies\Test\Namespace', 'id' => 'Masjid_App\Dependencies\Test\Namespace\TEST_CONSTANT', 'value' => 42, 'sourcePath' => '/path/to/file.php', 'duplicates' => [], 'phpDoc' => '/** @var int */', 'sinceVersion' => '7.0', 'removedVersion' => '8.0'];
        $result = $this->serializer->deserialize($data);
    ...
    {
        $interface = $this->interfaceWithParent('Masjid_App\Dependencies\MongoDB\BSON\Persistable', 'Serializable', 'Masjid_App\Dependencies\MongoDB\BSON\Serializable');
        $result = $this->serializer->serialize($interface);
        self::assertSame(['Masjid_App\Dependencies\MongoDB\BSON\Serializable'], $result['parentInterfaces']);
    }
    public function testParentInterfaceIdSurvivesARoundtrip(): void
    {
        ...
        self::assertSame('Masjid_App\Dependencies\MongoDB\BSON\Serializable', $parent->getId(), 'The qualified id must survive.');
    ...
    {
        $restored = $this->serializer->deserialize(['_type' => 'PHPFunction', 'name' => 'legacyFunction', 'id' => '\legacyFunction', 'isDeprecated' => \true]);
        self::assertTrue($restored->isDeprecated());
