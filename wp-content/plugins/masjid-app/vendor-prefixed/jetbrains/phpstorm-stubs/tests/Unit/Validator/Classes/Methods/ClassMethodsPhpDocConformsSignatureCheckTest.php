...
class ClassMethodsPhpDocConformsSignatureCheckTest extends CheckTestCase
{
    ...
    {
        $className = '\MyClass';
        $method = $this->makeMethodWithPhpDoc('getCount', 'int', 'string');
        // mismatch
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    {
        $className = '\MyClass';
        $method = $this->makeMethodWithPhpDoc('getCount', 'int', null);
        // no PhpDoc
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    {
        $className = '\MyClass';
        $property = $this->makePropertyWithPhpDoc('name', 'int', 'string');
        // mismatch
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], [$property]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, '8.0');
        $this->assertTrue($result->hasFailures());
    ...
    {
        $className = '\MyClass';
        $property = $this->makePropertyWithPhpDoc('name', 'string', null);
        // no PhpDoc
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], [$property]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testClassLevelKnownProblemSkips(): void
    {
        ...
        $method = $this->makeMethodWithPhpDoc('doWork', 'string', 'int');
        // mismatch
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
     ...
     */
    private function makeMethodWithPhpDoc(string $name, ?string $sigReturnType, ?string $docReturnType, array $params = []): PHPMethod
    {
     ...
     */
    private function makePropertyWithPhpDoc(string $name, ?string $sigType, ?string $docType): PHPProperty
    {
