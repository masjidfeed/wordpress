...
namespace Masjid_App\Dependencies\StubTests\Unit\Validator\Interfaces;
...
class InterfaceMethodsExistCheckTest extends CheckTestCase
{
    ...
    public function testAllReflectionMethodsPresentInStubs(): void
    {
        ...
        $reflIface = $this->makeInterface($interfaceId, [$this->makeMethod('current'), $this->makeMethod('key'), $this->makeMethod('next'), $this->makeMethod('rewind'), $this->makeMethod('valid')]);
        $stubIface = $this->makeInterface($interfaceId, [$this->makeMethod('current'), $this->makeMethod('key'), $this->makeMethod('next'), $this->makeMethod('rewind'), $this->makeMethod('valid')]);
        $provider = $this->createMockReflectionProviderWithInterfaces([$reflIface]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getInterfaces')->willReturn([$stubIface]);
        $result = (new ClassMethodsExistCheck(reflectionProvider: $provider, entityTypeConfig: EntityTypeConfig::forInterface()))->run($stubs, $interfaceId, '8.0');
    ...
    {
        $interfaceId = '\Iterator';
        $reflIface = $this->makeInterface($interfaceId, [$this->makeMethod('current'), $this->makeMethod('next')]);
        $stubIface = $this->makeInterface($interfaceId, [$this->makeMethod('current')]);
        $provider = $this->createMockReflectionProviderWithInterfaces([$reflIface]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getInterfaces')->willReturn([$stubIface]);
        $result = (new ClassMethodsExistCheck(reflectionProvider: $provider, entityTypeConfig: EntityTypeConfig::forInterface()))->run($stubs, $interfaceId, '8.0');
    ...
    public function testMethodInheritedFromParentInterfaceIsCounted(): void
    {
        ...
        $reflIface = $this->makeInterface($outerIteratorId, [$this->makeMethod('current'), $this->makeMethod('getInnerIterator')]);
    ...
    public function testMethodNotYetAvailableIsExcludedFromStubs(): void
    {
        ...
        $stubIface = $this->makeInterface($interfaceId, [$this->makeMethod('oldMethod'), $this->makeMethod('newMethod', sinceVersion: '8.1')]);
        $provider = $this->createMockReflectionProviderWithInterfaces([$reflIface]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getInterfaces')->willReturn([$stubIface]);
        $result = (new ClassMethodsExistCheck(reflectionProvider: $provider, entityTypeConfig: EntityTypeConfig::forInterface()))->run($stubs, $interfaceId, '8.0');
    ...
    public function testRemovedMethodIsExcludedFromStubs(): void
    {
        ...
        $stubIface = $this->makeInterface($interfaceId, [$this->makeMethod('currentMethod'), $this->makeMethod('legacyMethod', removedVersion: '7.4')]);
        $provider = $this->createMockReflectionProviderWithInterfaces([$reflIface]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getInterfaces')->willReturn([$stubIface]);
        $result = (new ClassMethodsExistCheck(reflectionProvider: $provider, entityTypeConfig: EntityTypeConfig::forInterface()))->run($stubs, $interfaceId, '8.0');
    ...
    {
        $interfaceId = '\IfaceA';
        $reflIface = $this->makeInterface($interfaceId, [$this->makeMethod('methodA'), $this->makeMethod('methodB')]);
    ...
    public function testInterfaceLevelKnownProblemSkipsAllMethodChecks(): void
    {
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::INTERFACE_TYPE, entityId: $interfaceId, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::CLASS_METHODS_EXIST], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Interface-level skip reason')]);
        KnownProblemsRegistry::reset();
    ...
    public function testMethodLevelKnownProblemSkipsSpecificMethod(): void
    {
        ...
        $reflIface = $this->makeInterface($interfaceId, [$this->makeMethod('presentMethod'), $this->makeMethod('missingMethod')]);
        $stubIface = $this->makeInterface($interfaceId, [$this->makeMethod('presentMethod')]);
        $knownProblemsProvider = $this->createStub(\Masjid_App\Dependencies\StubTests\Framework\Validator\KnownProblems\KnownProblemsProvider::class);
    ...
    {
        $interfaceId = '\Iterator';
        $reflIface = $this->makeInterface($interfaceId, [$this->makeMethod('valid'), $this->makeMethod('current'), $this->makeMethod('next')]);
        $stubIface = $this->makeInterface($interfaceId);
        // no methods
        $provider = $this->createMockReflectionProviderWithInterfaces([$reflIface]);
        $stubs = $this->createMockStorageManager();
