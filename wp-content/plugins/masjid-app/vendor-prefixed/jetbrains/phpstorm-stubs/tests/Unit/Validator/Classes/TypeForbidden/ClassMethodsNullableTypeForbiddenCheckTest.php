...
class ClassMethodsNullableTypeForbiddenCheckTest extends CheckTestCase
{
    ...
    public function testNullableReturnTypeViaSignatureIsFailureAlsoForPhp56(): void
    {
        ...
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('get', $this->createNullableType('int'))]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testNullableReturnTypeViaLLADefaultSucceeds(): void
    {
        ...
        // no version-specific entries
        $method->initStubsMetadata()->setDefaultType('?string');
        // LLA attribute default — IDE metadata only
    ...
    public function testPrivateMethodWithNullableTypeIsNotFlagged(): void
    {
        ...
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('privateGet', $this->createNullableType('string'), access: 'private')]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_0->value);
    ...
    public function testProtectedMethodWithNullableTypeIsFlagged(): void
    {
        ...
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('protectedGet', $this->createNullableType('string'), access: 'protected')]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_0->value);
    ...
    public function testFinalMethodWithNullableTypeIsNotFlagged(): void
    {
        ...
        $className = '\MyClass';
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('finalGet', $this->createNullableType('string'), isFinal: \true)]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_0->value);
    ...
    public function testMethodWithTentativeReturnTypeIsNotFlagged(): void
    {
        ...
        $className = '\MyClass';
        $method = $this->makeMethod('tentativeGet', $this->createNullableType('string'), isTentative: \true);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = $this->check->run($stubs, $className, PhpVersions::PHP_7_0->value);
    ...
    public function testKnownProblemAtClassLevelSkipsAllMethods(): void
    {
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::CLASS_TYPE, entityId: $className, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::NULLABLE_TYPE_FORBIDDEN], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Test class skip')]);
        KnownProblemsRegistry::reset();
    ...
    public function testMethodWithNullableReturnAndNullableParamReportsBoth(): void
    {
        ...
        $method = $this->makeMethod(
            'doSomething',
            $this->createNullableType('string'),
            // nullable return
            parameters: [$this->makeParam('val', $this->createNullableType('int'))]
        );
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$method]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testKnownProblemAtMethodLevelSkipsSpecificMethod(): void
    {
        ...
        $knownProblemsProvider = $this->createStub(\Masjid_App\Dependencies\StubTests\Framework\Validator\KnownProblems\KnownProblemsProvider::class);
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::METHOD, entityId: $methodEntityId, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::NULLABLE_TYPE_FORBIDDEN], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Test method skip')]);
        KnownProblemsRegistry::reset();
        $registry = KnownProblemsRegistry::getInstance($knownProblemsProvider);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getStr', $this->createNullableType('string'))]);
        $stubs = $this->createMockStorageManager();
