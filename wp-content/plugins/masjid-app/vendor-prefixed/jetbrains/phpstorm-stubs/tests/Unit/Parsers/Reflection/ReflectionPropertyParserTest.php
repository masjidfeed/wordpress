...
class ReflectionPropertyParserTest extends TestCase
{
    ...
    {
        $reflectionPropertyMock1 = $this->getMockBuilder(AdaptedReflectionProperty::class)->disableOriginalConstructor()->onlyMethods(['getName', 'isPublic'])->getMock();
        $reflectionPropertyMock2 = $this->getMockBuilder(AdaptedReflectionProperty::class)->disableOriginalConstructor()->onlyMethods(['getName', 'isProtected'])->getMock();
        $reflectionPropertyMock3 = $this->getMockBuilder(AdaptedReflectionProperty::class)->disableOriginalConstructor()->onlyMethods(['getName', 'isPrivate'])->getMock();
        $reflectionPropertyMock1->method('getName')->willReturn('prop1');
        $reflectionPropertyMock1->method('isPublic')->willReturn(\true);
        ...
        $reflectionPropertyMock2->method('isProtected')->willReturn(\true);
        ...
        $reflectionPropertyMock3->method('isPrivate')->willReturn(\true);
    ...
    {
        $reflectionPropertyMock = $this->getMockBuilder(AdaptedReflectionProperty::class)->disableOriginalConstructor()->onlyMethods(['getName', 'hasType'])->getMock();
    ...
    {
        $typeMock = $this->getMockBuilder(AdaptedReflectionType::class)->disableOriginalConstructor()->onlyMethods(['getName', 'allowsNull'])->getMock();
        $typeMock->method('getName')->willReturn('string');
        $typeMock->method('allowsNull')->willReturn(\false);
        $reflectionPropertyMock = $this->getMockBuilder(AdaptedReflectionProperty::class)->disableOriginalConstructor()->onlyMethods(['getName', 'getType'])->getMock();
        $reflectionPropertyMock->method('getName')->willReturn('testProperty');
    ...
    {
        $reflectionPropertyMock = $this->getMockBuilder(AdaptedReflectionProperty::class)->disableOriginalConstructor()->onlyMethods(['getName', 'hasDefaultValue', 'getDefaultValue'])->getMock();
        $reflectionPropertyMock->method('getName')->willReturn('testProperty');
        $reflectionPropertyMock->method('hasDefaultValue')->willReturn(\true);
    ...
    {
        // Mock union type
        $type1Mock = $this->getMockBuilder(AdaptedReflectionType::class)->disableOriginalConstructor()->getMock();
        $type1Mock->method('getName')->willReturn('string');
        $type2Mock = $this->getMockBuilder(AdaptedReflectionType::class)->disableOriginalConstructor()->getMock();
        $type2Mock->method('getName')->willReturn('int');
        $unionTypeMock = $this->getMockBuilder(AdaptedReflectionType::class)->disableOriginalConstructor()->onlyMethods(['isUnionType', 'getTypes'])->getMock();
        $unionTypeMock->method('isUnionType')->willReturn(\true);
    ...
    public function testItParsesIntersectionPropertyType()
    {
        ...
        $intersectionTypeMock = $this->getMockBuilder(AdaptedReflectionType::class)->disableOriginalConstructor()->onlyMethods(['isUnionType', 'isIntersectionType', 'getTypes'])->getMock();
        $intersectionTypeMock->method('isUnionType')->willReturn(\false);
        $intersectionTypeMock->method('isIntersectionType')->willReturn(\true);
        ...
        self::assertInstanceOf(\Masjid_App\Dependencies\StubTests\Framework\Model\Types\IntersectionType::class, $property->getType());
    ...
    public function testItParsesNullableUnionPropertyType()
    {
        ...
        $type2Mock = $this->getMockBuilder(AdaptedReflectionType::class)->disableOriginalConstructor()->getMock();
        $type2Mock->method('getName')->willReturn('int');
        $type3Mock = $this->getMockBuilder(AdaptedReflectionType::class)->disableOriginalConstructor()->getMock();
    ...
    {
        $typeMock = $this->getMockBuilder(AdaptedReflectionType::class)->disableOriginalConstructor()->onlyMethods(['getName', 'allowsNull', 'isUnionType', 'isIntersectionType'])->getMock();
        $typeMock->method('getName')->willReturn('string');
        $typeMock->method('allowsNull')->willReturn(\true);
