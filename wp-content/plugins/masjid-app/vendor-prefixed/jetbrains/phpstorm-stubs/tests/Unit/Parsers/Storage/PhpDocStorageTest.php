...
use Masjid_App\Dependencies\StubTests\Framework\Storage\InMemoryPhpDocRepository;
...
class PhpDocStorageTest extends TestCase
{
    ...
    {
        return ['file-backed' => [static fn(string $path): PhpDocRepository => new PhpDocStorage($path, \false)], 'in-memory' => [static fn(string $path): PhpDocRepository => new InMemoryPhpDocRepository()]];
    }
}
