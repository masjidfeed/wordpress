...
class StubMethodParserTest extends BaseTestCase
{
    ...
    public function testItCanParseDeprecatedFromDocComment()
    {
        ...
        $deprecatedMethod = $methods[0];
        // completeMethod with @deprecated
    ...
    public function testItAssignsParameterPositionsAndByReferenceFlagsOnMethods()
    {
        ...
        self::assertSame(['first' => [0, \false], 'second' => [1, \true], 'third' => [2, \false]], $actual);
    }
