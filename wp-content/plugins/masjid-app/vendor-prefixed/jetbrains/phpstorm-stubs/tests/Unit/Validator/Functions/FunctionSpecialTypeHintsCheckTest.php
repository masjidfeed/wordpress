...
class FunctionSpecialTypeHintsCheckTest extends CheckTestCase
{
    ...
    // ── Helper ───────────────────────────────────────────────────────────────
    private function runCheck(array $functions, string $entityId, string $phpVersion = '8.0'): \Masjid_App\Dependencies\StubTests\Framework\Validator\Contracts\CheckResultSet
    {
