...
class ClassPropertiesExistCheckTest extends CheckTestCase
{
    ...
    {
        $className = '\MyClass';
        $reflectionProperties = [$this->createMockProperty('prop1'), $this->createMockProperty('prop2'), $this->createMockProperty('staticProp')];
        $reflectionClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $reflectionProperties);
        $stubProperties = [$this->makeProperty('prop1'), $this->makeProperty('prop2'), $this->makeProperty('staticProp')];
    ...
    {
        $className = '\MyClass';
        $reflectionProperties = [$this->createMockProperty('existingProp'), $this->createMockProperty('missingProp')];
        $reflectionClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $reflectionProperties);
        $stubProperties = [$this->makeProperty('existingProp')];
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $stubProperties);
        $reflectionProvider = $this->createMockReflectionProvider([], [$reflectionClass]);
        $stubsManager = $this->createMockStorageManager();
        $stubsManager->method('getClasses')->willReturn([$stubClass]);
    ...
    {
        $className = '\MyClass';
        $reflectionProperties = [$this->createMockProperty('oldProp')];
        $reflectionClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $reflectionProperties);
        $stubProperties = [$this->makeProperty('oldProp'), $this->makeProperty('newProp', sinceVersion: '8.1')];
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $stubProperties);
        $reflectionProvider = $this->createMockReflectionProvider([], [$reflectionClass]);
        $stubsManager = $this->createMockStorageManager();
        $stubsManager->method('getClasses')->willReturn([$stubClass]);
    ...
    {
        $className = '\MyClass';
        $reflectionProperties = [$this->createMockProperty('currentProp')];
        $reflectionClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $reflectionProperties);
        $stubProperties = [$this->makeProperty('currentProp'), $this->makeProperty('legacyProp', removedVersion: '7.4')];
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $stubProperties);
        $reflectionProvider = $this->createMockReflectionProvider([], [$reflectionClass]);
        $stubsManager = $this->createMockStorageManager();
        $stubsManager->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testVersionBoundarySinceVersionEqualsPhpVersion(): void
    {
        ...
        $reflectionClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $reflectionProperties);
        $stubProperties = [$this->makeProperty('justAddedProp', sinceVersion: '8.0')];
        // since exactly 8.0
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $stubProperties);
        $reflectionProvider = $this->createMockReflectionProvider([], [$reflectionClass]);
        $stubsManager = $this->createMockStorageManager();
    ...
    public function testVersionBoundaryRemovedVersionEqualsPhpVersion(): void
    {
        ...
        $reflectionClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $reflectionProperties);
        $stubProperties = [$this->makeProperty('lastVersionProp', removedVersion: '7.4')];
        // removed at exactly 7.4
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $stubProperties);
        $reflectionProvider = $this->createMockReflectionProvider([], [$reflectionClass]);
        $stubsManager = $this->createMockStorageManager();
        $stubsManager->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testClassLevelKnownProblemSkipsAllPropertyChecks(): void
    {
        ...
        $reflectionClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $reflectionProperties);
        $stubClass = $this->createMockClassWithProperties($className);
        // no properties, but class-level skip
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::CLASS_TYPE, entityId: $className, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::CLASS_PROPERTIES_EXIST], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Class-level skip reason')]);
        KnownProblemsRegistry::reset();
    ...
    public function testPropertyLevelKnownProblemSkipsSpecificProperty(): void
    {
        ...
        $reflectionProperties = [$this->createMockProperty('presentProp'), $this->createMockProperty('missingProp')];
        $reflectionClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $reflectionProperties);
        $stubProperties = [$this->makeProperty('presentProp')];
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $stubProperties);
        $knownProblemsProvider = $this->createStub(\Masjid_App\Dependencies\StubTests\Framework\Validator\KnownProblems\KnownProblemsProvider::class);
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::PROPERTY, entityId: $missingPropertyId, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::CLASS_PROPERTIES_EXIST], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Property-level skip reason')]);
        KnownProblemsRegistry::reset();
        $registry = KnownProblemsRegistry::getInstance($knownProblemsProvider);
        $reflectionProvider = $this->createMockReflectionProvider([], [$reflectionClass]);
        $stubsManager = $this->createMockStorageManager();
    ...
    {
        $className = '\MyClass';
        $reflectionProperties = [$this->createMockProperty('gammaProp'), $this->createMockProperty('alphaProp'), $this->createMockProperty('betaProp')];
        $reflectionClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $reflectionProperties);
        $stubClass = $this->createMockClassWithProperties($className);
        // no properties
        $reflectionProvider = $this->createMockReflectionProvider([], [$reflectionClass]);
    ...
    public function testPropertyWithNullNameIsSkippedGracefully(): void
    {
        ...
        $reflectionClass = $this->createMockClassWithProperties($className, null, null, null, [], null, [], $reflectionProperties);
        $propertyWithNullName = new PHPProperty();
