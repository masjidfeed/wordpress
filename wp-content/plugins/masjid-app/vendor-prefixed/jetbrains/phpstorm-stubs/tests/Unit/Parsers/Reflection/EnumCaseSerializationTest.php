...
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Reflection\Wrappers\AdaptedEnumCaseReference;
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Reflection\Wrappers\ReflectionValueNormalizer;
use Masjid_App\Dependencies\StubTests\Framework\Serialization\Reflection\ReflectionClassSerializer;
use Masjid_App\Dependencies\StubTests\Unit\Parsers\Reflection\fixtures\BackedEnumFixture;
use Masjid_App\Dependencies\StubTests\Unit\Parsers\Reflection\fixtures\PureEnumFixture;
/**
...
class EnumCaseSerializationTest extends TestCase
{
    ...
    public function testLiveEnumUsesTheFragileSerializationFormat()
    {
        ...
        self::assertStringStartsWith('O:', serialize(new AdaptedEnumCaseReference('Masjid_App\Dependencies\Some\Enum', 'Case')));
    }
    /**
    ...
    {
        self::assertSame('Masjid_App\Dependencies\Io\Poll\Backend', (new AdaptedEnumCaseReference('Masjid_App\Dependencies\Io\Poll\Backend', 'Auto'))->getEnumFqn());
    }
