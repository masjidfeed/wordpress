...
namespace Masjid_App\Dependencies\StubTests\Unit\Parsers\Processors;
...
use Masjid_App\Dependencies\StubTests\Framework\Pipeline\ReflectionDeduplicationProcessor;
...
class EntityProcessingPipelineFactoryTest extends TestCase
{
    ...
    {
        self::assertNotInstanceOf(StubsDeduplicationProcessor::class, EntityProcessingPipelineFactory::forReflection()->getProcessors()[0]);
        self::assertNotInstanceOf(ReflectionDeduplicationProcessor::class, EntityProcessingPipelineFactory::forStubs()->getProcessors()[0]);
    }
}
