...
namespace Masjid_App\Dependencies\StubTests\Unit\Parsers\AST\fixtures;
...
{
    public function __construct(private readonly string $fixturesBasePath)
    {
    }
    public function getAllStubFiles(): array
    {
        $files = [];
        $iterator = new \RecursiveIteratorIterator(new \RecursiveDirectoryIterator($this->fixturesBasePath, \RecursiveDirectoryIterator::SKIP_DOTS));
