...
class ReflectionMethodParserTest extends TestCase
{
    ...
    {
        $reflectionMethodMock = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods([])->getMock();
    ...
    {
        $parentClassMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->onlyMethods(['getNamespaceName', 'getName', 'getShortName'])->getMock();
        $parentClassMock->method('getName')->willReturn('Masjid_App\Dependencies\SomeNamespace\SubNamespace\SomeFooClass');
        $parentClassMock->method('getNamespaceName')->willReturn('Masjid_App\Dependencies\SomeNamespace\SubNamespace');
        $parentClassMock->method('getShortName')->willReturn('SomeFooClass');
        $reflectionMethodMock = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['getName', 'getDeclaringClass'])->getMock();
        $reflectionMethodMock->method('getName')->willReturn('foo');
        $reflectionMethodMock->method('getDeclaringClass')->willReturn($parentClassMock);
        $basePHPElement = (new ReflectionMethodParser())->parse($reflectionMethodMock);
        self::assertEquals('Masjid_App\Dependencies\SomeNamespace\SubNamespace\SomeFooClass::foo', $basePHPElement->getId());
    }
    public function testItCanParseIdIfNoNamespaceIsPresent()
    {
        $parentClassMock = $this->getMockBuilder(AdaptedReflectionClass::class)->disableOriginalConstructor()->onlyMethods(['getName', 'getNamespaceName'])->getMock();
    ...
    {
        $reflectionMethodMock = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['isPublic'])->getMock();
        $reflectionMethodMock->method('isPublic')->willReturn(\true);
        $basePHPElement = (new ReflectionMethodParser())->parse($reflectionMethodMock);
    ...
    {
        $reflectionMethodMock = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['isPublic', 'isProtected', 'isPrivate'])->getMock();
        $reflectionMethodMock->method('isPublic')->willReturn(\false);
        $reflectionMethodMock->method('isProtected')->willReturn(\false);
        $reflectionMethodMock->method('isPrivate')->willReturn(\true);
        $basePHPElement = (new ReflectionMethodParser())->parse($reflectionMethodMock);
    ...
    public function testItCanParseVisibilityIfVisibilityIsProtected()
    {
        $reflectionMethodMock = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['isPublic', 'isProtected', 'isPrivate'])->getMock();
        $reflectionMethodMock->method('isPublic')->willReturn(\false);
        $reflectionMethodMock->method('isProtected')->willReturn(\true);
    ...
    {
        $reflectionMethodMock = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['isStatic'])->getMock();
        $reflectionMethodMock->method('isStatic')->willReturn(\true);
        $basePHPElement = (new ReflectionMethodParser())->parse($reflectionMethodMock);
    ...
    {
        $reflectionMethodMock = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['isFinal'])->getMock();
        $reflectionMethodMock->method('isFinal')->willReturn(\true);
        $basePHPElement = (new ReflectionMethodParser())->parse($reflectionMethodMock);
    ...
    {
        $reflectionMethodMock = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['isAbstract'])->getMock();
        $reflectionMethodMock->method('isAbstract')->willReturn(\true);
        $basePHPElement = (new ReflectionMethodParser())->parse($reflectionMethodMock);
    ...
    {
        $reflectionMethodMock = $this->getMockBuilder(AdaptedReflectionMethod::class)->disableOriginalConstructor()->onlyMethods(['isDeprecated'])->getMock();
        $reflectionMethodMock->method('isDeprecated')->willReturn(\true);
        $basePHPElement = (new ReflectionMethodParser())->parse($reflectionMethodMock);
    ...
    public function testItCanParseSimpleReturnType()
    {
        ...
        $returnTypeMock = $this->getMockBuilder(AdaptedReflectionType::class)->disableOriginalConstructor()->onlyMethods(['getName', 'allowsNull', 'isUnionType', 'isIntersectionType'])->getMock();
        ...
        $reflectionMethodMock->method('hasReturnType')->willReturn(\true);
    ...
    public function testItCanParseTentativeReturnType()
    {
        ...
        $reflectionMethodMock->method('hasTentativeReturnType')->willReturn(\true);
