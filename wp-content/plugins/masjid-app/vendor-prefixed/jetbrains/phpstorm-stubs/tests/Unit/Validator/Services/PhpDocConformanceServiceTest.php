...
class PhpDocConformanceServiceTest extends TestCase
{
    ...
    {
        $this->assertTrue($this->service->isPhpDocCompatibleWithSignature('Masjid_App\Dependencies\Some\Namespace\MyClass', 'MyClass'));
    }
    // ── @template variables ───────────────────────────────────────
    ...
    public static function phpStanTypeNarrowingProvider(): array
    {
        return [
            ...
            'const fetch' => ['Masjid_App\Dependencies\FFI\CType::TYPE_VOID', 'mixed'],
