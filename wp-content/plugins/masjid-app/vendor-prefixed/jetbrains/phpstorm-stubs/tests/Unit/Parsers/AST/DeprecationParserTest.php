...
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Stubs\Versions\DeprecationParser;
...
class DeprecationParserTest extends BaseTestCase
{
    ...
    {
        return [
            'not deprecated' => ['<?php function f(): void {}', \false, null],
            'JetBrains attribute, named since' => ['<?php use JetBrains\PhpStorm\Deprecated; #[Deprecated("reason", since: "8.4")] function f(): void {}', \true, '8.4'],
            'JetBrains attribute, no since' => ['<?php use JetBrains\PhpStorm\Deprecated; #[Deprecated("reason")] function f(): void {}', \true, null],
            'JetBrains attribute, bare' => ['<?php use JetBrains\PhpStorm\Deprecated; #[Deprecated] function f(): void {}', \true, null],
            // JetBrains signature is ($reason, $replacement, $since) — since is argument 2.
            'JetBrains attribute, positional since' => ['<?php use JetBrains\PhpStorm\Deprecated; #[Deprecated("reason", "replacement", "8.4")] function f(): void {}', \true, '8.4'],
            'JetBrains attribute, fully qualified' => ['<?php #[\JetBrains\PhpStorm\Deprecated(since: "7.3")] function f(): void {}', \true, '7.3'],
            'built-in attribute, bare' => ['<?php #[Deprecated] function f(): void {}', \true, null],
            'built-in attribute, named since' => ['<?php #[Deprecated(message: "msg", since: "8.5")] function f(): void {}', \true, '8.5'],
            // Built-in signature is ($message, $since) — since is argument 1, not 2.
            'built-in attribute, positional since' => ['<?php #[Deprecated("msg", "8.4")] function f(): void {}', \true, '8.4'],
        ];
    }
