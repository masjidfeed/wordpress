...
class ClassMethodsReturnTypesCheckTest extends CheckTestCase
{
    ...
    public function testMatchingReturnTypeIsSuccess(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getValue', $returnType)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getValue', $returnType)]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = (new ClassMethodsReturnTypesCheck($provider))->run($stubs, $className, '8.0');
    ...
    {
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getValue', new StandaloneType('string'))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getValue', new StandaloneType('int'))]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = (new ClassMethodsReturnTypesCheck($provider))->run($stubs, $className, '8.0');
    ...
    public function testReflectionMethodHasNoTypeIsSkipped(): void
    {
        ...
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getValue', null)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getValue', new StandaloneType('string'))]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = (new ClassMethodsReturnTypesCheck($provider))->run($stubs, $className, '8.0');
    ...
    public function testBothHaveNoTypeIsSuccess(): void
    {
        $className = '\MyClass';
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getValue', null)]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getValue', null)]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
        $result = (new ClassMethodsReturnTypesCheck($provider))->run($stubs, $className, '8.0');
    ...
    public function testMethodNotFoundInStubsIsSkipped(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('missingMethod', new StandaloneType('string'))]);
        $stubClass = $this->createMockClassWithProperties($className);
        // no methods
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
    ...
    public function testStaticReturnTypeMatchesConcreteClassName(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('create', new StandaloneType('MyClass'))]);
    ...
    public function testStaticUnionReturnTypeMatchesConcreteClassNameInUnion(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getCurrent', new StandaloneType('MyClass|null'))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$stubMethod]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testBothStaticReturnTypesMatch(): void
    {
        ...
        $stubMethod->setName('create');
        $stubMethod->setReturnTypeFromSignature(new StandaloneType('static'));
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('create', new StandaloneType('static'))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$stubMethod]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testStaticReturnTypeInheritedMethodMatchesParentClassInReflection(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties($childClassName, null, null, null, [$this->makeMethod('children', new StandaloneType('ParentClass|null'))]);
        $stubClass = $this->createMockClassWithProperties($childClassName, null, null, null, [$stubMethod]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testStaticReturnTypeReportsFailureForUnrelatedType(): void
    {
        ...
        $stubMethod->setReturnTypeFromSignature(new StandaloneType('static'));
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('compute', new StandaloneType('int'))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$stubMethod]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testTrueReturnTypeWhenReflectionReturnsBoolIsSkipped(): void
    {
        ...
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('doSomething', new StandaloneType('bool'))]);
        $stubClass = $this->createMockClassWithProperties($className, null, null, null, [$stubMethod]);
        $provider = $this->createMockReflectionProvider([], [$reflClass]);
        $stubs = $this->createMockStorageManager();
        $stubs->method('getClasses')->willReturn([$stubClass]);
    ...
    public function testKnownProblemAtClassLevelSkipsAllMethods(): void
    {
        ...
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::CLASS_TYPE, entityId: $className, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::RETURN_TYPES], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Test class skip')]);
        KnownProblemsRegistry::reset();
    ...
    public function testKnownProblemAtMethodLevelSkipsSpecificMethod(): void
    {
        ...
        $knownProblemsProvider = $this->createStub(\Masjid_App\Dependencies\StubTests\Framework\Validator\KnownProblems\KnownProblemsProvider::class);
        $knownProblemsProvider->method('getProblems')->willReturn([new ProblemDefinition(entityType: EntityType::METHOD, entityId: $methodEntityId, type: ProblemType::INTERNAL_IMPLEMENTATION, affectedChecks: [CheckType::RETURN_TYPES], versionRange: new PhpVersionRange(PhpVersions::EARLIEST, PhpVersions::LATEST), reason: 'Test method skip')]);
        KnownProblemsRegistry::reset();
        $registry = KnownProblemsRegistry::getInstance($knownProblemsProvider);
        // Mismatch: different types — would normally fail
        $reflClass = $this->createMockClassWithProperties($className, null, null, null, [$this->makeMethod('getValue', new StandaloneType('string'))]);
