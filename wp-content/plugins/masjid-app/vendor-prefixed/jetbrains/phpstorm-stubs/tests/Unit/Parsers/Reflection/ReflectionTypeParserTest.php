...
use Masjid_App\Dependencies\StubTests\Framework\Parsers\Reflection\ReflectionTypeParser;
class ReflectionTypeParserTest extends TestCase
{
    ...
    public function testItParsesIntersectionType()
    {
        ...
        self::assertInstanceOf(\Masjid_App\Dependencies\StubTests\Framework\Model\Types\IntersectionType::class, $result);
