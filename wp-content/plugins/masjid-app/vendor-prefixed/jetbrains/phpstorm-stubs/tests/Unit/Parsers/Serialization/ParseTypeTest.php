...
{
    private \Masjid_App\Dependencies\StubTests\Unit\Parsers\Serialization\ParseTypeTestHelper $helper;
    protected function setUp(): void
    {
        $this->helper = new \Masjid_App\Dependencies\StubTests\Unit\Parsers\Serialization\ParseTypeTestHelper();
    }
    // ------------------------------------------------------------------
    // NoType
    // ------------------------------------------------------------------
