...
class PhpDocValidatorTest extends ValidatorTestBase
{
    ...
    {
        $this->executeCheck(new PhpDocTagsCheck(), $entityId, $phpVersion, "PhpDoc of {$entityId} contains invalid tags in PHP {$phpVersion}");
    }
    /**
    ...
    {
        $this->executeCheck(new PhpDocLinksCheck(), $entityId, $phpVersion, "PhpDoc of {$entityId} has @link issues in PHP {$phpVersion}");
    }
    /**
    ...
    {
        $this->executeCheck(new PhpDocVersionFormatCheck(), $entityId, $phpVersion, "PhpDoc of {$entityId} uses patch-level version in PHP {$phpVersion}");
    }
}
