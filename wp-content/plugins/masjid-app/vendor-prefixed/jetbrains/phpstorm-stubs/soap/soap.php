 ...
 * @link https://php.net/manual/en/class.soapclient.php
 */
\class_alias('Masjid_App\Dependencies\SoapClient', 'SoapClient', \false);
/**
 ...
 * @link https://php.net/manual/en/class.soapvar.php
 */
\class_alias('Masjid_App\Dependencies\SoapVar', 'SoapVar', \false);
/**
...
class SoapServer
{
    ...
    public function fault(
        ...
        #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')]
        $name = '',
        #[PhpStormStubsElementAvailable('8.5')]
        string $lang = ''
    ): void
    {
    }
 ...
 * @link https://php.net/manual/en/class.soapserver.php
 */
\class_alias('Masjid_App\Dependencies\SoapServer', 'SoapServer', \false);
/**
 ...
 * @link https://php.net/manual/en/class.soapfault.php
 */
\class_alias('Masjid_App\Dependencies\SoapFault', 'SoapFault', \false);
/**
 ...
 * @link https://php.net/manual/en/class.soapparam.php
 */
\class_alias('Masjid_App\Dependencies\SoapParam', 'SoapParam', \false);
/**
 ...
 * @link https://php.net/manual/en/class.soapheader.php
 */
\class_alias('Masjid_App\Dependencies\SoapHeader', 'SoapHeader', \false);
/**
