...
class SQLiteDatabase
{
     ...
     * option.</p>
     */
    public function arrayQuery($query, $result_type = \SQLITE_BOTH, $decode_binary = \true)
    {
    }
    /**
     ...
     * @return array
     */
    public function singleQuery($query, $first_row_only = \true, $decode_binary = \true)
    {
    }
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
 ...
 * @link https://php.net/manual/en/ref.sqlite.php
 */
\class_alias('Masjid_App\Dependencies\SQLiteDatabase', 'SQLiteDatabase', \false);
/**
 * @link https://php.net/manual/en/ref.sqlite.php
 */
final class SQLiteResult implements \Iterator, \Countable
{
     ...
     * @return object
     */
    public function fetchObject($class_name = 'stdClass', $ctor_params = [], $decode_binary = \true)
    {
    }
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.1)
     ...
     * @return object
     */
    public function fetchAll($result_type = \SQLITE_BOTH, $decode_binary = \true)
    {
    }
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
 ...
 * @link https://php.net/manual/en/ref.sqlite.php
 */
\class_alias('Masjid_App\Dependencies\SQLiteResult', 'SQLiteResult', \false);
/**
 ...
 * @link https://php.net/manual/en/ref.sqlite.php
 */
\class_alias('Masjid_App\Dependencies\SQLiteUnbuffered', 'SQLiteUnbuffered', \false);
...
\class_alias('Masjid_App\Dependencies\SQLiteException', 'SQLiteException', \false);
/**
