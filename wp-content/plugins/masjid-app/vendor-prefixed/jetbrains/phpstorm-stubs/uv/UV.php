...
\class_alias('Masjid_App\Dependencies\UV', 'UV', \false);
abstract class UVStream extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVStream', 'UVStream', \false);
class UVTcp extends \UVStream
{
}
\class_alias('Masjid_App\Dependencies\UVTcp', 'UVTcp', \false);
class UVUdp extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVUdp', 'UVUdp', \false);
class UVPipe extends \UVStream
{
}
\class_alias('Masjid_App\Dependencies\UVPipe', 'UVPipe', \false);
class UVIdle extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVIdle', 'UVIdle', \false);
class UVTimer extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVTimer', 'UVTimer', \false);
class UVAsync extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVAsync', 'UVAsync', \false);
class UVAddrinfo extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVAddrinfo', 'UVAddrinfo', \false);
class UVProcess extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVProcess', 'UVProcess', \false);
class UVPrepare extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVPrepare', 'UVPrepare', \false);
class UVCheck extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVCheck', 'UVCheck', \false);
class UVWork extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVWork', 'UVWork', \false);
class UVFs extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVFs', 'UVFs', \false);
class UVFsEvent extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVFsEvent', 'UVFsEvent', \false);
class UVTty extends \UVStream
{
}
\class_alias('Masjid_App\Dependencies\UVTty', 'UVTty', \false);
class UVFsPoll extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVFsPoll', 'UVFsPoll', \false);
class UVPoll extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVPoll', 'UVPoll', \false);
class UVSignal extends \UV
{
}
\class_alias('Masjid_App\Dependencies\UVSignal', 'UVSignal', \false);
class UVLoop
{
}
\class_alias('Masjid_App\Dependencies\UVLoop', 'UVLoop', \false);
abstract class UVSockAddr
{
}
\class_alias('Masjid_App\Dependencies\UVSockAddr', 'UVSockAddr', \false);
class UVSockAddrIPv4 extends \UVSockAddr
{
}
\class_alias('Masjid_App\Dependencies\UVSockAddrIPv4', 'UVSockAddrIPv4', \false);
class UVSockAddrIPv6 extends \UVSockAddr
{
}
\class_alias('Masjid_App\Dependencies\UVSockAddrIPv6', 'UVSockAddrIPv6', \false);
class UVLock
{
}
\class_alias('Masjid_App\Dependencies\UVLock', 'UVLock', \false);
class UVStdio
{
}
\class_alias('Masjid_App\Dependencies\UVStdio', 'UVStdio', \false);
