...
use Masjid_App\Dependencies\JetBrains\PhpStorm\ExpectedValues as EV;
use Masjid_App\Dependencies\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware as LanguageAware;
use Masjid_App\Dependencies\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable as ElementAvailable;
...
\class_alias('Masjid_App\Dependencies\Collator', 'Collator', \false);
...
\class_alias('Masjid_App\Dependencies\NumberFormatter', 'NumberFormatter', \false);
class Normalizer
{
...
\class_alias('Masjid_App\Dependencies\Normalizer', 'Normalizer', \false);
class Locale
{
    /**
...
\class_alias('Masjid_App\Dependencies\Locale', 'Locale', \false);
...
\class_alias('Masjid_App\Dependencies\MessageFormatter', 'MessageFormatter', \false);
class IntlDateFormatter
{
    ...
    public function __construct(
        ...
        #[ElementAvailable(from: '8.1')]
        int $timeType = 0,
        #[LanguageAware(['8.5' => 'IntlTimeZone|DateTimeZone|string|null'], default: '')]
        $timezone = null,
        $calendar = null,
        #[LanguageAware(['8.0' => 'string|null'], default: '')]
        $pattern = null
...
\class_alias('Masjid_App\Dependencies\IntlDateFormatter', 'IntlDateFormatter', \false);
...
\class_alias('Masjid_App\Dependencies\ResourceBundle', 'ResourceBundle', \false);
/**
 * @since 5.4
 */
 ...
 * @since 5.4
 */
\class_alias('Masjid_App\Dependencies\Transliterator', 'Transliterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.spoofchecker.php
 */
\class_alias('Masjid_App\Dependencies\Spoofchecker', 'Spoofchecker', \false);
/**
 * @since 5.5
 */
 ...
 * @since 5.5
 */
\class_alias('Masjid_App\Dependencies\IntlGregorianCalendar', 'IntlGregorianCalendar', \false);
/**
 * @since 5.5
 */
class IntlCalendar
 ...
 * @since 5.5
 */
\class_alias('Masjid_App\Dependencies\IntlCalendar', 'IntlCalendar', \false);
/**
 * @since 5.5
 */
 ...
 * @since 5.5
 */
\class_alias('Masjid_App\Dependencies\IntlIterator', 'IntlIterator', \false);
/**
 * @since 5.5
 */
 ...
 * @since 5.5
 */
\class_alias('Masjid_App\Dependencies\IntlException', 'IntlException', \false);
/**
 * @since 5.5
 */
class IntlTimeZone
{
    ...
    public static function createEnumeration(
        #[LanguageAware(['8.5' => 'string|int|null'], default: '')]
        $countryOrRawOffset
    ): \IntlIterator|false
    {
    }
 ...
 * @since 5.5
 */
\class_alias('Masjid_App\Dependencies\IntlTimeZone', 'IntlTimeZone', \false);
/**
 * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
 * Create a collator
 * @link https://php.net/manual/en/collator.create.php
...
class IntlBreakIterator implements \IteratorAggregate
{
    ...
    public function getPartsIterator(
        #[LanguageAware(['8.6' => 'int', '8.0' => 'string'], default: '')]
 ...
 * @since 5.5
 */
\class_alias('Masjid_App\Dependencies\IntlBreakIterator', 'IntlBreakIterator', \false);
...
\class_alias('Masjid_App\Dependencies\IntlRuleBasedBreakIterator', 'IntlRuleBasedBreakIterator', \false);
/**
 ...
 * @since 5.5
 */
\class_alias('Masjid_App\Dependencies\IntlPartsIterator', 'IntlPartsIterator', \false);
...
\class_alias('Masjid_App\Dependencies\IntlCodePointBreakIterator', 'IntlCodePointBreakIterator', \false);
class UConverter
{
    /* Constants */
    ...
    public static function transcode(
        ...
        #[LanguageAware(['8.0' => 'string'], default: '')]
        $fromEncoding,
        #[LanguageAware(['7.1' => 'array|null'], default: '')]
        $options = null
    ): string|false
    {
    }
}
\class_alias('Masjid_App\Dependencies\UConverter', 'UConverter', \false);
// End of intl v.1.1.0
