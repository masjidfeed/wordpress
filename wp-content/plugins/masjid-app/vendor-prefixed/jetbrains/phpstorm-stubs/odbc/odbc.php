...
function odbc_autocommit(
    #[LanguageLevelTypeAware(['8.4' => 'Masjid_App\Dependencies\Odbc\Connection'], default: 'resource')]
    $odbc,
    ?bool $enable = \false
): int|bool
{
...
function odbc_binmode(
    #[LanguageLevelTypeAware(['8.4' => 'Masjid_App\Dependencies\Odbc\Result'], default: 'resource')]
    $statement,
    int $mode
)
{
...
function odbc_connect(
    string $dsn,
    #[PhpStormStubsElementAvailable(from: '5.3', to: '8.3')]
    string $user,
 ...
 */
function odbc_error(
    #[LanguageLevelTypeAware(['8.4' => '\Odbc\Connection|null'], default: 'resource')]
    $odbc = null
): string
{
}
...
function odbc_fetch_array(
    #[LanguageLevelTypeAware(['8.4' => 'Masjid_App\Dependencies\Odbc\Result'], default: 'resource')]
    $statement,
    #[LanguageLevelTypeAware(['8.4' => 'int|null'], default: 'int')]
    $row = -1
): array|false
{
}
...
function odbc_setoption(
    #[LanguageLevelTypeAware(['8.4' => '\Odbc\Connection|\Odbc\Result'], default: 'resource')]
    $odbc,
    int $which,
    int $option,
    int $value
