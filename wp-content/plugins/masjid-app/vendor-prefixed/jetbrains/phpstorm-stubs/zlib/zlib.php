...
function readgzfile(
    string $filename,
    #[LanguageLevelTypeAware(['8.5' => 'bool'], default: 'int')]
...
function deflate_init(
    int $encoding,
    #[LanguageLevelTypeAware(["8.3" => "array|object"], default: "array")]
    $options = []
)
{
}
 ...
 * @since 8.0
 */
\class_alias('Masjid_App\Dependencies\InflateContext', 'InflateContext', \false);
/**
 * @since 8.0
 */
 ...
 * @since 8.0
 */
\class_alias('Masjid_App\Dependencies\DeflateContext', 'DeflateContext', \false);
