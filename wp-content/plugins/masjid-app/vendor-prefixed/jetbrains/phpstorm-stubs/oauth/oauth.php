 ...
 * The OAuth extension provides a simple interface to interact with data providers using the OAuth HTTP specification to protect private resources.
 */
\class_alias('Masjid_App\Dependencies\OAuth', 'OAuth', \false);
...
\class_alias('Masjid_App\Dependencies\OAuthException', 'OAuthException', \false);
/**
 ...
 * Manages an OAuth provider class.
 */
\class_alias('Masjid_App\Dependencies\OAuthProvider', 'OAuthProvider', \false);
