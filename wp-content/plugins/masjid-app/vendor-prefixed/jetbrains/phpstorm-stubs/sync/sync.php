 ...
 * @link https://php.net/manual/en/class.syncmutex.php
 */
\class_alias('Masjid_App\Dependencies\SyncMutex', 'SyncMutex', \false);
/**
 * SyncSemaphore
 *
...
class SyncSemaphore
{
     ...
     */
    public function __construct($name = null, $initialval = 1, $autounlock = \true)
    {
    }
    /**
 ...
 * @link https://php.net/manual/en/class.syncsemaphore.php
 */
\class_alias('Masjid_App\Dependencies\SyncSemaphore', 'SyncSemaphore', \false);
/**
 * SyncEvent
 *
 ...
 * @link https://php.net/manual/en/class.syncevent.php
 */
\class_alias('Masjid_App\Dependencies\SyncEvent', 'SyncEvent', \false);
/**
 * SyncReaderWriter
 *
...
class SyncReaderWriter
{
     ...
     */
    public function __construct($name = null, $autounlock = \true)
    {
    }
    /**
 ...
 * @link https://php.net/manual/en/class.syncreaderwriter.php
 */
\class_alias('Masjid_App\Dependencies\SyncReaderWriter', 'SyncReaderWriter', \false);
/**
 * SyncSharedMemory
 *
 ...
 * @link https://php.net/manual/en/class.syncsharedmemory.php
 */
\class_alias('Masjid_App\Dependencies\SyncSharedMemory', 'SyncSharedMemory', \false);
