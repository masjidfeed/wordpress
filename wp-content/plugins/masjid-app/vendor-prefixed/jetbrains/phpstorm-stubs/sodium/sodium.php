...
\define('SODIUM_CRYPTO_IPCRYPT_BYTES', 16);
\define('SODIUM_CRYPTO_IPCRYPT_KEYBYTES', 16);
\define('SODIUM_CRYPTO_IPCRYPT_ND_INPUTBYTES', 16);
\define('SODIUM_CRYPTO_IPCRYPT_ND_KEYBYTES', 16);
\define('SODIUM_CRYPTO_IPCRYPT_ND_OUTPUTBYTES', 24);
\define('SODIUM_CRYPTO_IPCRYPT_ND_TWEAKBYTES', 8);
\define('SODIUM_CRYPTO_IPCRYPT_NDX_INPUTBYTES', 16);
\define('SODIUM_CRYPTO_IPCRYPT_NDX_KEYBYTES', 32);
\define('SODIUM_CRYPTO_IPCRYPT_NDX_OUTPUTBYTES', 32);
\define('SODIUM_CRYPTO_IPCRYPT_NDX_TWEAKBYTES', 16);
\define('SODIUM_CRYPTO_IPCRYPT_PFX_BYTES', 16);
\define('SODIUM_CRYPTO_IPCRYPT_PFX_KEYBYTES', 32);
\define('SODIUM_CRYPTO_XOF_SHAKE128_BLOCKBYTES', 168);
\define('SODIUM_CRYPTO_XOF_SHAKE128_STATEBYTES', 256);
\define('SODIUM_CRYPTO_XOF_SHAKE256_BLOCKBYTES', 136);
\define('SODIUM_CRYPTO_XOF_SHAKE256_STATEBYTES', 256);
\define('SODIUM_CRYPTO_XOF_TURBOSHAKE128_BLOCKBYTES', 168);
\define('SODIUM_CRYPTO_XOF_TURBOSHAKE128_STATEBYTES', 256);
\define('SODIUM_CRYPTO_XOF_TURBOSHAKE256_BLOCKBYTES', 136);
\define('SODIUM_CRYPTO_XOF_TURBOSHAKE256_STATEBYTES', 256);
...
\class_alias('Masjid_App\Dependencies\SodiumException', 'SodiumException', \false);
