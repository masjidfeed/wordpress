...
class Relay
{
     ...
     */
    #[Attributes\RedisCommand]
    public function gcra(string $key, int $maxBurst, int $requestsPerPeriod, int $period, int $tokens = 0): Relay|array|false
    {
    }
    /**
     ...
     */
    #[Attributes\RedisCommand]
    public function lmovem(mixed $srckey, mixed $dstkey, string $srcpos, string $dstpos, ?array $options = null): Relay|array|false
    {
    }
    /**
     ...
     */
    #[Attributes\RedisCommand]
    public function blmovem(mixed $srckey, mixed $dstkey, string $srcpos, string $dstpos, float $timeout, ?array $options = null): Relay|array|false
    {
    }
    /**
