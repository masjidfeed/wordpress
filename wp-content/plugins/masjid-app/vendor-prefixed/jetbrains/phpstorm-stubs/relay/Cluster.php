...
namespace Masjid_App\Dependencies\Relay;
...
class Cluster
{
    ...
    public function blmovem(mixed $srckey, mixed $dstkey, string $srcpos, string $dstpos, float $timeout, ?array $options = null): Cluster|array|false
    {
    }
    /**
     ...
     */
    #[Attributes\RedisCommand]
    public function gcra(string $key, int $maxBurst, int $requestsPerPeriod, int $period, int $tokens = 0): Cluster|array|false
    {
    }
    /**
     ...
     */
    #[Attributes\RedisCommand]
    public function lmovem(mixed $srckey, mixed $dstkey, string $srcpos, string $dstpos, ?array $options = null): Cluster|array|false
    {
    }
    /**
