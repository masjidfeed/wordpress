...
final class FFI
{
     ...
     * @throws ParserException
     */
    #[LanguageLevelTypeAware(['8.4' => 'Masjid_App\Dependencies\FFI\CData'], default: '\FFI\CData|null')]
    public function new(CType|string $type, bool $owned = \true, bool $persistent = \false)
    {
    }
    /**
     ...
     *         object, or {@see null} on failure for PHP versions prior to 8.4.
     */
    #[LanguageLevelTypeAware(['8.4' => 'Masjid_App\Dependencies\FFI\CType'], default: '\FFI\CType|null')]
 ...
 * @since 7.4
 */
\class_alias('Masjid_App\Dependencies\FFI', 'FFI', \false);
