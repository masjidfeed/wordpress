 ...
 * @return null
 */
function newrelic_notice_error(string|\Throwable|\Exception|int $messageOrExceptionOrCode, string|\Throwable|\Exception|null $errstrOrException = null, ?string $errfile = null, ?int $errline = null, ?string $errcontext = null)
{
}
/**
