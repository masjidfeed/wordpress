...
function pg_connect_poll(
    ...
    $connection = null,
    #[PhpStormStubsElementAvailable(from: '8.0')]
    #[LanguageLevelTypeAware(['8.1' => 'Masjid_App\Dependencies\PgSql\Connection'], default: 'resource')]
    $connection
): int
{
}
...
function pg_fetch_result(
    #[LanguageLevelTypeAware(['8.1' => 'Masjid_App\Dependencies\PgSql\Result'], default: 'resource')]
    $result,
    #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')]
    $row = 0,
    #[PhpStormStubsElementAvailable(from: '8.0')]
...
function pg_copy_from(
    ...
    $connection,
    string $table_name,
    #[LanguageLevelTypeAware(['8.5' => 'Traversable|array'], default: 'array')]
    $rows,
    string $separator = '	',
    string $null_as = '\\\\N'
): bool
...
function pg_lo_close(
    #[LanguageLevelTypeAware(['8.1' => 'Masjid_App\Dependencies\PgSql\Lob'], default: 'resource')]
    $lob
): bool
{
}
...
\define('PGSQL_ERRORS_SQLSTATE', 3);
