 ...
 */
#[ArrayShape(['name' => 'string', 'subject' => 'array', 'hash' => 'string', 'issuer' => 'array', 'version' => 'int', 'serialNumber' => 'string', 'serialNumberHex' => 'string', 'validFrom' => 'string', 'validTo' => 'string', 'validFrom_time_t' => 'int', 'validTo_time_t' => 'int', 'alias' => 'string', 'signatureTypeSN' => 'string', 'signatureTypeLN' => 'string', 'signatureTypeNID' => 'int', 'purposes' => 'array', 'extensions' => 'array'])]
...
function openssl_encrypt(
    ...
    &$tag = null,
    #[PhpStormStubsElementAvailable(from: '7.1')]
    #[LanguageLevelTypeAware(['8.6' => 'string|null'], default: 'string')]
    $aad = "",
    #[PhpStormStubsElementAvailable(from: '7.1')]
    int $tag_length = 16
): string|false
...
function openssl_sign(
    ...
    #[PhpStormStubsElementAvailable(from: '8.5')]
    int $padding = 0
): bool
{
}
...
function openssl_cms_encrypt(
    ...
    #[LanguageLevelTypeAware(['8.5' => 'int|string'], default: 'int')]
    $cipher_algo = \OPENSSL_CIPHER_AES_128_CBC
): bool
{
}
/**
 ...
 * @since 8.0
 */
\class_alias('Masjid_App\Dependencies\OpenSSLCertificate', 'OpenSSLCertificate', \false);
/**
 * @since 8.0
 */
 ...
 * @since 8.0
 */
\class_alias('Masjid_App\Dependencies\OpenSSLCertificateSigningRequest', 'OpenSSLCertificateSigningRequest', \false);
/**
 * @since 8.0
 */
 ...
 * @since 8.0
 */
\class_alias('Masjid_App\Dependencies\OpenSSLAsymmetricKey', 'OpenSSLAsymmetricKey', \false);
