 ...
 * Ev is a singleton providing access to the default loop and to some common operations.
 */
\class_alias('Masjid_App\Dependencies\Ev', 'Ev', \false);
/**
 * Class EvWatcher
 */
 ...
 * Class EvWatcher
 */
\class_alias('Masjid_App\Dependencies\EvWatcher', 'EvWatcher', \false);
/**
 * Class EvCheck
 *
 ...
 * before other EvCheck watchers did their job.
 */
\class_alias('Masjid_App\Dependencies\EvCheck', 'EvCheck', \false);
/**
 * Class EvChild
 *
 ...
 * It is allowed to register EvChild watchers in the default loop only.
 */
\class_alias('Masjid_App\Dependencies\EvChild', 'EvChild', \false);
/**
 * Class EvEmbed
 *
 ...
 * Used to embed one event loop into another.
 */
\class_alias('Masjid_App\Dependencies\EvEmbed', 'EvEmbed', \false);
/**
 * Class EvIo
 *
 ...
 * Always consider using non-blocking mode.
 */
\class_alias('Masjid_App\Dependencies\EvIo', 'EvIo', \false);
/**
 * Class EvPeriodic
 *
 ...
 * recursively).
 */
\class_alias('Masjid_App\Dependencies\EvPeriodic', 'EvPeriodic', \false);
/**
 * Class EvPrepare
 *
 * EvPrepare and EvCheck watchers are usually used in pairs. EvPrepare watchers get invoked before the process blocks,
 ...
 * before other EvCheck watchers did their job.
 */
\class_alias('Masjid_App\Dependencies\EvPrepare', 'EvPrepare', \false);
/**
 * Class EvSignal
 *
 ...
 * all the signals can be blocked in an EvCheck watcher and unblocked in a EvPrepare watcher.
 */
\class_alias('Masjid_App\Dependencies\EvSignal', 'EvSignal', \false);
/**
 * Class EvStat
 *
 ...
 * notifications, this can be resource-intensive.
 */
\class_alias('Masjid_App\Dependencies\EvStat', 'EvStat', \false);
/**
 * Class EvTimer
 *
 ...
 * iteration.
 */
\class_alias('Masjid_App\Dependencies\EvTimer', 'EvTimer', \false);
/**
 * Class EvIdle
 *
 ...
 * for new events.
 */
\class_alias('Masjid_App\Dependencies\EvIdle', 'EvIdle', \false);
/**
 * Class EvFork
 *
 ...
 * fork handlers will be invoked, too.
 */
\class_alias('Masjid_App\Dependencies\EvFork', 'EvFork', \false);
/**
 * Class EvLoop
 *
 ...
 * EvLoop::defaultLoop() method.
 */
\class_alias('Masjid_App\Dependencies\EvLoop', 'EvLoop', \false);
