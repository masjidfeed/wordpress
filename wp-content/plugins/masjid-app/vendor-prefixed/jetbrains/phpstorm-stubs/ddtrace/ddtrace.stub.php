...
namespace Masjid_App\Dependencies\DDTrace;

\define('DDTrace\DBM_PROPAGATION_DISABLED', 0);
\define('DDTrace\DBM_PROPAGATION_SERVICE', 0);
\define('DDTrace\DBM_PROPAGATION_FULL', 0);
 ...
 */
function trace_method(string $className, string $methodName, null|\Closure|array $tracingClosureOrConfigArray): bool
{
}
/**
 ...
 */
function hook_function(string $functionName, \Closure|array|null $prehookOrConfigArray = null, ?\Closure $posthook = null): bool
{
}
/**
 ...
 */
function hook_method(string $className, string $methodName, \Closure|array|null $prehookOrConfigArray = null, ?\Closure $posthook = null): bool
{
}
 ...
 */
function set_distributed_tracing_context(string $traceId, string $parentId, ?string $origin = null, array|string|null $propagated_tags = null): bool
{
}
/**
...
namespace Masjid_App\Dependencies\DDTrace\System;
...
namespace Masjid_App\Dependencies\DDTrace\Config;
...
namespace Masjid_App\Dependencies\DDTrace\UserRequest;
...
namespace Masjid_App\Dependencies\DDTrace\Testing;
...
namespace Masjid_App\Dependencies\DDTrace\Internal;

\define('DDTrace\Internal\SPAN_FLAG_OPENTELEMETRY', 0);
\define('DDTrace\Internal\SPAN_FLAG_OPENTRACING', 0);
/**
...
\define('DD_TRACE_VERSION', '0');
\define('DD_TRACE_PRIORITY_SAMPLING_AUTO_KEEP', 0);
\define('DD_TRACE_PRIORITY_SAMPLING_AUTO_REJECT', 0);
\define('DD_TRACE_PRIORITY_SAMPLING_USER_KEEP', 0);
\define('DD_TRACE_PRIORITY_SAMPLING_USER_REJECT', 0);
\define('DD_TRACE_PRIORITY_SAMPLING_UNKNOWN', 0);
\define('DD_TRACE_PRIORITY_SAMPLING_UNSET', 0);
/**
 ...
 */
function dd_trace_method(string $className, string $methodName, \Closure|array|null $tracingClosureOrConfigArray): bool
{
}
/**
