 ...
 * @template-implements Iterator<TKey, TYield>
 */
\class_alias('Masjid_App\Dependencies\Generator', 'Generator', \false);
class ClosedGeneratorException extends \Exception
{
}
\class_alias('Masjid_App\Dependencies\ClosedGeneratorException', 'ClosedGeneratorException', \false);
namespace Masjid_App\Dependencies\___PHPSTORM_HELPERS;
