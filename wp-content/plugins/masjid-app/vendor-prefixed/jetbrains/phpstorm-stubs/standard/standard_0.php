...
use Masjid_App\Dependencies\JetBrains\PhpStorm\FileReference;
...
\class_alias('Masjid_App\Dependencies\__PHP_Incomplete_Class', '__PHP_Incomplete_Class', \false);
...
\class_alias('Masjid_App\Dependencies\php_user_filter', 'php_user_filter', \false);
/**
 * @since 8.4
 */
 ...
 * @since 8.4
 */
\class_alias('Masjid_App\Dependencies\StreamBucket', 'StreamBucket', \false);
/**
 ...
 * Instances of Directory are created by calling the dir() function, not by the new operator.
 */
\class_alias('Masjid_App\Dependencies\Directory', 'Directory', \false);
/**
 ...
 */
#[Pure]
function htmlentities(string $string, int $flags = \ENT_QUOTES | \ENT_SUBSTITUTE, ?string $encoding = null, bool $double_encode = \true): string
{
}
/**
