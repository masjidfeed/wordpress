...
class RedisCluster
{
     ...
     */
    public function vgetattr(string $key, mixed $member, bool $decode = \true): \RedisCluster|array|string|false
    {
    }
    /**
 ...
 * @link   https://github.com/zgb7mtr/phpredis_cluster_phpdoc
 */
\class_alias('Masjid_App\Dependencies\RedisCluster', 'RedisCluster', \false);
class RedisClusterException extends \Exception
{
}
\class_alias('Masjid_App\Dependencies\RedisClusterException', 'RedisClusterException', \false);
