 ...
 * created using:
 */
\class_alias('Masjid_App\Dependencies\classObj', 'classObj', \false);
/**
 ...
 * Instance of clusterObj is always embedded inside the `layerObj`_.
 */
\class_alias('Masjid_App\Dependencies\clusterObj', 'clusterObj', \false);
/**
 ...
 * Instances of colorObj are always embedded inside other classes.
 */
\class_alias('Masjid_App\Dependencies\colorObj', 'colorObj', \false);
...
\class_alias('Masjid_App\Dependencies\errorObj', 'errorObj', \false);
/**
 ...
 * $oLayer->grid->set("labelformat", "DDMMSS");
 */
\class_alias('Masjid_App\Dependencies\gridObj', 'gridObj', \false);
/**
 ...
 * echo "Key: ".$key." value: ".$hashTable->get($key)."<br/>";
 */
\class_alias('Masjid_App\Dependencies\hashTableObj', 'hashTableObj', \false);
/**
 ...
 * Instances of imageObj are always created by the `mapObj`_ class methods.
 */
\class_alias('Masjid_App\Dependencies\imageObj', 'imageObj', \false);
...
\class_alias('Masjid_App\Dependencies\labelcacheMemberObj', 'labelcacheMemberObj', \false);
...
\class_alias('Masjid_App\Dependencies\labelcacheObj', 'labelcacheObj', \false);
/**
 ...
 * labelObj are always embedded inside other classes.
 */
\class_alias('Masjid_App\Dependencies\labelObj', 'labelObj', \false);
/**
 ...
 * layer created.
 */
\class_alias('Masjid_App\Dependencies\layerObj', 'layerObj', \false);
/**
 ...
 * Instances of legendObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('Masjid_App\Dependencies\legendObj', 'legendObj', \false);
final class lineObj
{
    /**
     * read-only
...
\class_alias('Masjid_App\Dependencies\lineObj', 'lineObj', \false);
final class mapObj
{
    /**
     * @var float
...
\class_alias('Masjid_App\Dependencies\mapObj', 'mapObj', \false);
/**
 ...
 * No constructor available (coming soon, see ticket 979)
 */
\class_alias('Masjid_App\Dependencies\outputformatObj', 'outputformatObj', \false);
...
\class_alias('Masjid_App\Dependencies\OwsrequestObj', 'OwsrequestObj', \false);
...
\class_alias('Masjid_App\Dependencies\pointObj', 'pointObj', \false);
...
\class_alias('Masjid_App\Dependencies\projectionObj', 'projectionObj', \false);
/**
 ...
 * `mapObj`_.
 */
\class_alias('Masjid_App\Dependencies\querymapObj', 'querymapObj', \false);
/**
 ...
 * also be created with:
 */
\class_alias('Masjid_App\Dependencies\rectObj', 'rectObj', \false);
/**
 ...
 * Instances of referenceMapObj are always embedded inside the `mapObj`_.
 */
\class_alias('Masjid_App\Dependencies\referenceMapObj', 'referenceMapObj', \false);
...
\class_alias('Masjid_App\Dependencies\resultObj', 'resultObj', \false);
/**
 ...
 * Instances of scalebarObj are always embedded inside the `mapObj`_.
 */
\class_alias('Masjid_App\Dependencies\scalebarObj', 'scalebarObj', \false);
...
\class_alias('Masjid_App\Dependencies\shapefileObj', 'shapefileObj', \false);
...
\class_alias('Masjid_App\Dependencies\shapeObj', 'shapeObj', \false);
/**
 ...
 * Instances of styleObj are always embedded inside a `classObj`_ or `labelObj`_.
 */
\class_alias('Masjid_App\Dependencies\styleObj', 'styleObj', \false);
...
\class_alias('Masjid_App\Dependencies\symbolObj', 'symbolObj', \false);
/**
 ...
 * Instances of webObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('Masjid_App\Dependencies\webObj', 'webObj', \false);
