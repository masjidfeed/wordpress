...
function pspell_new_config(
    #[LanguageLevelTypeAware(['8.1' => 'Masjid_App\Dependencies\PSpell\Config'], default: 'int')]
    $config
)
{
}
...
function pspell_check(
    #[LanguageLevelTypeAware(['8.1' => 'Masjid_App\Dependencies\PSpell\Dictionary'], default: 'int')]
    $dictionary,
    string $word
): bool
{
