...
use Masjid_App\Dependencies\Firebase\JWT\SignatureInvalidException;
use Masjid_App\Dependencies\Google\Auth\Cache\MemoryCacheItemPool;
...
use Masjid_App\Dependencies\phpseclib3\Crypt\PublicKeyLoader;
use Masjid_App\Dependencies\phpseclib3\Crypt\RSA;
use Masjid_App\Dependencies\phpseclib3\Math\BigInteger;
use Masjid_App\Dependencies\Psr\Cache\CacheItemPoolInterface;
use RuntimeException;
use Masjid_App\Dependencies\SimpleJWT\InvalidTokenException;
use Masjid_App\Dependencies\SimpleJWT\JWT as SimpleJWT;
use Masjid_App\Dependencies\SimpleJWT\Keys\KeyFactory;
use Masjid_App\Dependencies\SimpleJWT\Keys\KeySet;
use TypeError;
