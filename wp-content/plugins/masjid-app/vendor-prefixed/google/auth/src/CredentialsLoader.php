...
use Masjid_App\Dependencies\Google\Auth\Credentials\ExternalAccountAuthorizedUserCredentials;
use Masjid_App\Dependencies\Google\Auth\Credentials\ExternalAccountCredentials;
use Masjid_App\Dependencies\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use Masjid_App\Dependencies\Google\Auth\Credentials\InsecureCredentials;
...
abstract class CredentialsLoader implements GetUniverseDomainInterface, FetchAuthTokenInterface, UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], ?callable $httpHandler = null, ?callable $tokenCallback = null)
    {
        ...
        $stack = \Masjid_App\Dependencies\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \Masjid_App\Dependencies\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
