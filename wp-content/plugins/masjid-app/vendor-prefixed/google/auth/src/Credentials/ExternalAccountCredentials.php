...
use Masjid_App\Dependencies\Google\Auth\CredentialSource\AwsNativeSource;
use Masjid_App\Dependencies\Google\Auth\CredentialSource\ExecutableSource;
use Masjid_App\Dependencies\Google\Auth\CredentialSource\FileSource;
use Masjid_App\Dependencies\Google\Auth\CredentialSource\UrlSource;
use Masjid_App\Dependencies\Google\Auth\ExecutableHandler\ExecutableHandler;
use Masjid_App\Dependencies\Google\Auth\ExternalAccountCredentialSourceInterface;
use Masjid_App\Dependencies\Google\Auth\FetchAuthTokenInterface;
use Masjid_App\Dependencies\Google\Auth\GetQuotaProjectInterface;
...
use Masjid_App\Dependencies\Google\Auth\OAuth2;
