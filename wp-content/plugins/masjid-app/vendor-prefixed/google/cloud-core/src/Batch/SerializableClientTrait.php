 ...
 */
namespace Masjid_App\Dependencies\Google\Cloud\Core\Batch;

use Masjid_App\Dependencies\Opis\Closure\SerializableClosure;
/**
...
trait SerializableClientTrait
{
    ...
    {
        if (function_exists('Masjid_App\Dependencies\Opis\Closure\serialize')) {
