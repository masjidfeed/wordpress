 ...
 */
namespace Masjid_App\Dependencies\Google\Cloud\Core\Testing;

use Masjid_App\Dependencies\Google\Cloud\Core\Testing\RegexFileFilter;
use Masjid_App\Dependencies\Google\Cloud\Core\Testing\Snippet\Container;
use Masjid_App\Dependencies\Google\Cloud\Core\Testing\Snippet\Coverage\Coverage;
use Masjid_App\Dependencies\Google\Cloud\Core\Testing\Snippet\Coverage\Scanner;
use Masjid_App\Dependencies\Google\Cloud\Core\Testing\Snippet\Parser\Parser;
use Masjid_App\Dependencies\Google\Cloud\Core\Testing\Snippet\Fixtures;
use Masjid_App\Dependencies\Google\Cloud\Core\Testing\System\SystemTestCase;
/**
...
class TestHelpers
{
    ...
    private static function projectRoot()
    {
        static $projectRoot;
        if (!$projectRoot) {
            $ref = new \ReflectionClass(\Masjid_App\Dependencies\Composer\Autoload\ClassLoader::class);
