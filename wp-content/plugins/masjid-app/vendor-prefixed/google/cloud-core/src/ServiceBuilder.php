 ...
 */
namespace Masjid_App\Dependencies\Google\Cloud\Core;

use Masjid_App\Dependencies\Google\Auth\HttpHandler\Guzzle6HttpHandler;
use Masjid_App\Dependencies\Google\Auth\HttpHandler\HttpHandlerFactory;
use Masjid_App\Dependencies\Google\Cloud\BigQuery\BigQueryClient;
use Masjid_App\Dependencies\Google\Cloud\Datastore\DatastoreClient;
use Masjid_App\Dependencies\Google\Cloud\Firestore\FirestoreClient;
use Masjid_App\Dependencies\Google\Cloud\Language\LanguageClient as DeprecatedLanguageClient;
use Masjid_App\Dependencies\Google\Cloud\Language\V2\Client\LanguageServiceClient;
use Masjid_App\Dependencies\Google\Cloud\Logging\LoggingClient;
use Masjid_App\Dependencies\Google\Cloud\PubSub\PubSubClient;
use Masjid_App\Dependencies\Google\Cloud\Spanner\SpannerClient;
use Masjid_App\Dependencies\Google\Cloud\Speech\SpeechClient as DeprecatedSpeechClient;
use Masjid_App\Dependencies\Google\Cloud\Speech\V2\Client\SpeechClient;
use Masjid_App\Dependencies\Google\Cloud\Storage\StorageClient;
use Masjid_App\Dependencies\Google\Cloud\Trace\V2\Client\TraceServiceClient;
use Masjid_App\Dependencies\Google\Cloud\Translate\V2\TranslateClient as DeprecatedTranslateClient;
use Masjid_App\Dependencies\Google\Cloud\Translate\V3\Client\TranslationServiceClient;
use Masjid_App\Dependencies\Google\Cloud\Vision\V1\Client\ImageAnnotatorClient;
use Masjid_App\Dependencies\Google\Cloud\Vision\VisionClient as DeprecatedVisionClient;
