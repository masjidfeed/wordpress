...
use Masjid_App\Dependencies\Google\Cloud\Core\Compute\Metadata;
...
trait ClientTrait
{
    ...
    {
        $config += ['credentialsFetcher' => null, 'httpHandler' => null, 'projectId' => null, 'projectIdRequired' => \false, 'hasEmulator' => \false, 'preferNumericProjectId' => \false];
        if ($config['projectId']) {
