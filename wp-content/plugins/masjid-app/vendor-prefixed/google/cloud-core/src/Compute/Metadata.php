 ...
 */
namespace Masjid_App\Dependencies\Google\Cloud\Core\Compute;

use Masjid_App\Dependencies\Google\Cloud\Core\Compute\Metadata\Readers\HttpHandlerReader;
use Masjid_App\Dependencies\Google\Cloud\Core\Compute\Metadata\Readers\ReaderInterface;
/**
