 ...
 */
class BatchingConfigProto extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Api\BatchingSettingsProto::class);
        $this->thresholds = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Api\BatchingDescriptorProto::class);
