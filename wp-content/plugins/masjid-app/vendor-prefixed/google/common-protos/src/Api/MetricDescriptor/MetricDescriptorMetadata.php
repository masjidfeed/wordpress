...
namespace Masjid_App\Dependencies\Google\Api\MetricDescriptor;
 ...
 */
class MetricDescriptorMetadata extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Protobuf\Duration::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Masjid_App\Dependencies\Google\Protobuf\Internal\GPBType::ENUM, \Masjid_App\Dependencies\Google\Api\MetricDescriptor\MetricDescriptorMetadata\TimeSeriesResourceHierarchyLevel::class);
