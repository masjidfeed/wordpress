 ...
 */
class BatchingSettingsProto extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Masjid_App\Dependencies\Google\Api\FlowControlLimitExceededBehaviorProto::class);
