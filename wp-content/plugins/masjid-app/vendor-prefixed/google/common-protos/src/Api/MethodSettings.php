 ...
 */
class MethodSettings extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Api\MethodSettings\LongRunning::class);
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Api\BatchingConfigProto::class);
        $this->batching = $var;
        return $this;
    }
}
