 ...
 */
class PythonSettings extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
     * Some settings.
     *
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Api\PythonSettings\ExperimentalFeatures::class);
