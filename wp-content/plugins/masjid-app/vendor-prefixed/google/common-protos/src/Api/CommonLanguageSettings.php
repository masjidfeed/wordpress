 ...
 */
class CommonLanguageSettings extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Masjid_App\Dependencies\Google\Protobuf\Internal\GPBType::ENUM, \Masjid_App\Dependencies\Google\Api\ClientLibraryDestination::class);
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Api\SelectiveGapicGeneration::class);
