 ...
 */
class ConfigChange extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Masjid_App\Dependencies\Google\Api\ChangeType::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Masjid_App\Dependencies\Google\Protobuf\Internal\GPBType::MESSAGE, \Masjid_App\Dependencies\Google\Api\Advice::class);
        $this->advices = $arr;
        return $this;
    }
}
