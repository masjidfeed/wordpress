...
namespace Masjid_App\Dependencies\Google\Api\Distribution;
 ...
 */
class BucketOptions extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    protected $options;
    /**
     * Constructor.
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Api\Distribution\BucketOptions\Linear::class);
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Api\Distribution\BucketOptions\Exponential::class);
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Api\Distribution\BucketOptions\Explicit::class);
