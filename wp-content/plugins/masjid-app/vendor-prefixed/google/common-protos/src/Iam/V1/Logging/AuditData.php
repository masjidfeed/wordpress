...
namespace Masjid_App\Dependencies\Google\Iam\V1\Logging;
 ...
 */
class AuditData extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Masjid_App\Dependencies\GPBMetadata\Google\Iam\V1\Logging\AuditData::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Cloud\Iam\V1\PolicyDelta::class);
