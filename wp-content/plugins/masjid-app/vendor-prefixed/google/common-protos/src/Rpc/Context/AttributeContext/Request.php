...
namespace Masjid_App\Dependencies\Google\Rpc\Context\AttributeContext;
 ...
 */
class Request extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Masjid_App\Dependencies\Google\Protobuf\Internal\GPBType::STRING, \Masjid_App\Dependencies\Google\Protobuf\Internal\GPBType::STRING);
        $this->headers = $arr;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Protobuf\Timestamp::class);
        $this->time = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Rpc\Context\AttributeContext\Auth::class);
        $this->auth = $var;
        return $this;
    }
    /**
