...
namespace Masjid_App\Dependencies\Google\Rpc\BadRequest;
 ...
 */
class FieldViolation extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Rpc\LocalizedMessage::class);
