 ...
 */
class AuditConfigDelta extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Masjid_App\Dependencies\Google\Cloud\Iam\V1\AuditConfigDelta\Action::class);
        $this->action = $var;
        return $this;
    }
    /**
