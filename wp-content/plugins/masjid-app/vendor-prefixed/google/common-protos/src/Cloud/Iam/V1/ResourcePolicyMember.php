 ...
 */
class ResourcePolicyMember extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Masjid_App\Dependencies\GPBMetadata\Google\Iam\V1\ResourcePolicyMember::initOnce();
