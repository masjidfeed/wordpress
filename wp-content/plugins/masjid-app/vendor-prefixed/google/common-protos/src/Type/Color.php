 ...
 */
class Color extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Masjid_App\Dependencies\GPBMetadata\Google\Type\Color::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Protobuf\FloatValue::class);
        $this->alpha = $var;
        return $this;
    }
    /**
