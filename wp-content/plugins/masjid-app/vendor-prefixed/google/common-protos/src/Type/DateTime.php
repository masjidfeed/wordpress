...
namespace Masjid_App\Dependencies\Google\Type;
 ...
 */
class DateTime extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Masjid_App\Dependencies\GPBMetadata\Google\Type\Datetime::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Type\TimeZone::class);
