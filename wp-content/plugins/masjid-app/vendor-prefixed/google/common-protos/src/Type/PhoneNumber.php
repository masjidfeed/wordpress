 ...
 */
class PhoneNumber extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Masjid_App\Dependencies\GPBMetadata\Google\Type\PhoneNumber::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Google\Type\PhoneNumber\ShortCode::class);
