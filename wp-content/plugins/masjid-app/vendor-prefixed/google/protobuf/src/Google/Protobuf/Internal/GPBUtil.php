...
use Masjid_App\Dependencies\Google\Protobuf\Duration;
use Masjid_App\Dependencies\Google\Protobuf\FieldMask;
use Masjid_App\Dependencies\Google\Protobuf\Internal\GPBType;
use Masjid_App\Dependencies\Google\Protobuf\Internal\MapField;
...
class GPBUtil
{
    ...
    public static function parseTimestamp($timestamp)
    {
        ...
        $value = new \Masjid_App\Dependencies\Google\Protobuf\Timestamp();
    ...
    {
        return is_a($msg, 'Masjid_App\Dependencies\Google\Protobuf\Any') || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\ListValue") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\Struct") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\Value") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\Duration") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\Timestamp") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\FieldMask") || static::hasJsonValue($msg);
    }
    public static function hasJsonValue($msg)
    {
        return is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\DoubleValue") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\FloatValue") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\Int64Value") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\UInt64Value") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\Int32Value") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\UInt32Value") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\BoolValue") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\StringValue") || is_a($msg, "Masjid_App\\Dependencies\\Google\\Protobuf\\BytesValue");
    }
