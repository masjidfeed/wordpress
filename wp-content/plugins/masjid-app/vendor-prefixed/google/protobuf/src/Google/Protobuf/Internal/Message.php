...
use Masjid_App\Dependencies\Google\Protobuf\Internal\CodedInputStream;
use Masjid_App\Dependencies\Google\Protobuf\Internal\CodedOutputStream;
use Masjid_App\Dependencies\Google\Protobuf\Internal\DescriptorPool;
use Masjid_App\Dependencies\Google\Protobuf\Internal\GPBType;
use Masjid_App\Dependencies\Google\Protobuf\Internal\GPBWire;
use Masjid_App\Dependencies\Google\Protobuf\Internal\MapEntry;
use Masjid_App\Dependencies\Google\Protobuf\ListValue;
use Masjid_App\Dependencies\Google\Protobuf\RepeatedField;
use Masjid_App\Dependencies\Google\Protobuf\PrintOptions;
use Masjid_App\Dependencies\Google\Protobuf\Value;
use Masjid_App\Dependencies\Google\Protobuf\Struct;
use Masjid_App\Dependencies\Google\Protobuf\NullValue;
/**
...
class Message
{
    ...
    private function initWithGeneratedPool()
    {
        ...
        foreach ($this->desc->getField() as $field) {
            ...
            } else if (!$field->isRequired() && !$field->isRepeated() && \PHP_INT_SIZE == 4 && $this->{$getter}() === 0) {
                switch ($field->getType()) {
                    case GPBType::INT64:
                    case GPBType::UINT64:
    ...
    {
        return ($options & \Masjid_App\Dependencies\Google\Protobuf\PrintOptions::EMIT_DEFAULTS) !== 0;
    }
    /**
     * @ignore
     */
    ...
    private function convertJsonValueToProtoValue($value, $field, $ignore_unknown, $is_map_key = \false)
    {
        switch ($field->getType()) {
            case GPBType::MESSAGE:
                $klass = $field->getMessageType()->getClass();
                $submsg = new $klass();
                if (is_a($submsg, "Masjid_App\\Dependencies\\Google\\Protobuf\\Duration")) {
                    if (is_null($value)) {
                        return $this->defaultValue($field);
                ...
                } else if (is_a($submsg, "Masjid_App\\Dependencies\\Google\\Protobuf\\FieldMask")) {
                    if (is_null($value)) {
                        return $this->defaultValue($field);
                    }
                    try {
                    ...
                    if (is_null($value) && !is_a($submsg, "Masjid_App\\Dependencies\\Google\\Protobuf\\Value")) {
                        return $this->defaultValue($field);
                    }
    ...
    {
        if (is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\Any")) {
            $this->clear();
        ...
        if (is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\DoubleValue") || is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\FloatValue") || is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\Int64Value") || is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\UInt64Value") || is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\Int32Value") || is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\UInt32Value") || is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\BoolValue") || is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\StringValue")) {
            $this->setValue($array);
            return;
        }
        if (is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\BytesValue")) {
            $this->setValue(base64_decode($array));
            return;
        }
        if (is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\Duration")) {
            $this->mergeFrom(GPBUtil::parseDuration($array));
            return;
        }
        if (is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\FieldMask")) {
            $this->mergeFrom(GPBUtil::parseFieldMask($array));
            return;
        }
        if (is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\Timestamp")) {
            $this->mergeFrom(GPBUtil::parseTimestamp($array));
            return;
        }
        if (is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\Struct")) {
        ...
        if (is_a($this, "Masjid_App\\Dependencies\\Google\\Protobuf\\Value")) {
            if (is_bool($array)) {
    ...
    public function parseFromJsonStream($input, $ignore_unknown)
    {
        ...
        if ($this instanceof \Masjid_App\Dependencies\Google\Protobuf\ListValue) {
            $array = ["values" => $array];
        }
        if (is_null($array)) {
            if ($this instanceof \Masjid_App\Dependencies\Google\Protobuf\Value) {
                $this->setNullValue(\Masjid_App\Dependencies\Google\Protobuf\NullValue::NULL_VALUE);
                return;
            } else {
    ...
    public function serializeToJsonStream(&$output)
    {
        ...
        if (is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\Any')) {
            ...
            $output->writeRaw("}", 1);
        } elseif (is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\FieldMask')) {
            $field_mask = GPBUtil::formatFieldMask($this);
            $output->writeRaw("\"", 1);
            $output->writeRaw($field_mask, strlen($field_mask));
            $output->writeRaw("\"", 1);
        } elseif (is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\Duration')) {
            ...
            $first = \true;
            foreach ($fields as $field) {
                if ($this->existField($field, $options) || GPBUtil::hasJsonValue($this)) {
                    if ($first) {
                        $first = \false;
                    } else {
                        $output->writeRaw(",", 1);
    ...
    public function __debugInfo()
    {
        ...
        if (is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\BoolValue') || is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\BytesValue') || is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\DoubleValue') || is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\FloatValue') || is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\StringValue') || is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\Int32Value') || is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\Int64Value') || is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\UInt32Value') || is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\UInt64Value')) {
            return ['value' => json_decode($this->serializeToJsonString(), \true)];
        }
        if (is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\Duration') || is_a($this, 'Masjid_App\Dependencies\Google\Protobuf\Timestamp')) {
