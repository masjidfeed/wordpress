 ...
 */
class MethodOptions extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Masjid_App\Dependencies\Google\Protobuf\Internal\MethodOptions\IdempotencyLevel::class);
