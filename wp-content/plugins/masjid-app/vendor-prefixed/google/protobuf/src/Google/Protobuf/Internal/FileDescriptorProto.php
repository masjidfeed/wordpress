 ...
 */
class FileDescriptorProto extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Masjid_App\Dependencies\Google\Protobuf\Internal\GPBType::INT32);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Masjid_App\Dependencies\Google\Protobuf\Internal\GPBType::MESSAGE, \Masjid_App\Dependencies\Google\Protobuf\Internal\ServiceDescriptorProto::class);
        $this->service = $arr;
        return $this;
    }
    /**
     ...
     * @return $this
     */
    public function setOptions(\Masjid_App\Dependencies\Google\Protobuf\Internal\FileOptions|null $var)
    {
        $this->options = $var;
        return $this;
    }
     ...
     * @return $this
     */
    public function setSourceCodeInfo(\Masjid_App\Dependencies\Google\Protobuf\Internal\SourceCodeInfo|null $var)
    {
