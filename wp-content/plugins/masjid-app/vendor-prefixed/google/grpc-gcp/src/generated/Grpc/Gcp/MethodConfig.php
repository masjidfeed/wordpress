 ...
 */
class MethodConfig extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Grpc\Gcp\AffinityConfig::class);
        $this->affinity = $var;
        return $this;
    }
}
