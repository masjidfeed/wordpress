 ...
 */
class ApiConfig extends \Masjid_App\Dependencies\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Masjid_App\Dependencies\Grpc\Gcp\ChannelPoolConfig::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Masjid_App\Dependencies\Google\Protobuf\Internal\GPBType::MESSAGE, \Masjid_App\Dependencies\Grpc\Gcp\MethodConfig::class);
        $this->method = $arr;
        return $this;
    }
}
