...
use Masjid_App\Dependencies\Google\Cloud\Core\JsonTrait;
...
use Masjid_App\Dependencies\Google\Cloud\Storage\Connection\RetryTrait;
/**
...
class SigningHelper
{
    ...
    const V4_TIMESTAMP_FORMAT = 'Masjid_App\Dependencies\Ymd\THis\Z';
