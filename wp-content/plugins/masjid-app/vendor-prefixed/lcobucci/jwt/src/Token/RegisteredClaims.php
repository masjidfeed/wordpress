...
{
    public const ALL = [self::AUDIENCE, self::EXPIRATION_TIME, self::ID, self::ISSUED_AT, self::ISSUER, self::NOT_BEFORE, self::SUBJECT];
    public const DATE_CLAIMS = [self::ISSUED_AT, self::NOT_BEFORE, self::EXPIRATION_TIME];
    /**
