...
use Masjid_App\Dependencies\Lcobucci\JWT\Token as TokenInterface;
...
final class Parser implements ParserInterface
{
    ...
    public function parse(string $jwt): TokenInterface
    {
        ...
        return new Plain(new DataSet($header, $encodedHeaders), new DataSet($this->parseClaims($encodedClaims), $encodedClaims), $this->parseSignature($encodedSignature));
    }
    /**
