...
use Masjid_App\Dependencies\Lcobucci\JWT\Signer\CannotSignPayload;
use Masjid_App\Dependencies\Lcobucci\JWT\Signer\Ecdsa\ConversionFailed;
use Masjid_App\Dependencies\Lcobucci\JWT\Signer\InvalidKeyProvided;
use Masjid_App\Dependencies\Lcobucci\JWT\Signer\Key;
use Masjid_App\Dependencies\Lcobucci\JWT\Token\RegisteredClaimGiven;
/** @immutable */
interface Builder
{
    /**
