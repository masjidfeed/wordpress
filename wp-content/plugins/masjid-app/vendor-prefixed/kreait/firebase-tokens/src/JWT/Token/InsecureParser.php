...
use Masjid_App\Dependencies\Lcobucci\JWT\Token\InvalidTokenStructure;
use Masjid_App\Dependencies\Lcobucci\JWT\Token\Plain;
use Masjid_App\Dependencies\Lcobucci\JWT\Token\RegisteredClaims;
use Masjid_App\Dependencies\Lcobucci\JWT\Token\Signature;
use Masjid_App\Dependencies\Lcobucci\JWT\Token\UnsupportedHeaderFound;
...
final class InsecureParser implements ParserInterface
{
    ...
    public function parse(string $jwt): Token
    {
        ...
        return new Plain(new DataSet($header, $encodedHeaders), new DataSet($this->parseClaims($encodedClaims), $encodedClaims), new Signature('none', 'none'));
    }
    /**
