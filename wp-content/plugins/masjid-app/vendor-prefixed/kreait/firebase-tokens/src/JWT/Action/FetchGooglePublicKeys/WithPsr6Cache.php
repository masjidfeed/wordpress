...
{
    public function __construct(private readonly Handler $handler, private readonly CacheItemPoolInterface $cache, private readonly ClockInterface $clock)
    {
    }
    public function handle(FetchGooglePublicKeys $action): Keys
    {
        ...
        try {
            ...
            $reason = sprintf('The inner handler of %s (%s) failed in fetching keys: %s', self::class, $this->handler::class, $e->getMessage());
