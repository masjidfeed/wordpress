...
{
    private function __construct(private readonly ?string $tenantId, private readonly ?string $locale, private readonly string $type, private readonly string $email, private readonly ActionCodeSettings $settings)
    {
    }
