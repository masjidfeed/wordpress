...
use Masjid_App\Dependencies\Kreait\Firebase\Exception\Database\ReferenceHasNotBeenSnapshotted;
use Masjid_App\Dependencies\Kreait\Firebase\Exception\Database\TransactionFailed;
