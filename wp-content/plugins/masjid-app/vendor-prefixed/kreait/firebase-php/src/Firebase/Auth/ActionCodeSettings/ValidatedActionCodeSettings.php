...
namespace Masjid_App\Dependencies\Kreait\Firebase\Auth\ActionCodeSettings;
    ...
    public static function fromArray(array $settings): self
    {
        ...
        foreach ($settings as $key => $value) {
            switch (mb_strtolower($key)) {
                case 'continueurl':
                case 'url':
                    $instance->continueUrl = $value !== null ? Utils::uriFor(self::ensureNonEmptyString($value)) : null;
                    break;
                case 'handlecodeinapp':
                    $instance->canHandleCodeInApp = (bool) $value;
                    break;
                case 'dynamiclinkdomain':
                    $instance->dynamicLinkDomain = $value !== null ? Utils::uriFor(self::ensureNonEmptyString($value)) : null;
                    break;
