...
final class User
{
     ...
     */
    private function __construct(private readonly ?string $name, private readonly ?string $email, private readonly ?UriInterface $imageUri)
    {
    }
    /**
     * @internal
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($data['name'] ?? null, $data['email'] ?? null, $imageUri);
    }
    /**
