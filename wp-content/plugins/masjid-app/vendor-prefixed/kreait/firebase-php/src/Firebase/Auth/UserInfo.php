...
final class UserInfo
{
     ...
     */
    public function __construct(public readonly string $uid, public readonly string $providerId, public readonly ?string $displayName, public readonly ?string $email, public readonly ?string $phoneNumber, public readonly ?string $photoUrl)
    {
    }
    /**
     * @internal
    ...
    {
        return new self($data['rawId'], $data['providerId'], $data['displayName'] ?? null, $data['email'] ?? null, $data['phoneNumber'] ?? null, $data['photoUrl'] ?? null);
    }
}
