...
final class DecodedAppCheckToken
{
     ...
     */
    private function __construct(public readonly string $app_id, public readonly array $aud, public readonly int $exp, public readonly int $iat, public readonly string $iss, public readonly string $sub)
    {
    }
    /**
    ...
    {
        return new self($data['app_id'] ?? $data['sub'], $data['aud'], $data['exp'], $data['iat'], $data['iss'], $data['sub']);
    }
}
