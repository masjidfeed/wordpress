...
use Masjid_App\Dependencies\GuzzleHttp\RequestOptions;
...
final class HttpClientOptions
{
     ...
     */
    private function __construct(private readonly array $guzzleConfig, private readonly array $guzzleMiddlewares)
    {
    }
    ...
    {
        return $this->withGuzzleMiddlewares([['middleware' => $middleware, 'name' => $name ?? '']]);
    }
    /**
     * @param list<array{
