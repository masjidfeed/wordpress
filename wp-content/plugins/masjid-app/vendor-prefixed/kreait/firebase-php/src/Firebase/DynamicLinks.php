...
use Masjid_App\Dependencies\Kreait\Firebase\DynamicLink\ApiClient;
...
use Masjid_App\Dependencies\Kreait\Firebase\DynamicLink\GetStatisticsForDynamicLink\FailedToGetStatisticsForDynamicLink;
...
final class DynamicLinks implements Contract\DynamicLinks
{
     ...
     */
    private function __construct(private readonly ?string $defaultDynamicLinksDomain, private readonly ApiClient $apiClient)
    {
    }
