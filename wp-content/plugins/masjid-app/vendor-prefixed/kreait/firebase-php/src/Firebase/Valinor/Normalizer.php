...
namespace Masjid_App\Dependencies\Kreait\Firebase\Valinor;
...
use Masjid_App\Dependencies\Kreait\Firebase\Valinor\Transformer\CamelToSnakeCaseTransformer;
/**
 * @internal
 */
final class Normalizer
{
    private const DEFAULT_JSON_OPTIONS = \JSON_UNESCAPED_SLASHES | \JSON_UNESCAPED_UNICODE | \JSON_UNESCAPED_SLASHES | \JSON_UNESCAPED_UNICODE;
    ...
    {
        $builder = $this->normalizerBuilder->registerTransformer($transformer);
