...
class TagColor implements Stringable
{
    ...
    final public const VALID_COLORS = [self::BLUE, self::BROWN, self::CYAN, self::DEEP_ORANGE, self::GREEN, self::INDIGO, self::LIME, self::ORANGE, self::PINK, self::PURPLE, self::TEAL];
    /**
    ...
    public function __construct(string $value)
    {
        ...
        if (!in_array($value, self::VALID_COLORS, \true)) {
