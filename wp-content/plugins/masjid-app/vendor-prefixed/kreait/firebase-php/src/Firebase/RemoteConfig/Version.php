...
final class Version
{
    private function __construct(private readonly VersionNumber $versionNumber, private readonly User $user, private readonly string $description, private readonly DateTimeImmutable $updatedAt, private readonly UpdateOrigin $updateOrigin, private readonly UpdateType $updateType, private readonly ?VersionNumber $rollbackSource)
    {
    }
    /**
     * @internal
    ...
    public static function fromArray(array $data): self
    {
        ...
        $rollbackSource = array_key_exists('rollbackSource', $data) ? VersionNumber::fromValue($data['rollbackSource']) : null;
        return new self($versionNumber, $user, $description, $updatedAt, $updateOrigin, $updateType, $rollbackSource);
    }
