...
namespace Masjid_App\Dependencies\Kreait\Firebase\RemoteConfig;
...
class Parameter implements JsonSerializable
{
     ...
     */
    private function __construct(private readonly string $name, private readonly string $description, private readonly ?ParameterValue $defaultValue, private readonly array $conditionalValues, private readonly ParameterValueType $valueType)
    {
    }
    /**
     * @param non-empty-string $name
    ...
    public static function named(string $name, $defaultValue = null, ?ParameterValueType $valueType = null): self
    {
        ...
        return new self(name: $name, description: '', defaultValue: $defaultValue, conditionalValues: [], valueType: $valueType ?? ParameterValueType::UNSPECIFIED);
    }
    /**
     * @param DefaultValue|RemoteConfigParameterValueShape|string|bool|null $defaultValue
     */
    ...
    {
        return new self(name: $this->name, description: $description, defaultValue: $this->defaultValue, conditionalValues: $this->conditionalValues, valueType: $this->valueType);
    }
    /**
     * @param DefaultValue|RemoteConfigParameterValueShape|string|bool|null $defaultValue
     */
    ...
    {
        $defaultValue = self::mapDefaultValue($defaultValue);
        return new self(name: $this->name, description: $this->description, defaultValue: $defaultValue, conditionalValues: $this->conditionalValues, valueType: $this->valueType);
    }
    /**
    ...
    public function withConditionalValue(ConditionalValue $conditionalValue): self
    {
        ...
        return new self(name: $this->name, description: $this->description, defaultValue: $this->defaultValue, conditionalValues: $conditionalValues, valueType: $this->valueType);
    }
    /**
    ...
    {
        return new self(name: $this->name, description: $this->description, defaultValue: $this->defaultValue, conditionalValues: $this->conditionalValues, valueType: $valueType);
    }
