...
{
    public function __construct(private readonly CreateSessionCookie $action, private readonly ?ResponseInterface $response, ?string $message = null, ?int $code = null, ?Throwable $previous = null)
    {
        $message ??= '';
        $code ??= 0;
