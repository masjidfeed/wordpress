...
class Condition implements JsonSerializable
{
     ...
     */
    private function __construct(private readonly string $name, private string $expression, private ?TagColor $tagColor = null)
    {
    }
    /**
    ...
    {
        return new self($data['name'], $data['expression'], isset($data['tagColor']) ? new TagColor($data['tagColor']) : null);
    }
    /**
     * @param non-empty-string $name
     */
    ...
    {
        $array = ['name' => $this->name, 'expression' => $this->expression];
