...
final class CloudMessage implements Message
{
    ...
    {
        $data = ['data' => $this->data, 'notification' => $this->notification, 'android' => $this->androidConfig, 'apns' => $this->apnsConfig, 'webpush' => $this->webPushConfig, 'fcm_options' => $this->fcmOptions];
        $data = Json::decode(Json::encode($data), \true);
