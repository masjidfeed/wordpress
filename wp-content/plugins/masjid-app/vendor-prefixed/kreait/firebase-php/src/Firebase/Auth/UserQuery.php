...
class UserQuery implements JsonSerializable
{
    ...
    {
        $data = array_filter(['returnUserInfo' => \true, 'limit' => $this->limit, 'offset' => $this->offset, 'sortBy' => $this->sortBy, 'order' => $this->order], fn(int|bool|null|string $value): bool => $value !== null);
        if ($this->filter !== null) {
