...
use Masjid_App\Dependencies\Kreait\Firebase\DynamicLink\AnalyticsInfo\GooglePlayAnalytics;
use Masjid_App\Dependencies\Kreait\Firebase\DynamicLink\AnalyticsInfo\ITunesConnectAnalytics;
...
{
    private function __construct(private readonly ?GooglePlayAnalytics $googlePlayAnalytics, private readonly ?ITunesConnectAnalytics $iTunesConnectAnalytics)
    {
    }
    /**
    ...
    {
        $googlePlayAnalytics = array_key_exists('googlePlayAnalytics', $data) ? GooglePlayAnalytics::fromArray($data['googlePlayAnalytics']) : null;
        $itunesConnectAnalytics = array_key_exists('itunesConnectAnalytics', $data) ? ITunesConnectAnalytics::fromArray($data['itunesConnectAnalytics']) : null;
    ...
    {
        return array_filter(['googlePlayAnalytics' => $this->googlePlayAnalytics?->jsonSerialize(), 'itunesConnectAnalytics' => $this->iTunesConnectAnalytics?->jsonSerialize()], fn(?array $value): bool => $value !== null);
    }
}
