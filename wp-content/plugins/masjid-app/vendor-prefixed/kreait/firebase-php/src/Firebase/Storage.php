...
final class Storage implements Contract\Storage
{
    ...
    public function __construct(private readonly StorageClient $storageClient, private readonly ?string $defaultBucket = null)
    {
    }
    ...
    public function getBucket(?string $name = null): Bucket
    {
        ...
        if ($name === null) {
            throw new RuntimeException('No bucket name was given and no default bucked was configured.');
        }
