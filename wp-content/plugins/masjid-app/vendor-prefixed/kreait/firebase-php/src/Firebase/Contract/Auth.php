...
use Masjid_App\Dependencies\Kreait\Firebase\Auth\CreateActionLink\FailedToCreateActionLink;
use Masjid_App\Dependencies\Kreait\Firebase\Auth\CreateSessionCookie\FailedToCreateSessionCookie;
...
interface Auth
{
     ...
     * @throws Exception\FirebaseException
     */
    public function confirmPasswordReset(string $oobCode, Stringable|string $newPassword, bool $invalidatePreviousSessions = \true): string;
    /**
