...
final class ApnsConfig implements JsonSerializable
{
     ...
     */
    private function __construct(private readonly array $headers, private readonly array $payload, private readonly array $fcmOptions, private readonly ?string $liveActivityToken)
    {
    }
    ...
    public function withHeader(string $name, string $value): self
    {
        ...
        $headers[$name] = $value;
        return new self(headers: $headers, payload: $this->payload, fcmOptions: $this->fcmOptions, liveActivityToken: $this->liveActivityToken);
    }
    ...
    public function withApsField(string $key, mixed $value): self
    {
        ...
        return new self(headers: $this->headers, payload: $payload, fcmOptions: $this->fcmOptions, liveActivityToken: $this->liveActivityToken);
    }
    /**
     * @param non-empty-string $name
     */
    ...
    {
        return new self(headers: $this->headers, payload: $this->payload, fcmOptions: $this->fcmOptions, liveActivityToken: $liveActivityToken);
    }
    /**
    ...
    {
        return isset($this->payload['aps']['alert']) || isset($this->payload['aps']['badge']) || isset($this->payload['aps']['sound']);
    }
    /**
    ...
    public function toArray(): array
    {
        ...
        return array_filter(['headers' => array_filter($this->headers, $filter), 'payload' => array_filter($this->payload, $filter), 'fcm_options' => array_filter($this->fcmOptions, $filter), 'live_activity_token' => $this->liveActivityToken], $filter);
    }
    /**
