...
final class Notification implements JsonSerializable
{
    ...
    {
        return new self($data['title'] ?? null, $data['body'] ?? null, $data['image'] ?? null);
    }
    ...
    {
        return array_filter(['title' => $this->title, 'body' => $this->body, 'image' => $this->imageUrl], static fn(?string $value): bool => $value !== null);
    }
}
