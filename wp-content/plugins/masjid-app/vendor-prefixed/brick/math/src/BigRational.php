...
final readonly class BigRational extends BigNumber
{
     ...
     * @pure
     */
    public static function ofFraction(BigNumber|int|string $numerator, BigNumber|int|string $denominator): BigRational
    {
        $numerator = BigInteger::of($numerator);
        $denominator = BigInteger::of($denominator);
        return new BigRational($numerator, $denominator, \true, \true);
    }
    /**
    ...
    public function plus(BigNumber|int|string $that): BigRational
    {
        ...
        return new BigRational($numerator, $denominator, \false, \true);
    }
    /**
    ...
    public function power(int $exponent): BigRational
    {
        ...
        return new BigRational($this->numerator->power($exponent), $this->denominator->power($exponent), \false, \false);
    }
    /**
    ...
    public function reciprocal(): BigRational
    {
        ...
        return new BigRational($this->denominator, $this->numerator, \true, \false);
    }
    #[Override]
    ...
    public function toFloat(): float
    {
        ...
        $result = $this->numerator->toBigDecimal()->dividedBy($this->denominator, $scale, RoundingMode::HalfEven)->toFloat();
