...
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\ArrayNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\CastNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\ClassNameNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\CloneNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\ClosureNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\ForEachNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\FunctionCallNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\IfNode;
...
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\MatchNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\NegateNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\NewClassNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\ParameterDeclarationNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\PropertyDeclarationNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\ReturnNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\ShortClosureNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\TernaryNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\ThrowNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\ValueNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\VariableNode;
use Masjid_App\Dependencies\CuyZ\Valinor\Compiler\Native\YieldNode;
/**
 ...
 */
function shortClosure(Node $return, array $parameters = []): ShortClosureNode
{
