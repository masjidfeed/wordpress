...
final class AnonymousClassNode extends Node
{
     ...
     */
    public function withConstructor(string $visibility = 'public', array $parameters = [], array $body = []): self
    {
     ...
     * @param list<Node> $body
     */
    public function withMethod(string $name, string $visibility = 'private', array $parameters = [], ?string $returnType = null, array $body = []): self
    {
        $self = clone $this;
