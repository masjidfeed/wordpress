...
namespace Masjid_App\Dependencies\CuyZ\Valinor\Normalizer\Configurator;

use Attribute;
use Masjid_App\Dependencies\CuyZ\Valinor\Normalizer\AsTransformer;
    ...
    public function configureNormalizerBuilder(NormalizerBuilder $builder): NormalizerBuilder
    {
        return $builder->registerTransformer(
            ...
            static function (object $value, callable $next): mixed {
                ...
                return array_filter($normalized, static fn(mixed $item): bool => !$item instanceof self);
            }
        );
    }
