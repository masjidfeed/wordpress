...
use Masjid_App\Dependencies\CuyZ\Valinor\Normalizer\Exception\TypeUnhandledByNormalizer;
use Masjid_App\Dependencies\CuyZ\Valinor\Normalizer\Transformer\Compiler\TransformerDefinitionBuilder;
use Masjid_App\Dependencies\CuyZ\Valinor\Normalizer\Transformer\Compiler\TransformerRootNode;
...
final class CompiledTransformer implements Transformer
{
    ...
    {
        $type = $this->inferType($value, isSure: \true);
    ...
    private function compileFor(Type $type): string
    {
        ...
        $node = shortClosure(return: $rootNode, parameters: [param('transformers', 'array'), param('delegate', Transformer::class)]);
