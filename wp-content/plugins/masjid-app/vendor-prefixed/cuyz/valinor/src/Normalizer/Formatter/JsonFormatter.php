...
namespace Masjid_App\Dependencies\CuyZ\Valinor\Normalizer\Formatter;

use Masjid_App\Dependencies\CuyZ\Valinor\Normalizer\Formatter\Exception\CannotFormatInvalidTypeToJson;
