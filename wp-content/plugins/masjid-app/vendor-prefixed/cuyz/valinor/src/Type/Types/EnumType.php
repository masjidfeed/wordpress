...
use Masjid_App\Dependencies\CuyZ\Valinor\Type\CombiningType;
use Masjid_App\Dependencies\CuyZ\Valinor\Type\Parser\Exception\Enum\EnumCaseNotFound;
use Masjid_App\Dependencies\CuyZ\Valinor\Type\Parser\Exception\Enum\EnumHasNoCase;
use Masjid_App\Dependencies\CuyZ\Valinor\Type\Parser\Lexer\Token\CaseFinder;
...
final class EnumType implements ClassType
{
    ...
    {
        return in_array($value, $this->cases, \true);
    }
    ...
    public function matches(Type $other): bool
    {
        ...
        if ($other instanceof self) {
            ...
            foreach ($this->cases as $case) {
                if (!in_array($case, $other->cases, \true)) {
                    return \false;
                }
            }
            return \true;
