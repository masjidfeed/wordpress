...
use Masjid_App\Dependencies\CuyZ\Valinor\Type\Parser\Exception\Intersection\InvalidIntersectionElement;
...
final class IntersectionType implements CombiningType
{
    ...
    {
        return logicalAnd(...array_map(fn(Type $type) => $type->compiledAccept($node), $this->types));
    }
