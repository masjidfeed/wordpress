...
use Masjid_App\Dependencies\CuyZ\Valinor\Type\Parser\Exception\Union\ForbiddenMixedType;
use Masjid_App\Dependencies\CuyZ\Valinor\Type\Type;
use function array_filter;
use function array_map;
use function array_shift;
use function array_values;
use function Masjid_App\Dependencies\CuyZ\Valinor\Compiler\logicalOr;
...
final class UnionType implements CombiningType, DumpableType
{
    ...
    {
        return logicalOr(...array_map(fn(Type $type) => $type->compiledAccept($node), $this->types));
    }
