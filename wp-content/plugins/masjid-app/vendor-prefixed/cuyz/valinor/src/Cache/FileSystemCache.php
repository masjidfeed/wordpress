...
use Masjid_App\Dependencies\CuyZ\Valinor\Cache\Exception\CacheDirectoryNotWritable;
use Masjid_App\Dependencies\CuyZ\Valinor\Cache\Exception\CompiledPhpCacheFileNotWritten;
use Masjid_App\Dependencies\CuyZ\Valinor\Cache\Exception\CorruptedCompiledPhpCacheFile;
use Error;
...
final class FileSystemCache implements Cache
{
    ...
    public function set(string $key, CacheEntry $entry): void
    {
         ...
         */
        if (!is_dir($tmpDir) && !@mkdir($tmpDir, 0777, \true) && !is_dir($tmpDir)) {
