...
namespace Masjid_App\Dependencies\CuyZ\Valinor\Cache\Warmup;

use Masjid_App\Dependencies\CuyZ\Valinor\Cache\Exception\InvalidSignatureToWarmup;
...
final class RecursiveCacheWarmupService
{
    ...
    {
        if (in_array($type->className(), $this->classesWarmedUp, \true)) {
            return;
        }
