...
namespace Masjid_App\Dependencies\CuyZ\Valinor\Mapper\Object;
...
use Masjid_App\Dependencies\CuyZ\Valinor\Mapper\Object\Exception\CannotParseToDateTime;
...
final class InternalClassConstructors
{
    ...
    public const CLASSES = [DateTime::class => null, DateTimeImmutable::class => null, DateTimeZone::class => null, ArrayObject::class => null, ArrayIterator::class => null, SplDoublyLinkedList::class => null, SplStack::class => null, SplQueue::class => null, SplFixedArray::class => null, SplMinHeap::class => null, SplMaxHeap::class => null, Vector::class => null, Deque::class => null, Set::class => null, Map::class => null, Stack::class => null, Queue::class => null, Pair::class => null];
    ...
    public function get(string $className): FunctionObject
    {
        ...
        return new FunctionObject($this->functionDefinitionRepository->for($callable), $callable);
    }
    /**
     * @param key-of<self::CLASSES> $className
     */
