...
use Masjid_App\Dependencies\CuyZ\Valinor\Mapper\Object\Exception\CannotFindObjectBuilder;
...
use Masjid_App\Dependencies\CuyZ\Valinor\Mapper\Tree\Message\UserlandError;
...
final class ObjectNodeBuilder implements NodeBuilder
{
    ...
    public function build(Shell $shell): Node
    {
        ...
        foreach ($objectBuilders as $objectBuilder) {
            $arguments = $objectBuilder->describeArguments()->withoutSelfReferencingSingleArgument($shell->value(), $className);
