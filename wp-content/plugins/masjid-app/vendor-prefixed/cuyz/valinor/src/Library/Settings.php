...
final class Settings
{
    ...
    {
        return $this->hash ??= hash('xxh128', serialize([$this->nativeConstructors, $this->supportedDateFormats, $this->allowCastingToBoolean, $this->allowCastingToInteger, $this->allowCastingToFloat, $this->allowCastingToString, $this->allowUndefinedValues, $this->allowSuperfluousKeys, $this->allowPermissiveTypes, $this->mapperConverterAttributes, $this->normalizerTransformerAttributes, implode('', array_map(function (callable $callable) {
