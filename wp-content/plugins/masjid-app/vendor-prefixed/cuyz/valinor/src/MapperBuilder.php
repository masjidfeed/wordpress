...
namespace Masjid_App\Dependencies\CuyZ\Valinor;

use Masjid_App\Dependencies\CuyZ\Valinor\Cache\Cache;
use Masjid_App\Dependencies\CuyZ\Valinor\Library\Container;
use Masjid_App\Dependencies\CuyZ\Valinor\Library\Settings;
use Masjid_App\Dependencies\CuyZ\Valinor\Mapper\ArgumentsMapper;
use Masjid_App\Dependencies\CuyZ\Valinor\Mapper\Configurator\MapArrayToList;
...
use Masjid_App\Dependencies\CuyZ\Valinor\Mapper\Configurator\MapperBuilderConfigurator;
...
final class MapperBuilder
{
     ...
     */
    public function allowScalarValueCasting(array $true = [1, '1', 'true'], array $false = [0, '0', 'false']): self
    {
        return $this->allowCastingToBoolean($true, $false)->allowCastingToInteger()->allowCastingToFloat()->allowCastingToString();
    }
    /**
     ...
     * @param non-empty-list<non-empty-string|int> $false
     */
    public function allowCastingToBoolean(array $true = [1, '1', 'true'], array $false = [0, '0', 'false']): self
    {
        $clone = clone $this;
    ...
    {
        $clone = clone $this;
        $clone->settings->allowCastingToInteger = \true;
        return $clone;
    }
    /**
    ...
    {
        $clone = clone $this;
        $clone->settings->allowCastingToFloat = \true;
        return $clone;
    }
    /**
    ...
    {
        $clone = clone $this;
        $clone->settings->allowCastingToString = \true;
        return $clone;
    }
    /**
    ...
    {
        $clone = clone $this;
        $clone->settings->allowUndefinedValues = \true;
        return $clone;
    }
    /**
    ...
    {
        $clone = clone $this;
        $clone->settings->allowSuperfluousKeys = \true;
        return $clone;
    }
    /**
    ...
    {
        $clone = clone $this;
        $clone->settings->allowPermissiveTypes = \true;
        return $clone;
    }
    /**
