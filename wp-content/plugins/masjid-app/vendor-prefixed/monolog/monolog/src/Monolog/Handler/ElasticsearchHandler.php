...
use Masjid_App\Dependencies\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use Masjid_App\Dependencies\Monolog\Level;
use Masjid_App\Dependencies\Monolog\Formatter\FormatterInterface;
use Masjid_App\Dependencies\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use Masjid_App\Dependencies\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use Masjid_App\Dependencies\Elasticsearch\Client;
use Masjid_App\Dependencies\Monolog\LogRecord;
use Masjid_App\Dependencies\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use Masjid_App\Dependencies\Elastic\Elasticsearch\Client as Client8;
/**
