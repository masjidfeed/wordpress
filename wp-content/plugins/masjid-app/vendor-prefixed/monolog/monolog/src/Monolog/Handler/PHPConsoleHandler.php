...
use Masjid_App\Dependencies\Monolog\Formatter\LineFormatter;
use Masjid_App\Dependencies\Monolog\Formatter\FormatterInterface;
use Masjid_App\Dependencies\Monolog\Level;
use Masjid_App\Dependencies\Monolog\Utils;
use Masjid_App\Dependencies\PhpConsole\Connector;
use Masjid_App\Dependencies\PhpConsole\Handler as VendorPhpConsoleHandler;
use Masjid_App\Dependencies\PhpConsole\Helper;
use Masjid_App\Dependencies\Monolog\LogRecord;
use Masjid_App\Dependencies\PhpConsole\Storage;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('Masjid_App\Dependencies\PhpConsole\Connector')) {
