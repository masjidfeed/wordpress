 ...
 */
namespace Masjid_App\Dependencies\Monolog\Processor;
    ...
    public function __invoke(LogRecord $record): LogRecord
    {
        ...
        foreach ($context as $key => $val) {
            ...
            if (null === $val || \is_scalar($val) || \is_object($val) && method_exists($val, "__toString")) {
                ...
                if (null === $this->dateFormat && $val instanceof \Masjid_App\Dependencies\Monolog\JsonSerializableDateTimeImmutable) {
