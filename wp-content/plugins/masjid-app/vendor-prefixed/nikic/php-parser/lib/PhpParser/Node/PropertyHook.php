...
namespace Masjid_App\Dependencies\PhpParser\Node;

use Masjid_App\Dependencies\PhpParser\Modifiers;
use Masjid_App\Dependencies\PhpParser\Node\Expr\Assign;
use Masjid_App\Dependencies\PhpParser\Node\Expr\PropertyFetch;
use Masjid_App\Dependencies\PhpParser\Node\Expr\Variable;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\Expression;
use Masjid_App\Dependencies\PhpParser\Node\Stmt\Return_;
use Masjid_App\Dependencies\PhpParser\NodeAbstract;
