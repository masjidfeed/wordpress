...
namespace Masjid_App\Dependencies\PhpParser\Lexer;
...
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use Masjid_App\Dependencies\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
use Masjid_App\Dependencies\PhpParser\PhpVersion;
use Masjid_App\Dependencies\PhpParser\Token;
