...
$command = 'php -d memory_limit=-1 vendor/bin/php-scoper add-prefix --config=scoper.inc.php --output-dir=vendor-prefixed vendor/composer vendor/firebase --force';
...
$entrypoint_file = __DIR__ . '/../vendor-prefixed/autoload.php';
$entrypoint = <<<PHP
<?php
...
$files_file = __DIR__ . '/../vendor-prefixed/composer/autoload_files.php';
...
$static_file = __DIR__ . '/../vendor-prefixed/composer/autoload_static.php';
