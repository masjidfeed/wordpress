<?php
/**
 * Seed 100 test event posts into the local WP install compatible with Awesome Events Calendar.
 * Run inside the wordpress container: php /scripts/seed-ace.php
 */
